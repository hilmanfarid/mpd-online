<?php
//Include Common Files @1-0AB14F9F
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_order_paymentkey.php");
...
//Class_Initialize Event @2-A300E2C3
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_ro_order_paymentkey.php";
...
//Operation Method @355-DCA908D6
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_order_paymentkey.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_order_paymentkey.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_order_paymentkey.html";
$BlockToParse = "main";
...
//Include events file @1-B584558A
include_once("./t_vat_setllement_ro_order_paymentkey_events.php");
