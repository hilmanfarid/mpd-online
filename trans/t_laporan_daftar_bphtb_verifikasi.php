<?php
//Include Common Files @1-5536DB90
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_daftar_bphtb_verifikasi.php");
...
class clsRecordt_laporan_daftar_bphtb { //t_laporan_daftar_bphtb Class @2-116AADF3
...
//Class_Initialize Event @2-D6F7CEC2
...
//Operation Method @2-09C6D7CA
    function Operation()
    {
        ...
        $Redirect = "t_laporan_daftar_bphtb_verifikasi.php";
        if($this->Validate()) {
...
} //End t_laporan_daftar_bphtb Class @2-FCB6E20C

//Initialize Page @1-A7EDED7C
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_daftar_bphtb_verifikasi.html";
$BlockToParse = "main";
...
//Include events file @1-2FCDB8BA
include_once("./t_laporan_daftar_bphtb_verifikasi_events.php");
...
//Initialize Objects @1-24C7C0CC
$Attributes = new clsAttributes("page:");
$MainPage->Attributes = & $Attributes;

// Controls
$t_laporan_daftar_bphtb = & new clsRecordt_laporan_daftar_bphtb("", $MainPage);
$MainPage->t_laporan_daftar_bphtb = & $t_laporan_daftar_bphtb;
...
//Execute Components @1-6153804D
$t_laporan_daftar_bphtb->Operation();
//End Execute Components

//Go to destination page @1-006DE093
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    header("Location: " . $Redirect);
    unset($t_laporan_daftar_bphtb);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-35F4D9F1
$t_laporan_daftar_bphtb->Show();
$Tpl->block_path = "";
