<?php
//Include Common Files @1-10FBBAFA
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_reject_transaksi.php");
...
//Operation Method @3-667C839E
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_reject_transaksi.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_reject_transaksi.html";
$BlockToParse = "main";
...
//Include events file @1-DC79B08E
include_once("./t_vat_setllement_reject_transaksi_events.php");
