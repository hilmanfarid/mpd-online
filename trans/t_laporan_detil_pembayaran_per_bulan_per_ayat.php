<?php
//Include Common Files @1-A1A2C1D6
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_detil_pembayaran_per_bulan_per_ayat.php");
...
//Operation Method @3-2F3D4CD4
    function Operation()
    {
        ...
        $Redirect = "t_laporan_detil_pembayaran_per_bulan_per_ayat.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_detil_pembayaran_per_bulan_per_ayat.html";
$BlockToParse = "main";
...
//Include events file @1-465A0042
include_once("./t_laporan_detil_pembayaran_per_bulan_per_ayat_events.php");
