<?php
//Include Common Files @1-740ACA50
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cetak_kartu_npwpd_dr_t_cust_account.php");
...
//Operation Method @3-B1CAA127
    function Operation()
    {
        ...
        $Redirect = "t_cetak_kartu_npwpd_dr_t_cust_account.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cetak_kartu_npwpd_dr_t_cust_account.html";
$BlockToParse = "main";
...
//Include events file @1-3AA0A64E
include_once("./t_cetak_kartu_npwpd_dr_t_cust_account_events.php");
