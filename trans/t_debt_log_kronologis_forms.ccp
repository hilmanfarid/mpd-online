...
VALUES(
 ...
 '{input_type}')" dataSource="t_order_log_kronologis">
			<Components>
				...
				<Hidden id="328" fieldSourceType="DBColumn" dataType="Float" name="t_debt_letter_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_order_log_kronologisFormt_debt_letter_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_debt_log_kronologis_forms_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_debt_log_kronologis_forms.php" forShow="True" url="t_debt_log_kronologis_forms.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
