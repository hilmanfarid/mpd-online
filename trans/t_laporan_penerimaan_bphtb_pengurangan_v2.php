<?php
//Include Common Files @1-AAECE597
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_penerimaan_bphtb_pengurangan_v2.php");
...
//Operation Method @2-F4341CDA
    function Operation()
    {
        ...
        $Redirect = "t_laporan_penerimaan_bphtb_pengurangan_v2.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_penerimaan_bphtb_pengurangan_v2.html";
$BlockToParse = "main";
...
//Include events file @1-ABD35488
include_once("./t_laporan_penerimaan_bphtb_pengurangan_v2_events.php");
