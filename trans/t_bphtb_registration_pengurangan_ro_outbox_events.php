...
function BindEvents()
{
    ...
    $t_bphtb_registrationForm->Button8->CCSEvents["OnClick"] = "t_bphtb_registrationForm_Button8_OnClick";
    $t_bphtb_registrationForm->Button9->CCSEvents["OnClick"] = "t_bphtb_registrationForm_Button9_OnClick";
...
//t_bphtb_registrationForm_Button8_OnClick @226-B6A7A3C8
function t_bphtb_registrationForm_Button8_OnClick(& $sender)
{
    $t_bphtb_registrationForm_Button8_OnClick = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_bphtb_registrationForm; //Compatibility
//End t_bphtb_registrationForm_Button8_OnClick
...
//Close t_bphtb_registrationForm_Button8_OnClick @226-3C8742AB
    return $t_bphtb_registrationForm_Button8_OnClick;
}
//End Close t_bphtb_registrationForm_Button8_OnClick

//t_bphtb_registrationForm_Button9_OnClick @228-98BAE900
function t_bphtb_registrationForm_Button9_OnClick(& $sender)
{
    $t_bphtb_registrationForm_Button9_OnClick = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_bphtb_registrationForm; //Compatibility
//End t_bphtb_registrationForm_Button9_OnClick
...
//Close t_bphtb_registrationForm_Button9_OnClick @228-FD099D6B
    return $t_bphtb_registrationForm_Button9_OnClick;
}
//End Close t_bphtb_registrationForm_Button9_OnClick
