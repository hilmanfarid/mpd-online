<?php
//Include Common Files @1-3284B9CD
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_harian_v2.php");
...
//Operation Method @3-C9E6BB91
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_harian_v2.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_harian_v2.html";
$BlockToParse = "main";
...
//Include events file @1-6B0E687A
include_once("./t_rep_lap_harian_v2_events.php");
