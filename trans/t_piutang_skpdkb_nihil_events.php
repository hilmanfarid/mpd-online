...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->t_piutang_pajak_penetapan_final_id->GetValue();
        $t_vat_setllementForm->DataSource->Parameters["urlt_piutang_pajak_penetapan_final_id"] = $selected_id;
...
// End Bdr 
  	...
  	// Start Bdr    
          ...
          if ($Component->DataSource->t_piutang_pajak_penetapan_final_id->GetValue()== $selected_id) {
...
// -------------------------
	...
	$i_vat_setllement_id = $t_vat_setllementForm->t_piutang_pajak_penetapan_final_id->GetValue();
	$i_no_kohir = $t_vat_setllementForm->no_kohir->GetValue();
	
	
	$sql_update_kohir = "select f_update_no_kohir_vat_settlement(".$t_piutang_pajak_penetapan_final_id.",'".$i_no_kohir."') from dual";
...
//Page_OnInitializeView @1-A886D98E
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_piutang_skpdkb_nihil; //Compatibility
...
//End Custom Code
  ...
  // -------------------------
      // Write your own code here.
  	 global $selected_id;
          $selected_id = -1;
          $selected_id=CCGetFromGet("t_piutang_pajak_penetapan_final_id", $selected_id);
  // -------------------------
