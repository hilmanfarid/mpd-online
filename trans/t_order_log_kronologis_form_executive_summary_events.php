...
// -------------------------
    // Write your own code here.
		...
		$redirectloader = "t_order_log_kronologis_ver_executive_summary.php?t_customer_order_id=".$cusOrderId
...
//Page_OnInitializeView @1-826C3799
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_order_log_kronologis_form_executive_summary; //Compatibility
