<?php
//Include Common Files @1-DEE47F2E
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_bulanan_target_vs_realisasi.php");
...
//Operation Method @3-6F31C52F
    function Operation()
    {
        ...
        $Redirect = "t_rep_bulanan_target_vs_realisasi.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_bulanan_target_vs_realisasi.html";
$BlockToParse = "main";
...
//Include events file @1-8A5652D5
include_once("./t_rep_bulanan_target_vs_realisasi_events.php");
