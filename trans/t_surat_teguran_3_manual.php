<?php
//Include Common Files @1-7989E7ED
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_surat_teguran_3_manual.php");
...
//Class_Initialize Event @2-1E48FB49
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_surat_teguran_3_manual.php";
...
//DataSource Variables @2-88A7F4AF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-C74ECF3F
...
//Open Method @2-3CDE42C7
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select distinct (a.npwd), (a.npwd) as npwd2, b.wp_name, b.address_name,b.company_name, upper(c.vat_code) as jenis_pajak\n" .
        ...
        $this->SQL = "select distinct (a.npwd), (a.npwd) as npwd2, b.wp_name, b.address_name,b.company_name, upper(c.vat_code) as jenis_pajak\n" .
        "from t_cust_account a\n" .
        "left join t_cust_account b on a.t_cust_account_id = b.t_cust_account_id\n" .
        "left join p_vat_type c on c.p_vat_type_id = b.p_vat_type_id\n" .
        "where (a.npwd ilike '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
...
//Operation Method @3-07B8C2D6
    function Operation()
    {
        ...
        $Redirect = "t_surat_teguran_3_manual.php";
    }
...
//Class_Initialize Event @312-ACA9CBE6
...
//CheckErrors Method @312-92C4598F
    function CheckErrors()
    {
        $errors = false;
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_surat_teguran_3_manual.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_surat_teguran_3_manual.html";
$BlockToParse = "main";
...
//Include events file @1-570864A4
include_once("./t_surat_teguran_3_manual_events.php");
