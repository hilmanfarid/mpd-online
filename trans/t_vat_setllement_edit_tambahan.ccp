<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="CoffeeBreak" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_setllementGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="SQLParameters" dataSource="select b.code as finance_period_code,d.order_no,a.* from t_vat_setllement a
left join p_finance_period b on b.p_finance_period_id = a.p_finance_period_id
left join t_cust_account c on c.t_cust_account_id= a.t_cust_account_id
left join t_customer_order d on d.t_customer_order_id = a.t_customer_order_id
where p_settlement_type_id = 6
and d.p_order_status_id = 1
ORDER BY a.creation_date desc" parameterTypeListName="ParameterTypeList">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_vat_setllement_edit_tambahan.ccp" wizardThemeItem="GridA" PathID="t_vat_setllementGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
			...
			<SQLParameters>
				...
				<SQLParameter id="386" parameterType="Expression" variable="Expr1" dataType="Float" parameterSource="2" defaultValue="0"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Grid>
		<Record id="23" sourceType="SQL" urlType="Relative" secured="False" allowInsert="False" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="ConnSIKP" name="t_vat_setllementForm" errorSummator="Error" wizardCaption="Add/Edit P App Role " wizardFormMethod="post" PathID="t_vat_setllementForm" activeCollection="USPParameters" parameterTypeListName="ParameterTypeList" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" dataSource="select c.wp_name,c.wp_address_name||' '||c.wp_address_no as wp_address_name ,
e.vat_code as jenis_pajak,f.year_code, f.p_year_period_id,
b.code as finance_period_code,d.order_no,
...
a.* from t_vat_setllement a
left join p_finance_period b on b.p_finance_period_id = a.p_finance_period_id
left join t_cust_account c on c.t_cust_account_id= a.t_cust_account_id
left join t_customer_order d on d.t_customer_order_id = a.t_customer_order_id
left join p_vat_type e on e.p_vat_type_id = c.p_vat_type_id
left join p_year_period f on f.p_year_period_id = b.p_year_period_id
where a.t_vat_setllement_id = {t_vat_setllement_id} 
ORDER BY a.creation_date desc " customUpdateType="Procedure" customDeleteType="SQL" customDelete="select o_result_code, o_result_msg from f_first_submit_engine(501,{t_customer_order_id},'{UserName}')" customUpdate="f_crud_setllement_update">
			<Components>
				...
				<Button id="415" urlType="Relative" enableValidation="True" isDefault="False" name="Button3" PathID="t_vat_setllementFormButton3">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="387" parameterType="URL" variable="t_vat_setllement_id" dataType="Float" parameterSource="t_vat_setllement_id"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
			...
			<USQLParameters>
				<SQLParameter id="388" variable="finance_period_code" dataType="Text" parameterType="Control" parameterSource="finance_period_code"/>
				<SQLParameter id="389" variable="order_no" dataType="Text" parameterType="Control" parameterSource="order_no"/>
				<SQLParameter id="390" variable="total_trans_amount" dataType="Float" parameterType="Control" parameterSource="total_trans_amount" format="#,##0.00"/>
				<SQLParameter id="391" variable="total_vat_amount" dataType="Float" parameterType="Control" parameterSource="total_vat_amount" format="#,##0.00"/>
				<SQLParameter id="392" variable="npwd" dataType="Text" parameterType="Control" parameterSource="npwd"/>
				<SQLParameter id="393" variable="t_vat_setllement_id" dataType="Float" parameterType="Control" parameterSource="t_vat_setllement_id"/>
				<SQLParameter id="394" variable="t_cust_account_id" dataType="Float" parameterType="Control" parameterSource="t_cust_account_id"/>
				<SQLParameter id="395" variable="p_vat_type_id" dataType="Text" parameterType="Control" parameterSource="p_vat_type_id"/>
				<SQLParameter id="396" variable="p_rqst_type_id" dataType="Float" parameterType="Control" parameterSource="p_rqst_type_id"/>
				<SQLParameter id="397" variable="year_code" dataType="Text" parameterType="Control" parameterSource="year_code"/>
				<SQLParameter id="398" variable="p_year_period_id" dataType="Float" parameterType="Control" parameterSource="p_year_period_id"/>
				<SQLParameter id="399" variable="jenis_pajak" dataType="Text" parameterType="Control" parameterSource="jenis_pajak"/>
				<SQLParameter id="400" variable="wp_name" dataType="Text" parameterType="Control" parameterSource="wp_name"/>
				<SQLParameter id="401" variable="wp_address_name" dataType="Text" parameterType="Control" parameterSource="wp_address_name"/>
				<SQLParameter id="402" variable="start_period" dataType="Text" parameterType="Control" parameterSource="start_period" format="dd-mmm-yyyy"/>
				<SQLParameter id="403" variable="end_period" dataType="Text" parameterType="Control" parameterSource="end_period" format="dd-mmm-yyyy"/>
				<SQLParameter id="404" variable="due_date" dataType="Text" parameterType="Control" parameterSource="due_date" format="dd-mmm-yyyy"/>
				<SQLParameter id="405" variable="debt_vat_amt" dataType="Float" parameterType="Control" parameterSource="debt_vat_amt" format="#,##0.00"/>
				<SQLParameter id="406" variable="cr_adjustment" dataType="Float" parameterType="Control" parameterSource="cr_adjustment" format="#,##0.00"/>
				<SQLParameter id="407" variable="cr_others" dataType="Float" parameterType="Control" parameterSource="cr_others" format="#,##0.00"/>
				<SQLParameter id="408" variable="cr_payment" dataType="Float" parameterType="Control" parameterSource="cr_payment" format="#,##0.00"/>
				<SQLParameter id="409" variable="cr_stp" dataType="Float" parameterType="Control" parameterSource="cr_stp" format="#,##0.00"/>
				<SQLParameter id="410" variable="db_interest_charge" dataType="Float" parameterType="Control" parameterSource="db_interest_charge" format="#,##0.00"/>
				<SQLParameter id="411" variable="db_increasing_charge" dataType="Float" parameterType="Control" parameterSource="db_increasing_charge" format="#,##0.00"/>
				<SQLParameter id="412" variable="t_customer_order_id" dataType="Float" parameterType="Control" parameterSource="t_customer_order_id"/>
				<SQLParameter id="413" variable="p_finance_period_id" dataType="Float" parameterType="Control" parameterSource="p_finance_period_id"/>
				<SQLParameter id="414" variable="total_penalty_amount" dataType="Float" parameterType="Control" parameterSource="total_penalty_amount" format="#,##0.00"/>
			</USQLParameters>
			<UConditions>
			</UConditions>
			<UFormElements>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_setllement_edit_tambahan_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_vat_setllement_edit_tambahan.php" forShow="True" url="t_vat_setllement_edit_tambahan.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
