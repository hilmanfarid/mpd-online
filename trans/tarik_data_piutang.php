<?php
//Include Common Files @1-276A1149
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "tarik_data_piutang.php");
...
//Class_Initialize Event @2-E251BDD5
...
//Operation Method @2-4236B472
    function Operation()
    {
        ...
        $Redirect = "tarik_data_piutang.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "tarik_data_piutang.html";
$BlockToParse = "main";
...
//Include events file @1-BD8DFB08
include_once("./tarik_data_piutang_events.php");
