...
// -------------------------
    // Write your own code here.
		...
		$redirectloader = "t_order_log_kronologis_srt.php?t_customer_order_id=".$cusOrderId
...
//Page_OnInitializeView @1-F9151133
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_order_log_kronologis_form_srt; //Compatibility
