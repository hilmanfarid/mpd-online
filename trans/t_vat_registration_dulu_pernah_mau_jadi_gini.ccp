...
ORDER BY p_doc_delivery_type_id" orderBy="p_private_question_id" boundColumn="p_doc_delivery_type_id" textColumn="code" fieldSource="p_doc_delivery_type_id" caption="Pilih media pengiriman">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_registration_dulu_pernah_mau_jadi_gini_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_vat_registration_dulu_pernah_mau_jadi_gini.php" forShow="True" url="t_vat_registration_dulu_pernah_mau_jadi_gini.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
