<?php
//Include Common Files @1-F97833CD
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_ver_executive_summary.php");
...
//Class_Initialize Event @2-28E62ECC
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_ver_executive_summary.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_ver_executive_summary.php";
...
//Operation Method @3-13A0BDBD
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_ver_executive_summary.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_ver_executive_summary.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_ver_executive_summary.html";
$BlockToParse = "main";
...
//Include events file @1-C974E17D
include_once("./t_cust_order_legal_doc_ro_ver_executive_summary_events.php");
