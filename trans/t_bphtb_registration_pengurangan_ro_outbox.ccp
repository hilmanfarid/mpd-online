...
WHERE pemeriksa_status = 'pemeriksa'"><Components/>
				...
				<Button id="228" urlType="Relative" enableValidation="True" isDefault="False" name="Button9" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_bphtb_registrationFormButton9">
					<Components/>
					<Events>
						<Event name="OnClick" type="Server">
							<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_registration_pengurangan_ro_outbox_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_registration_pengurangan_ro_outbox.php" forShow="True" url="t_bphtb_registration_pengurangan_ro_outbox.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
