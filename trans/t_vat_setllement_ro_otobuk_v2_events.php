...
function BindEvents()
{
    ...
    $t_vat_setllementForm->Button3->CCSEvents["OnClick"] = "t_vat_setllementForm_Button3_OnClick";
...
// -------------------------
	...
	if(empty($payment_key)) {
		...
		$urlref = "../report/cetak_no_bayar.php?no_bayar=".$payment_key;
		echo "
  			<script>
...
//t_vat_setllementForm_Button3_OnClick @362-487267B9
function t_vat_setllementForm_Button3_OnClick(& $sender)
{
    $t_vat_setllementForm_Button3_OnClick = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_vat_setllementForm; //Compatibility
//End t_vat_setllementForm_Button3_OnClick

//Custom Code @363-2A29BDB7
// -------------------------
    $no_kohir = $t_vat_setllementForm->no_kohir->GetValue();
	...
	if(empty($payment_key)) {
		...
		$urlref = "http://172.16.21.7:81/mpd-wp/client/ws.php?type=json&module=bds&class=t_vat_settlement&method=printNoBayar&no_bayar=".$payment_key;
		echo "
  			<script>
  				window.open('".$urlref."', '_blank', 'location=yes,height=500,width=800,scrollbars=yes,status=yes');
  			</script>
...
//Close t_vat_setllementForm_Button3_OnClick @362-35D79CF3
    return $t_vat_setllementForm_Button3_OnClick;
}
//End Close t_vat_setllementForm_Button3_OnClick
...
//Page_OnInitializeView @1-AE71A795
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_vat_setllement_ro_otobuk_v2; //Compatibility
