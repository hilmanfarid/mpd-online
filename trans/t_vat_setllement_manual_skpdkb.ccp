...
<CustomParameter id="178" field="p_vat_type_dtl_cls_id" dataType="Text" parameterType="Control" parameterSource="p_vat_type_dtl_cls_id"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_setllement_manual_skpdkb_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_vat_setllement_manual_skpdkb.php" forShow="True" url="t_vat_setllement_manual_skpdkb.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
