<?php
//Include Common Files @1-1766226E
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_penerimaan_pertahun_sts.php");
...
//Class_Initialize Event @3-1316D029
    function clsRecordt_rep_penerimaan_pertahunSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->periode_piutang_start = & new clsControl(ccsTextBox, "periode_piutang_start", "periode_piutang_start", ccsDate, array("dd", "-", "mm", "-", "yyyy"), CCGetRequestParam("periode_piutang_start", $Method, NULL), $this);
...
//Validate Method @3-D1711DC1
    function Validate()
    {
        ...
        $Validation = ($this->periode_piutang_start->Validate() && $Validation);
        $Validation = ($this->periode_piutang_end->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->periode_piutang_start->Errors->Count() == 0);
        $Validation =  $Validation && ($this->periode_piutang_end->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-6DA4DB66
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->periode_piutang_start->Errors->Count());
        $errors = ($errors || $this->DatePicker_tgl_penerimaan1->Errors->Count());
        $errors = ($errors || $this->periode_piutang_end->Errors->Count());
        $errors = ($errors || $this->DatePicker_tgl_penerimaan2->Errors->Count());
...
//Show Method @3-40856D49
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->periode_piutang_start->Errors->ToString());
            $Error = ComposeStrings($Error, $this->DatePicker_tgl_penerimaan1->Errors->ToString());
            $Error = ComposeStrings($Error, $this->periode_piutang_end->Errors->ToString());
            $Error = ComposeStrings($Error, $this->DatePicker_tgl_penerimaan2->Errors->ToString());
        ...
        $this->periode_piutang_start->Show();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_penerimaan_pertahun_sts.html";
$BlockToParse = "main";
...
//Include events file @1-965C4D99
include_once("./t_rep_penerimaan_pertahun_sts_events.php");
