<?php
//Include Common Files @1-604DCF90
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_target_realisasi_perbandingan.php");
...
//Operation Method @3-1BA51545
    function Operation()
    {
        ...
        $Redirect = "t_target_realisasi_perbandingan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_target_realisasi_perbandingan.html";
$BlockToParse = "main";
...
//Include events file @1-E2F6C1E3
include_once("./t_target_realisasi_perbandingan_events.php");
