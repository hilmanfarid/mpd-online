	...
	<Components>
		<Record id="2" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_laporan_penerimaan_bphtb" wizardCaption="Search T Payment Receipt " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="t_laporan_permohonan_bphtb_pengurangan.ccp" PathID="t_laporan_penerimaan_bphtb" pasteActions="pasteActions">
			<Components>
				...
				<ListBox id="29" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="p_bphtb_legal_doc_type_id" wizardEmptyCaption="Select Value" PathID="t_laporan_penerimaan_bphtbp_bphtb_legal_doc_type_id" connection="ConnSIKP" fieldSource="p_bphtb_legal_doc_type_id" _valueOfList="5" _nameOfList="5" dataSource="select p_bphtb_legal_doc_type_id,description 
from p_bphtb_legal_doc_type">
		...
		<Label id="31" fieldSourceType="DBColumn" dataType="Text" html="True" name="Label1" PathID="Label1">
			<Components/>
			<Events/>
			<Attributes/>
			<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_laporan_permohonan_bphtb_pengurangan_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_laporan_permohonan_bphtb_pengurangan.php" forShow="True" url="t_laporan_permohonan_bphtb_pengurangan.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
