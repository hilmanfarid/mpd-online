<?php
//Include Common Files @1-8CA6DD1B
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_register_kas_berdasarkan_ketetapan.php");
...
//Class_Initialize Event @3-6BB3EF98
...
//Operation Method @3-AA38D8B5
    function Operation()
    {
        ...
        $Redirect = "t_laporan_register_kas_berdasarkan_ketetapan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_register_kas_berdasarkan_ketetapan.html";
$BlockToParse = "main";
...
//Include events file @1-622F881C
include_once("./t_laporan_register_kas_berdasarkan_ketetapan_events.php");
