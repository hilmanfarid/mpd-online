<?php
//Include Common Files @1-0B005F8A
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_list_check_date.php");
...
//Class_Initialize Event @3-F67BA53F
    function clsRecordt_cust_order_legal_docSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->DatePicker_date_start_laporan1 = & new clsDatePicker("DatePicker_date_start_laporan1", "t_cust_order_legal_docSearch", "date_start_laporan", $this);
            ...
            $this->DatePicker_end_start_laporan1 = & new clsDatePicker("DatePicker_end_start_laporan1", "t_cust_order_legal_docSearch", "date_end_laporan", $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-F58DE236
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//Operation Method @3-6EB8368B
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_list_check_date.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_list_check_date.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "Button_DoSearch1", "Button_DoSearch1_x", "Button_DoSearch1_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_list_check_date.html";
$BlockToParse = "main";
...
//Include events file @1-B5570648
include_once("./t_bphtb_registration_list_check_date_events.php");
...
//Go to destination page @1-88F18228
if($Redirect)
{
