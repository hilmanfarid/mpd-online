<?php
//Include Common Files @1-951745C6
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_dtl_ro_otobuk_tapping.php");
...
//Class_Initialize Event @2-BD42A3CB
...
//DataSource Variables @2-0C57AEFE
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-CDAF6835
...
//Operation Method @3-7EDC6BE1
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_dtl_ro_otobuk_tapping.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_dtl_ro_otobuk_tapping.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_dtl_ro_otobuk_tapping.html";
$BlockToParse = "main";
...
//Include events file @1-02BB5A84
include_once("./t_vat_setllement_dtl_ro_otobuk_tapping_events.php");
