<?php
//Include Common Files @1-12DEC2BD
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_harian_vop.php");
...
//Class_Initialize Event @3-99CE3FE3
    function clsRecordt_rep_lap_harian_bdhrSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->nama_teller->DSType = dsSQL;
            $this->nama_teller->DataSource = new clsDBConnSIKP();
            $this->nama_teller->ds = & $this->nama_teller->DataSource;
...
//Operation Method @3-2C8B391C
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_harian_vop.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_harian_vop.html";
$BlockToParse = "main";
...
//Include events file @1-A5F30715
include_once("./t_rep_lap_harian_vop_events.php");
