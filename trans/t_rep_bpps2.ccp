<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions" connection="ConnSIKP">
	<Components>
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_rep_bppsSearch" returnPage="t_rep_bpps2.ccp" PathID="t_rep_bppsSearch" pasteActions="pasteActions">
			<Components>
				...
				<ListBox id="570" visible="Yes" fieldSourceType="DBColumn" sourceType="ListOfValues" dataType="Text" returnValueType="Number" name="status" wizardEmptyCaption="Select Value" PathID="t_rep_bppsSearchstatus" connection="ConnSIKP" dataSource=";Semua;1;ACTIVE;2;NON-ACTIVE" fieldSource="i_flag_setoran" _nameOfList="Semua">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_rep_bpps2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_rep_bpps2.php" forShow="True" url="t_rep_bpps2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
