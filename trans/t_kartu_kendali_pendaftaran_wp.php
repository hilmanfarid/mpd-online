<?php
//Include Common Files @1-F7B41A8B
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_kartu_kendali_pendaftaran_wp.php");
...
//Class_Initialize Event @3-BF2F815F
...
//Operation Method @3-1E192080
    function Operation()
    {
        ...
        $Redirect = "t_kartu_kendali_pendaftaran_wp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_kartu_kendali_pendaftaran_wp.html";
$BlockToParse = "main";
...
//Include events file @1-1FB9FC8D
include_once("./t_kartu_kendali_pendaftaran_wp_events.php");
