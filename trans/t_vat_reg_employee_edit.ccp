...
WHERE t_vat_reg_employee_id={t_vat_reg_employee_id}" customDelete="DELETE FROM t_vat_reg_employee
WHERE t_vat_reg_employee_id = {t_vat_reg_employee_id}" dataSource="v_vat_reg_employee">
			<Components>
				...
				<Hidden id="101" fieldSourceType="DBColumn" dataType="Float" name="t_vat_reg_employee_id" fieldSource="t_vat_reg_employee_id" caption="Id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_vat_reg_employeeFormt_vat_reg_employee_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="677" fieldSourceType="DBColumn" dataType="Text" html="False" name="rqst_type_code" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="t_vat_reg_employeeFormrqst_type_code">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="752" fieldSourceType="DBColumn" dataType="Float" name="p_rqst_type_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_employeeFormp_rqst_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="753" fieldSourceType="DBColumn" dataType="Float" name="t_customer_order_id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_vat_reg_employeeFormt_customer_order_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="619" fieldSourceType="DBColumn" dataType="Float" name="t_vat_registration_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_employeeFormt_vat_registration_id" fieldSource="t_vat_registration_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Hidden id="567" fieldSourceType="DBColumn" dataType="Float" name="p_job_position_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_employeeFormp_job_position_id" fieldSource="p_job_position_id" caption="p_job_position_id">
			...
			<TableParameters>
				<TableParameter id="762" conditionType="Parameter" useIsNull="False" field="t_vat_reg_employee_id" dataType="Float" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="t_vat_reg_employee_id"/>
</TableParameters>
			<SPParameters/>
			<SQLParameters>
			</SQLParameters>
			<JoinTables>
				<JoinTable id="761" tableName="v_vat_reg_employee" posLeft="10" posTop="10" posWidth="160" posHeight="180"/>
</JoinTables>
			<JoinLinks/>
			<Fields>
			</Fields>
			...
			<USQLParameters>
				<SQLParameter id="738" variable="t_vat_reg_employee_id" dataType="Float" parameterType="Control" parameterSource="t_vat_reg_employee_id" defaultValue="0"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_reg_employee_edit_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_vat_reg_employee_edit.php" forShow="True" url="t_vat_reg_employee_edit.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
