<?php
//Include Common Files @1-885FAF5E
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_ubah_register.php");
...
//Operation Method @3-4F5B1355
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_ubah_register.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_ubah_register.html";
$BlockToParse = "main";
...
//Include events file @1-0B9A7F06
include_once("./t_bphtb_ubah_register_events.php");
