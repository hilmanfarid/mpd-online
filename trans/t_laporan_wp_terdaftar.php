<?php
//Include Common Files @1-93F85327
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_wp_terdaftar.php");
...
//Class_Initialize Event @2-24D0FE0F
    function clsRecordt_laporan_piutang_pajak($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->p_account_status_id->Values = array(array("1", "Terdaftar"), array("2", "Tutup"));
...
//Operation Method @2-9CCF5E19
    function Operation()
    {
        ...
        $Redirect = "t_laporan_wp_terdaftar.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_wp_terdaftar.html";
$BlockToParse = "main";
...
//Include events file @1-61161BCE
include_once("./t_laporan_wp_terdaftar_events.php");
