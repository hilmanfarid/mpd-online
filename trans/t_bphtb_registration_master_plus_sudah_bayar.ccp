...
'{user_name}' 
			...
			<Components>
				...
				<Button id="96" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Submit" PathID="t_bphtb_registrationFormButton_Update" removeParameters="FLAG" returnPage="t_bphtb_registration_list_update_master_sudah_bayar.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
" boundColumn="p_bphtb_legal_doc_type_id" textColumn="code" features="(assigned)" fieldSource="p_bphtb_legal_doc_type_id">
					...
					<Attributes/>
					<Features>
						<PTAutoFill id="951" enabled="True" valueField="value" sourceType="Table" name="PTAutoFill2" servicePage="../services/trans_t_bphtb_registration_t_bphtb_registrationForm_p_bphtb_legal_doc_type_id_PTAutoFill1.ccp" searchField="p_bphtb_legal_doc_type_id" connection="ConnSIKP" featureNameChanged="No" dataSource="p_bphtb_legal_doc_type, p_legal_doc_type" category="Prototype">
							<Components/>
							<Events/>
							<TableParameters/>
							<SPParameters/>
			...
			<USQLParameters>
				...
				<SQLParameter id="1043" variable="p_bphtb_legal_doc_type_id" parameterType="Control" defaultValue="0" dataType="Integer" parameterSource="p_bphtb_legal_doc_type_id"/>
				<SQLParameter id="1044" variable="land_area" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="land_area"/>
				<SQLParameter id="1045" variable="land_price_per_m" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="land_price_per_m"/>
				<SQLParameter id="1046" variable="land_total_price" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="land_total_price"/>
				<SQLParameter id="1047" variable="building_area" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="building_area"/>
				<SQLParameter id="1048" variable="building_price_per_m" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="building_price_per_m"/>
				<SQLParameter id="1049" variable="building_total_price" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="building_total_price"/>
				<SQLParameter id="1050" variable="market_price" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="market_price"/>
				<SQLParameter id="1051" variable="npop" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="npop"/>
				<SQLParameter id="1052" variable="npop_tkp" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="npop_tkp"/>
				<SQLParameter id="1053" variable="npop_kp" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="npop_kp"/>
				<SQLParameter id="1054" variable="bphtb_amt" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="bphtb_amt"/>
				<SQLParameter id="1055" variable="bphtb_discount" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="bphtb_discount"/>
				<SQLParameter id="1056" variable="bphtb_amt_final" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="bphtb_amt_final"/>
				<SQLParameter id="1057" variable="description" parameterType="Control" dataType="Text" parameterSource="description"/>
				<SQLParameter id="1058" variable="jenis_harga_bphtb" parameterType="Control" defaultValue="0" dataType="Integer" parameterSource="jenis_harga_bphtb"/>
				<SQLParameter id="1059" variable="bphtb_legal_doc_description" parameterType="Control" dataType="Text" parameterSource="bphtb_legal_doc_description"/>
				<SQLParameter id="1060" variable="add_disc_percent" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="add_disc_percent"/>
			</USQLParameters>
			<UConditions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_registration_master_plus_sudah_bayar_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_registration_master_plus_sudah_bayar.php" forShow="True" url="t_bphtb_registration_master_plus_sudah_bayar.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
