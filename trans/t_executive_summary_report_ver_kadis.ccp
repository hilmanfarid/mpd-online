...
<SQLParameter id="969" variable="t_executive_summary_id" parameterType="Control" defaultValue="0" dataType="Integer" parameterSource="t_executive_summary_id"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_executive_summary_report_ver_kadis_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_executive_summary_report_ver_kadis.php" forShow="True" url="t_executive_summary_report_ver_kadis.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
