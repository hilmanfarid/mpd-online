<?php
//Include Common Files @1-D374ADB6
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_ubah_register_list.php");
...
//Class_Initialize Event @2-E202E25F
    function clsGridt_bphtb_registrationGrid($RelativePath, & $Parent)
    {
        ...
        $this->BtnHapus = & new clsButton("BtnHapus", ccsGet, $this);
...
//Show Method @2-D724D868
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["BtnHapus"] = $this->BtnHapus->Visible;
...
//Open Method @2-6C0D3FCD
    function Open()
    {
        ...
        ")\n" .
        "and b.t_payment_receipt_bphtb_id is not null) cnt";
        ...
        "  upper(a.registration_no) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")\n" .
        "and b.t_payment_receipt_bphtb_id is not null {SQL_OrderBy}";
...
//Operation Method @3-5B51025C
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_ubah_register_list.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_ubah_register_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_ubah_register_list.html";
$BlockToParse = "main";
...
//Include events file @1-C09241D6
include_once("./t_bphtb_ubah_register_list_events.php");
