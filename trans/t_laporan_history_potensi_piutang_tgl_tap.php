<?php
//Include Common Files @1-DD9730E2
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_history_potensi_piutang_tgl_tap.php");
...
//Class_Initialize Event @3-74A15E05
...
//Operation Method @3-DC11CDFE
    function Operation()
    {
        ...
        $Redirect = "t_laporan_history_potensi_piutang_tgl_tap.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_history_potensi_piutang_tgl_tap.html";
$BlockToParse = "main";
...
//Include events file @1-19800207
include_once("./t_laporan_history_potensi_piutang_tgl_tap_events.php");
