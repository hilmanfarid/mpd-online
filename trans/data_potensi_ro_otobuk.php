<?php
//Include Common Files @1-816C2964
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "data_potensi_ro_otobuk.php");
...
//Class_Initialize Event @688-0AE85C4B
    function clsGridt_vat_reg_dtl_restaurantGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "data_potensi_ro_otobuk.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "data_potensi_ro_otobuk.php";
...
//Class_Initialize Event @790-C1F832F5
...
//Class_Initialize Event @814-69C1410A
...
//Class_Initialize Event @838-AB4AEA24
...
//Class_Initialize Event @862-C513BFDD
...
//Class_Initialize Event @896-F5D7FEFA
...
//DataSource Variables @896-41756E37
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @896-ED5A9D48
...
//Prepare Method @896-2AF53C1A
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlt_cacc_dtl_ppj_id", ccsFloat, "", "", $this->Parameters["urlt_cacc_dtl_ppj_id"], "", false);
    }
//End Prepare Method

//Open Method @896-5B169B18
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        ...
        "FROM t_cacc_dtl_ppj\n" .
        "WHERE t_cacc_dtl_ppj_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "AND is_pln = 'N' ) cnt";
...
//Class_Initialize Event @915-EA027848
...
//DataSource Variables @915-75F28BA1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @915-94DF3F40
...
//Class_Initialize Event @3-2815C61A
...
class clsGridt_vat_reg_employeeGrid { //t_vat_reg_employeeGrid class @1005-B79C6852

//Variables @1005-AC1EDBB9
...
//Class_Initialize Event @1005-3BCAB1CE
...
//Initialize Method @1005-90E704C5
    function Initialize()
    {
        if(!$this->Visible) return;
...
//GetErrors Method @1005-E16DF06E
    function GetErrors()
    {
        $errors = "";
...
} //End t_vat_reg_employeeGrid Class @1005-FCB6E20C

class clst_vat_reg_employeeGridDataSource extends clsDBConnSIKP {  //t_vat_reg_employeeGridDataSource Class @1005-785B9916

//DataSource Variables @1005-C3343826
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @1005-531FC0F8
...
//SetValues Method @1005-155B00EE
    function SetValues()
    {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "data_potensi_ro_otobuk.html";
$BlockToParse = "main";
...
//Include events file @1-017A456C
include_once("./data_potensi_ro_otobuk_events.php");
