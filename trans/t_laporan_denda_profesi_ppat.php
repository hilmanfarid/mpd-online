<?php
//Include Common Files @1-64F006A0
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_denda_profesi_ppat.php");
...
//Class_Initialize Event @3-062EE6BE
...
//Operation Method @3-6F3748A3
    function Operation()
    {
        ...
        $Redirect = "t_laporan_denda_profesi_ppat.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_denda_profesi_ppat.html";
$BlockToParse = "main";
...
//Include events file @1-717A0E84
include_once("./t_laporan_denda_profesi_ppat_events.php");
