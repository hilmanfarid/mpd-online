<?php
//Include Common Files @1-8F4A2A54
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_registration2.php");
...
//Class_Initialize Event @94-5E3E750D
...
"FROM p_entertaintment_type {SQL_Where} {SQL_OrderBy}";
            list($this->p_entertaintment_type_id->BoundColumn, $this->p_entertaintment_type_id->TextColumn, $this->p_entertaintment_type_id->DBFormat) = array("p_entertaintment_type_id", "code", "");
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_registration2.html";
$BlockToParse = "main";
...
//Include events file @1-332BBA3E
include_once("./t_vat_registration2_events.php");
