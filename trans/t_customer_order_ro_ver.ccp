...
WHERE t_customer_order_id = {CURR_DOC_ID} ">
			<Components>
				...
				<Hidden id="938" fieldSourceType="DBColumn" dataType="Text" name="Hidden1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_registrationFormHidden1">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_customer_order_ro_ver_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_customer_order_ro_ver.php" forShow="True" url="t_customer_order_ro_ver.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
