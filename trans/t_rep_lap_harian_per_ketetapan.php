<?php
//Include Common Files @1-C863C9B8
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_harian_per_ketetapan.php");
...
//Operation Method @3-4D421FAA
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_harian_per_ketetapan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_harian_per_ketetapan.html";
$BlockToParse = "main";
...
//Include events file @1-78C846AE
include_once("./t_rep_lap_harian_per_ketetapan_events.php");
