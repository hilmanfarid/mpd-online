<?php
//Include Common Files @1-92C9DFDE
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_cetak_skpd.php");
...
//Class_Initialize Event @2-E408A5FE
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_cetak_skpd.php";
...
//Operation Method @3-DB965CF1
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_cetak_skpd.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_cetak_skpd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_cetak_skpd.html";
$BlockToParse = "main";
...
//Include events file @1-42EA85D0
include_once("./t_vat_setllement_cetak_skpd_events.php");
