<?php 
//Include Common Files @1-DD8F358D
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_edit_lb.php");
...
//Class_Initialize Event @2-D7F35957
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_edit_lb.php";
...
//Class_Initialize Event @23-7191C7F4
...
//Operation Method @3-99D90032
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_edit_lb.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_edit_lb.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_edit_lb.html";
$BlockToParse = "main";
...
//Include events file @1-0DF26085
include_once("./t_vat_setllement_edit_lb_events.php");
