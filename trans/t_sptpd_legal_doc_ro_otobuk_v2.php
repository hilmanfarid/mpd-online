<?php
//Include Common Files @1-B17EDF97
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_sptpd_legal_doc_ro_otobuk_v2.php");
...
//Class_Initialize Event @2-A8F8CCD4
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_sptpd_legal_doc_ro_otobuk_v2.php";
        ...
        $this->Insert_Link->Page = "t_sptpd_legal_doc_ro_otobuk_v2.php";
...
//Class_Initialize Event @3-EAD6DC24
...
//Operation Method @3-30C93163
    function Operation()
    {
        ...
        $Redirect = "t_sptpd_legal_doc_ro_otobuk_v2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_sptpd_legal_doc_ro_otobuk_v2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_sptpd_legal_doc_ro_otobuk_v2.html";
$BlockToParse = "main";
...
//Include events file @1-DCAAE0F5
include_once("./t_sptpd_legal_doc_ro_otobuk_v2_events.php");
