<?php 
//Include Common Files @1-F60E458A
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_penutupan_wp_master.php");
...
//Class_Initialize Event @2-375941EF
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_penutupan_wp_master.php";
...
//Operation Method @3-8959A0FF
    function Operation()
    {
        ...
        $Redirect = "t_penutupan_wp_master.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_penutupan_wp_master.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_penutupan_wp_master.html";
$BlockToParse = "main";
...
//Include events file @1-D7991152
include_once("./t_penutupan_wp_master_events.php");
