...
// -------------------------
	...
	if ( CCGetFromGet('s_keyword','') ==  '' && 
		...
		if ( CCGetFromGet('date_end_laporan','') !=  '' ){
			$p_room_typeGrid->DataSource->SQL .= " and (modification_date < '".CCGetFromGet('date_end_laporan','')."')";
		}
		if ( CCGetFromGet('date_start_laporan','') !=  '' ){
			$p_room_typeGrid->DataSource->SQL .= " and (modification_date > '".CCGetFromGet('date_start_laporan','')."')";
		}
