<?php
//Include Common Files @1-6F8DA80C
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_pembayaran_wp_baru_summary.php");
...
//Operation Method @2-221C9781
    function Operation()
    {
        ...
        $Redirect = "t_laporan_pembayaran_wp_baru_summary.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_pembayaran_wp_baru_summary.html";
$BlockToParse = "main";
...
//Include events file @1-13736932
include_once("./t_laporan_pembayaran_wp_baru_summary_events.php");
