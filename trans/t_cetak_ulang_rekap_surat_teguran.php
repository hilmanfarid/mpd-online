<?php
//Include Common Files @1-0E0F1CB0
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cetak_ulang_rekap_surat_teguran.php");
...
//Class_Initialize Event @3-D5135648
...
//Operation Method @3-D4CD096D
    function Operation()
    {
        ...
        $Redirect = "t_cetak_ulang_rekap_surat_teguran.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cetak_ulang_rekap_surat_teguran.html";
$BlockToParse = "main";
...
//Include events file @1-EFEE890D
include_once("./t_cetak_ulang_rekap_surat_teguran_events.php");
