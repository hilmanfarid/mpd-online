<?php
//Include Common Files @1-4326FC25
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis_kasi.php");
...
//Operation Method @3-000478EA
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis_kasi.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis_kasi.html";
$BlockToParse = "main";
...
//Include events file @1-E19D402C
include_once("./t_order_log_kronologis_kasi_events.php");
