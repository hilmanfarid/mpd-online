<?php
//Include Common Files @1-D5B679D2
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_rekap_surat_teguran_per_bulan.php");
...
//Class_Initialize Event @3-4DDF86DB
...
//Operation Method @3-23609F9E
    function Operation()
    {
        ...
        $Redirect = "t_laporan_rekap_surat_teguran_per_bulan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_rekap_surat_teguran_per_bulan.html";
$BlockToParse = "main";
...
//Include events file @1-580F3A38
include_once("./t_laporan_rekap_surat_teguran_per_bulan_events.php");
