<?php
//Include Common Files @1-C9942264
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_ver_penutupan.php");
...
//Class_Initialize Event @2-9E9E425A
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_ver_penutupan.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_ver_penutupan.php";
...
//Operation Method @3-E4F8B464
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_ver_penutupan.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_ver_penutupan.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_ver_penutupan.html";
$BlockToParse = "main";
...
//Include events file @1-1D9CC69C
include_once("./t_cust_order_legal_doc_ro_ver_penutupan_events.php");
