<?php
//Include Common Files @1-C3B2AC38
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_perkembangan_jumlah_wp.php");
...
//Class_Initialize Event @3-25652763
...
//Operation Method @3-EF6A4D90
    function Operation()
    {
        ...
        $Redirect = "t_laporan_perkembangan_jumlah_wp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_perkembangan_jumlah_wp.html";
$BlockToParse = "main";
...
//Include events file @1-2429D596
include_once("./t_laporan_perkembangan_jumlah_wp_events.php");
