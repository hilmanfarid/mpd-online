...
where sysdate between start_date and end_date">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_target_realisasi_jenis_view_large_dengan_target_triwulan_v3_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_target_realisasi_jenis_view_large_dengan_target_triwulan_v3.php" forShow="True" url="t_target_realisasi_jenis_view_large_dengan_target_triwulan_v3.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
