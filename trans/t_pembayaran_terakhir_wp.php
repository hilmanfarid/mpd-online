<?php
//Include Common Files @1-6990A831
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_pembayaran_terakhir_wp.php");
...
//Operation Method @3-9B5668FE
    function Operation()
    {
        ...
        $Redirect = "t_pembayaran_terakhir_wp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_pembayaran_terakhir_wp.html";
$BlockToParse = "main";
...
//Include events file @1-64226B39
include_once("./t_pembayaran_terakhir_wp_events.php");
