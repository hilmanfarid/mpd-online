...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->npwd->GetValue();
   }
// End Bdr  
...
//Set Row Style @10-982C9472
	...
	// Start Bdr    
      ...
      if ($Component->DataSource->npwd->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-F9EBCA0A
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_surat_teguran_piutang_pajak_penetapan_final2; //Compatibility
...
// -------------------------
    // Write your own code here.
	  global $selected_id;
      $selected_id = -1;
      $selected_id=CCGetFromGet("npwd", $selected_id);
// -------------------------
//End Custom Code
