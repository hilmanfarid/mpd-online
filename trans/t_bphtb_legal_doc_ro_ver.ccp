<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_cust_order_legal_docGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cust_order_legal_doc">
			<Components>
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Insert_Link" hrefSource="t_bphtb_legal_doc_ro_ver.ccp" removeParameters="t_cust_order_legal_doc_id;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="t_cust_order_legal_docGridInsert_Link">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_bphtb_legal_doc_ro_ver.ccp" wizardThemeItem="GridA" PathID="t_cust_order_legal_docGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
...
WHERE t_cust_order_legal_doc_id = {t_cust_order_legal_doc_id} ">
			<Components>
				...
				<Hidden id="619" fieldSourceType="DBColumn" dataType="Float" name="t_customer_order_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cust_order_legal_docFormt_customer_order_id" fieldSource="t_customer_order_id" visible="Yes">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<ListBox id="720" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="p_legal_doc_type_id" wizardEmptyCaption="Select Value" PathID="t_cust_order_legal_docFormp_legal_doc_type_id" connection="ConnSIKP" dataSource="SELECT
...
WHERE
	t_bphtb_registration.t_bphtb_registration_id = {t_bphtb_registration_id}
	and bphtb_sspd_legal_doc.p_legal_doc_type_id_child not in(select p_legal_doc_type_id from t_cust_order_legal_doc where t_customer_order_id={t_customer_order_id})
UNION SELECT
	bphtb_sspd_legal_doc.p_legal_doc_type_id_child AS p_bphtb_legal_doc_type_id,
	bphtb_sspd_legal_doc.code
...
where t_cust_order_legal_doc.t_cust_order_legal_doc_id={t_cust_order_legal_doc_id}" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" fieldSource="p_legal_doc_type_id">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
					<SQLParameters>
						<SQLParameter id="722" variable="t_bphtb_registration_id" parameterType="URL" dataType="Text" parameterSource="t_bphtb_registration_id" designDefaultValue="26"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_legal_doc_ro_ver_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_legal_doc_ro_ver.php" forShow="True" url="t_bphtb_legal_doc_ro_ver.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
