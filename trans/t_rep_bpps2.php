<?php
//Include Common Files @1-AA4A3B92
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_bpps2.php");
...
//Class_Initialize Event @3-D9986EBA
    function clsRecordt_rep_bppsSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->status->Values = array(array("", "Semua"), array("1", "ACTIVE"), array("2", "NON-ACTIVE"));
        }
    }
//End Class_Initialize Event

//Validate Method @3-84FEBC62
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_bpps2.html";
$BlockToParse = "main";
...
//Include events file @1-DEF7E8B9
include_once("./t_rep_bpps2_events.php");
