<?php
//Include Common Files @1-CB9C47B8
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_pembayaran_berdasarkan_cara_bayar_dan_ketetapan.php");
...
//Class_Initialize Event @3-15A91300
    function clsRecordt_rep_lap_spjpSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ListBox1->DataSource = new clsDBConnSIKP();
            $this->ListBox1->ds = & $this->ListBox1->DataSource;
            list($this->ListBox1->BoundColumn, $this->ListBox1->TextColumn, $this->ListBox1->DBFormat) = array("", "", "");
            $this->ListBox1->DataSource->SQL = "select p_payment_type_id, code\n" .
            "from p_payment_type";
...
//Operation Method @3-09F77C9A
    function Operation()
    {
        ...
        $Redirect = "t_laporan_pembayaran_berdasarkan_cara_bayar_dan_ketetapan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_pembayaran_berdasarkan_cara_bayar_dan_ketetapan.html";
$BlockToParse = "main";
...
//Include events file @1-AC97A04C
include_once("./t_laporan_pembayaran_berdasarkan_cara_bayar_dan_ketetapan_events.php");
