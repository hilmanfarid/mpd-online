<?php
//Include Common Files @1-56AAF511
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc.php");
...
//Class_Initialize Event @2-DF42EE87
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc.php";
...
//Class_Initialize Event @3-40333207
...
//Operation Method @3-F896AE16
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc.html";
$BlockToParse = "main";
...
//Include events file @1-3DAEBF06
include_once("./t_cust_order_legal_doc_events.php");
