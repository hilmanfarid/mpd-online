...
// -------------------------
	...
	if(!$cust_id == 0 && !$cust_id == ""){
		...
		echo '<script language="javascript">';
		echo 'location.href="t_vat_setllement_ro_otobuk_v2.php?CURR_DOC_ID='.$cust_id.'"';
		echo '</script>';
	}
	else{
...
//Page_OnInitializeView @1-9541DB76
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_vat_setllement_manual_v2; //Compatibility
