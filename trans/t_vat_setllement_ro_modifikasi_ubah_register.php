<?php
//Include Common Files @1-8856E0D7
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_modifikasi_ubah_register.php");
...
//Class_Initialize Event @2-4C064A6A
...
//DataSource Variables @2-308E6B68
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-BEEE2636
...
//Open Method @2-66F4DE59
    function Open()
    {
        ...
        "  upper(a.payment_key) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') OR\n" .
...
//Operation Method @3-BD769641
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_modifikasi_ubah_register.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_modifikasi_ubah_register.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_modifikasi_ubah_register.html";
$BlockToParse = "main";
...
//Include events file @1-8E93BF94
include_once("./t_vat_setllement_ro_modifikasi_ubah_register_events.php");
