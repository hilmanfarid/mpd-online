<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions" connection="ConnSIKP">
	<Components>
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_rep_bppsSearch" returnPage="t_laporan_register_kas_berdasarkan_ketetapan.ccp" PathID="t_rep_bppsSearch" pasteActions="pasteActions">
			<Components>
				...
				<ListBox id="565" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="p_settlement_type_id" wizardEmptyCaption="Select Value" PathID="t_rep_bppsSearchp_settlement_type_id" connection="ConnSIKP" _valueOfList="7" _nameOfList="STPD" dataSource="select p_settlement_type_id,code from p_settlement_type" fieldSource="i_flag_setoran" required="True">
					<Components/>
					<Events>
...
<ListBox id="567" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="p_payment_type_id" wizardEmptyCaption="Select Value" PathID="t_rep_bppsSearchp_payment_type_id" connection="ConnSIKP" _valueOfList="7" _nameOfList="STPD" dataSource="select p_payment_type_id,code from p_payment_type" fieldSource="i_flag_setoran" required="True">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_laporan_register_kas_berdasarkan_ketetapan_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_laporan_register_kas_berdasarkan_ketetapan.php" forShow="True" url="t_laporan_register_kas_berdasarkan_ketetapan.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
