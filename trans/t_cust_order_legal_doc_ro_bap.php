<?php
//Include Common Files @1-79C8DEC5
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_bap.php");
...
//Class_Initialize Event @2-6A074131
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_bap.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_bap.php";
...
//Operation Method @3-CECF06A9
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_bap.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_bap.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_bap.html";
$BlockToParse = "main";
...
//Include events file @1-ECF49F9E
include_once("./t_cust_order_legal_doc_ro_bap_events.php");
