<?php
//Include Common Files @1-7D951CE7
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_modifikasi.php");
...
//Class_Initialize Event @2-2596DF45
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_ro_modifikasi.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->vat_settlement_id->SetValue($this->DataSource->vat_settlement_id->GetValue());
                $this->customer_order_id->SetValue($this->DataSource->customer_order_id->GetValue());
...
//GetErrors Method @2-BE53DB03
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->vat_settlement_id->Errors->ToString());
        $errors = ComposeStrings($errors, $this->customer_order_id->Errors->ToString());
...
//DataSource Variables @2-8B967108
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $payment_key;
    var $created_by;
    var $vat_settlement_id;
    var $customer_order_id;
//End DataSource Variables

//DataSourceClass_Initialize Event @2-AA9D14B1
    function clst_vat_setllementGridDataSource(& $Parent)
    {
        ...
        $this->sett_code = new clsField("sett_code", ccsText, "");
        ...
        $this->vat_settlement_id = new clsField("vat_settlement_id", ccsText, "");
        
        $this->customer_order_id = new clsField("customer_order_id", ccsText, "");
...
//SetValues Method @2-E39728AE
    function SetValues()
    {
        ...
        $this->vat_settlement_id->SetDBValue($this->f("t_vat_setllement_id"));
        $this->customer_order_id->SetDBValue($this->f("t_customer_order_id"));
    }
...
//Operation Method @3-B2B66404
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_modifikasi.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_modifikasi.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_modifikasi.html";
$BlockToParse = "main";
...
//Include events file @1-6EBA9BD3
include_once("./t_vat_setllement_ro_modifikasi_events.php");
