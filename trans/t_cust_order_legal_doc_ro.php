<?php
//Include Common Files @1-8B7C87DE
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro.php");
...
//Class_Initialize Event @2-A9826C6F
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro.php";
...
//Operation Method @3-A6B2C11A
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro.html";
$BlockToParse = "main";
...
//Include events file @1-83486C16
include_once("./t_cust_order_legal_doc_ro_events.php");
