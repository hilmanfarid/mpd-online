<?php
//Include Common Files @1-74886AF1
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_oc_ver.php");
...
//Class_Initialize Event @94-801398C6
...
//CheckErrors Method @94-F48E7A5B
...
//DataSource Variables @94-7F60762F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @94-EC3B73CA
    function clst_bphtb_registrationFormDataSource(& $Parent)
    {
        ...
        $this->UpdateFields["add_disc_percent"] = array("Name" => "add_disc_percent", "Value" => "", "DataType" => ccsSingle, "OmitIfEmpty" => 1);
    }
...
//SetValues Method @94-4F9E7B40
    function SetValues()
    {
        ...
        $this->object_p_region_id->SetDBValue(trim($this->f("wp_p_region_idobject_p_region_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_oc_ver.html";
$BlockToParse = "main";
...
//Include events file @1-46E2F017
include_once("./t_bphtb_registration_oc_ver_events.php");
