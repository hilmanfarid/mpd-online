<?php
//Include Common Files @1-8BD22A48
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rekap_npwpd_jabatan.php");
...
//Operation Method @3-56B5DD9C
    function Operation()
    {
        ...
        $Redirect = "t_rekap_npwpd_jabatan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rekap_npwpd_jabatan.html";
$BlockToParse = "main";
...
//Include events file @1-3CE66725
include_once("./t_rekap_npwpd_jabatan_events.php");
