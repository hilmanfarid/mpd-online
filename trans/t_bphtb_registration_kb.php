<?php
//Include Common Files @1-50BC6283
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_kb.php");
...
//Class_Initialize Event @94-FC970E03
    function clsRecordt_bphtb_registrationForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->bphtb_amt_final_old = & new clsControl(ccsTextBox, "bphtb_amt_final_old", "bphtb_amt_final_old", ccsFloat, array(False, 0, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("bphtb_amt_final_old", $Method, NULL), $this);
            ...
            $this->market_price = & new clsControl(ccsTextBox, "market_price", "market_price", ccsFloat, array(False, 0, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("market_price", $Method, NULL), $this);
            ...
            $this->prev_payment_amount = & new clsControl(ccsTextBox, "prev_payment_amount", "prev_payment_amount", ccsFloat, array(False, 0, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("prev_payment_amount", $Method, NULL), $this);
            $this->registration_no_ref = & new clsControl(ccsTextBox, "registration_no_ref", "no_ref", ccsText, "", CCGetRequestParam("registration_no_ref", $Method, NULL), $this);
            $this->registration_no_ref->Required = true;
...
//Operation Method @94-29D11BD0
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = "t_bphtb_registration_list_kb.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "FLAG", "t_bphtb_registration_id"));
...
//DataSourceClass_Initialize Event @94-898346D7
    function clst_bphtb_registrationFormDataSource(& $Parent)
    {
        ...
        $this->registration_no_ref = new clsField("registration_no_ref", ccsText, "");
...
//Insert Method @94-788B2EF0
    function Insert()
    {
        ...
        if (!is_null($this->cp["registration_no_ref"]->GetValue()) and !strlen($this->cp["registration_no_ref"]->GetText()) and !is_bool($this->cp["registration_no_ref"]->GetValue())) 
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_kb.html";
$BlockToParse = "main";
...
//Include events file @1-E2E6EE59
include_once("./t_bphtb_registration_kb_events.php");
