<?php
//Include Common Files @1-777A0245
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_pengurangan_ro_outbox.php");
...
//Class_Initialize Event @2-62C46E8F
    function clsRecordt_bphtb_registrationForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Button9 = & new clsButton("Button9", $Method, $this);
...
//Operation Method @2-FFB69927
    function Operation()
    {
        ...
        if($this->FormSubmitted) {
            ...
            } else if($this->Button9->Pressed) {
                $this->PressedButton = "Button9";
            }
        }
        ...
        if($this->PressedButton == "Button_Delete") {
            ...
            } else if($this->PressedButton == "Button9") {
                if(!CCGetEvent($this->Button9->CCSEvents, "OnClick", $this->Button9)) {
                    $Redirect = "";
                }
            }
        } else {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_pengurangan_ro_outbox.html";
$BlockToParse = "main";
...
//Include events file @1-13D7FB4A
include_once("./t_bphtb_registration_pengurangan_ro_outbox_events.php");
