...
" boundColumn="p_bphtb_legal_doc_type_id" textColumn="code" features="(assigned)" fieldSource="p_bphtb_legal_doc_type_id">
				...
				<ListBox id="1084" visible="Yes" fieldSourceType="DBColumn" sourceType="ListOfValues" dataType="Text" returnValueType="Number" name="potongan_waris" wizardEmptyCaption="Select Value" PathID="t_bphtb_registrationFormpotongan_waris" connection="ConnSIKP" dataSource="1/1;Bukan Waris;1/2;1/2;1/3;1/3;2/3;2/3;1/4;1/4;1/7;1/7;3/4;3/4" fieldSource="potongan_waris" defaultValue="0" _valueOfList="3/4" _nameOfList="3/4">
					<Components/>
					<Events>
						<Event name="OnChange" type="Client">
							<Actions>
