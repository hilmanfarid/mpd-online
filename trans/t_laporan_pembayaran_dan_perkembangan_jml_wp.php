<?php
//Include Common Files @1-1E29CA05
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_pembayaran_dan_perkembangan_jml_wp.php");
...
//Class_Initialize Event @3-B3F7097A
...
//Operation Method @3-FD126DAB
    function Operation()
    {
        ...
        $Redirect = "t_laporan_pembayaran_dan_perkembangan_jml_wp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_pembayaran_dan_perkembangan_jml_wp.html";
$BlockToParse = "main";
...
//Include events file @1-4936F32B
include_once("./t_laporan_pembayaran_dan_perkembangan_jml_wp_events.php");
