...
where p_app_role_id_to IN(select p_app_role_id from p_app_user_role where p_app_user_id={p_app_user_id})
order by inbox.creation_date DESC" parameterTypeListName="ParameterTypeList">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_message_inbox.ccp" wizardThemeItem="GridA" PathID="t_message_inboxGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
...
<Hidden id="286" fieldSourceType="DBColumn" dataType="Float" name="t_message_inbox_id" PathID="t_message_inboxGridt_message_inbox_id" fieldSource="t_message_inbox_id">
<Components/>
<Events/>
<Attributes/>
<Features/>
...
FROM
	t_message_inbox inbox
LEFT JOIN sikp.p_message_type mtype ON mtype.p_message_type_id = inbox.p_message_type_id
where t_message_inbox_id = {t_message_inbox_id}" customUpdate="select o_result_code, o_result_msg from f_first_submit_engine(501,{t_customer_order_id},'{UserName}')" customUpdateType="SQL" customDeleteType="SQL" customDelete="select * from f_del_vat_setllement({t_vat_setllement_id},null,null)">
			<Components>
...
<TextBox id="243" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="message_type" fieldSource="message_type" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_message_inboxFormmessage_type">
				...
				<Hidden id="223" fieldSourceType="DBColumn" dataType="Float" html="False" name="t_message_inbox_id" fieldSource="t_message_inbox_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="t_message_inboxFormt_message_inbox_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Action actionName="Custom Code" actionCategory="General" id="287"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_message_inbox_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_message_inbox.php" forShow="True" url="t_message_inbox.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
