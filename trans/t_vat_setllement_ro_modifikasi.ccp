...
ORDER BY d.wp_name ASC, b.start_date DESC" parameterTypeListName="ParameterTypeList">
			<Components>
				...
				<Label id="321" fieldSourceType="DBColumn" dataType="Text" html="False" name="payment_key" fieldSource="payment_key" wizardCaption="Valid To" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_vat_setllementGridpayment_key" format="#,##">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="324" fieldSourceType="DBColumn" dataType="Text" html="False" name="vat_settlement_id" fieldSource="t_vat_setllement_id" wizardCaption="Valid To" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_vat_setllementGridvat_settlement_id" format="#,##">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
