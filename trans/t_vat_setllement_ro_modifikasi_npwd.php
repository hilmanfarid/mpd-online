<?php
//Include Common Files @1-86687E88
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_modifikasi_npwd.php");
...
//Class_Initialize Event @2-B8C819A7
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_ro_modifikasi_npwd.php";
...
//Operation Method @3-0E897668
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_modifikasi_npwd.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_modifikasi_npwd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_modifikasi_npwd.html";
$BlockToParse = "main";
...
//Include events file @1-1B3D1B79
include_once("./t_vat_setllement_ro_modifikasi_npwd_events.php");
