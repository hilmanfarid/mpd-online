...
// -------------------------
    // Write your own code here.
		...
		$redirectloader = "t_order_log_kronologis_ver_executive_summary_kadis.php?t_customer_order_id=".$cusOrderId
...
//Page_OnInitializeView @1-138F9DC6
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_order_log_kronologis_form_executive_summary_kadis; //Compatibility
