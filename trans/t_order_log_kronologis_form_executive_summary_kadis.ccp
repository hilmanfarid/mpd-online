...
VALUES(
 ...
 '{input_type}')" dataSource="t_order_log_kronologis">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_order_log_kronologis_form_executive_summary_kadis_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_order_log_kronologis_form_executive_summary_kadis.php" forShow="True" url="t_order_log_kronologis_form_executive_summary_kadis.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
