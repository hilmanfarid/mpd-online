...
from p_bphtb_legal_doc_type">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_laporan_penerimaan_bphtb_pengurangan_v2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_laporan_penerimaan_bphtb_pengurangan_v2.php" forShow="True" url="t_laporan_penerimaan_bphtb_pengurangan_v2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
