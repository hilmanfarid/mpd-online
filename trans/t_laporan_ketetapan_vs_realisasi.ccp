...
order by p_settlement_type_id" fieldSource="i_flag_setoran" required="True">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_laporan_ketetapan_vs_realisasi_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_laporan_ketetapan_vs_realisasi.php" forShow="True" url="t_laporan_ketetapan_vs_realisasi.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
