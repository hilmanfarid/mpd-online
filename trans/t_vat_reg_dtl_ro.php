<?php
//Include Common Files @1-427F1061
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl_ro.php");
...
//Class_Initialize Event @2-79A7E112
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl_ro.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl_ro.php";
...
//Operation Method @3-61A841E3
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl_ro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl_ro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-FE6F1E00
...
//Class_Initialize Event @790-7E5FD287
...
//Class_Initialize Event @814-170586A1
...
//Class_Initialize Event @838-EC106B88
...
//Class_Initialize Event @862-AA0F3272
...
//Class_Initialize Event @896-0F525843
...
//Class_Initialize Event @915-A4D358C7
...
//Class_Initialize Event @952-65A811A6
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl_ro.html";
$BlockToParse = "main";
...
//Include events file @1-7D5D469B
include_once("./t_vat_reg_dtl_ro_events.php");
