<?php
//Include Common Files @1-147D07BB
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_restitution.php");
...
//Class_Initialize Event @94-E56705CD
...
//CheckErrors Method @94-2CB3909A
...
//DataSource Variables @94-607F6674
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @94-C0D49C5B
...
//Class_Initialize Event @1016-EA0D4911
...
//CheckErrors Method @1016-2CB3909A
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->wp_kota->Errors->Count());
...
//Operation Method @1016-6EE62D61
    function Operation()
    {
        if(!$this->Visible)
            return;
...
//InsertRow Method @1016-3C052326
    function InsertRow()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeInsert", $this);
        if(!$this->InsertAllowed) return false;
...
//UpdateRow Method @1016-91F2EA44
    function UpdateRow()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeUpdate", $this);
        if(!$this->UpdateAllowed) return false;
...
//DataSource Variables @1016-607F6674
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @1016-3626745F
...
//SetValues Method @1016-B76280DA
    function SetValues()
    {
        $this->wp_kota->SetDBValue($this->f("wp_kota"));
        $this->wp_kelurahan->SetDBValue($this->f("wp_kelurahan"));
...
//Update Method @1016-5C766E5D
    function Update()
    {
        ...
        $this->CmdExecution = true;
        $this->cp["updated_by"] = new clsSQLParameter("sesUserLogin", ccsText, "", "", CCGetSession("UserLogin", NULL), NULL, false, $this->ErrorBlock);
        $this->cp["updated_date"] = new clsSQLParameter("expr1199", ccsText, "", "", date("Y-m-d H:i:s"), NULL, false, $this->ErrorBlock);
        $this->cp["wp_p_region_id"] = new clsSQLParameter("ctrlwp_p_region_id", ccsFloat, "", "", $this->wp_p_region_id->GetValue(true), NULL, false, $this->ErrorBlock);
        $this->cp["wp_p_region_id_kel"] = new clsSQLParameter("ctrlwp_p_region_id_kel", ccsFloat, "", "", $this->wp_p_region_id_kel->GetValue(true), NULL, false, $this->ErrorBlock);
        $this->cp["wp_name"] = new clsSQLParameter("ctrlwp_name", ccsText, "", "", $this->wp_name->GetValue(true), NULL, false, $this->ErrorBlock);
        $this->cp["wp_address_name"] = new clsSQLParameter("ctrlwp_address_name", ccsText, "", "", $this->wp_address_name->GetValue(true), NULL, false, $this->ErrorBlock);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_restitution.html";
$BlockToParse = "main";
...
//Include events file @1-7CD6CEEB
include_once("./t_bphtb_restitution_events.php");
