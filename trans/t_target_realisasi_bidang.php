<?php
//Include Common Files @1-A709B297
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_target_realisasi_bidang.php");
...
//Class_Initialize Event @2-C9AE9638
    function clsGridt_target_realisasi_jenisGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_target_realisasi_bidang.php";
        ...
        $this->p_vat_group_id2 = & new clsControl(ccsHidden, "p_vat_group_id2", "p_vat_group_id2", ccsFloat, "", CCGetRequestParam("p_vat_group_id2", ccsGet, NULL), $this);
    }
...
//Open Method @2-468EFC80
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM ((SELECT max(t_revenue_target_id) as t_revenue_target_id, max(p_year_period_id) as p_year_period_id, p_vat_group_id, group_code, max(year_code) as year_code, sum(target_amount) as target_amount, sum(realisasi_amt) as realisasi_amt\n" .
        ...
        "ORDER BY group_code)) cnt";
        $this->SQL = "(SELECT max(t_revenue_target_id) as t_revenue_target_id, max(p_year_period_id) as p_year_period_id, p_vat_group_id, group_code, max(year_code) as year_code, sum(target_amount) as target_amount, sum(realisasi_amt) as realisasi_amt\n" .
        "FROM v_revenue_target_vs_realisasi\n" .
        "WHERE p_year_period_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "group by p_vat_group_id,group_code\n" .
        "ORDER BY group_code)";
...
//SetValues Method @2-D0D103EE
    function SetValues()
    {
        ...
        $this->vat_code->SetDBValue($this->f("group_code"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_target_realisasi_bidang.html";
$BlockToParse = "main";
...
//Include events file @1-1FF46A77
include_once("./t_target_realisasi_bidang_events.php");
