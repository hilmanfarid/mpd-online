<?php
//Include Common Files @1-F7A32619
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_survey_kepuasan_pelanggan_pendaftaran.php");
...
//Class_Initialize Event @3-138F3F8A
...
//Operation Method @3-FD8DD5AA
    function Operation()
    {
        ...
        $Redirect = "t_survey_kepuasan_pelanggan_pendaftaran.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_survey_kepuasan_pelanggan_pendaftaran.html";
$BlockToParse = "main";
...
//Include events file @1-0C274361
include_once("./t_survey_kepuasan_pelanggan_pendaftaran_events.php");
