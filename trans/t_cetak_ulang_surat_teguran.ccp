...
<TextBox id="574" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="no_surat" PathID="t_rep_lap_spjpSearchno_surat">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Hidden id="36" fieldSourceType="DBColumn" dataType="Text" name="p_region_id_kelurahan" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_rep_lap_spjpSearchp_region_id_kelurahan" fieldSource="p_region_id_kelurahan">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_cetak_ulang_surat_teguran_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_cetak_ulang_surat_teguran.php" forShow="True" url="t_cetak_ulang_surat_teguran.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
