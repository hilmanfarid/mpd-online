...
// -------------------------
    // Write your own code here.
		...
		$custId = $t_order_log_kronologisForm->t_cust_account_id->GetValue();

		$redirectloader = "t_order_log_kronologis_otobuk.php?t_cust_account_id=".$custId
													 ."&TAKEN_CTL=".$takenCtl
													 ."&IS_TAKEN=".$isTaken
...
//Page_OnInitializeView @1-0034BED4
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_order_log_kronologis_form_otobuk; //Compatibility
