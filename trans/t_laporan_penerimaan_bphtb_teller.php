<?php
//Include Common Files @1-62635ED5
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_penerimaan_bphtb_teller.php");
...
//Operation Method @2-B0CB38D3
    function Operation()
    {
        ...
        $Redirect = "t_laporan_penerimaan_bphtb_teller.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_penerimaan_bphtb_teller.html";
$BlockToParse = "main";
...
//Include events file @1-B8A55F15
include_once("./t_laporan_penerimaan_bphtb_teller_events.php");
