...
<SQLParameter id="794" variable="input_type" parameterType="Control" dataType="Text" parameterSource="input_type"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_order_log_kronologis_form_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_order_log_kronologis_form.php" forShow="True" url="t_order_log_kronologis_form.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
