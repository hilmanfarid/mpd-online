<?php
//Include Common Files @1-7A3167C9
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_harian_bdhr.php");
...
//Class_Initialize Event @3-33C825B9
...
//Operation Method @3-E6F6980E
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_harian_bdhr.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_harian_bdhr.html";
$BlockToParse = "main";
...
//Include events file @1-141083CA
include_once("./t_rep_lap_harian_bdhr_events.php");
