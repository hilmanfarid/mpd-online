...
<?php
		      	$DBConn = new clsDBConnSIKP();
		      	$list = "select * from p_order_status where p_order_status_id in (2,3) ORDER BY p_order_status_id";
		      	$DBConn->query($list);
		      	$option = array();
  ...
  <div class="tab-background-styled">
    <div class="th tab-button">
      <div class="tab-title-selected">
        MONITORING TITIK PROSES PENDAFTARAN WP
      </div>
    </div>
  </div>
</div>
<div style="CLEAR: both; PADDING-TOP: 50px">
	...
	<td valign="top">
	 <table class="Record" cellspacing="0" cellpadding="0" border="0">
	    <tr class="Controls">
	      <td class="search-field">Status Pendaftaran</td>
