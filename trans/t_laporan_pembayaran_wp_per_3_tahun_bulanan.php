<?php
//Include Common Files @1-6F157307
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_pembayaran_wp_per_3_tahun_bulanan.php");
...
//Class_Initialize Event @3-D41B8CE6
...
//Operation Method @3-E46B94C8
    function Operation()
    {
        ...
        $Redirect = "t_laporan_pembayaran_wp_per_3_tahun_bulanan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_pembayaran_wp_per_3_tahun_bulanan.html";
$BlockToParse = "main";
...
//Include events file @1-87659729
include_once("./t_laporan_pembayaran_wp_per_3_tahun_bulanan_events.php");
