<?php
//Include Common Files @1-FF551614
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_list_update.php");
...
//Open Method @2-65249DF6
    function Open()
    {
        ...
        "AND NOT EXISTS (SELECT 1 FROM t_payment_receipt_bphtb as x WHERE x.t_bphtb_registration_id = regis.t_bphtb_registration_id)) cnt";
        ...
        "regis.wp_name ILIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') \n" .
        "AND (cust_order.p_order_status_id = 2 OR cust_order.p_order_status_id = 3)\n" .
        "AND NOT EXISTS (SELECT 1 FROM t_payment_receipt_bphtb as x WHERE x.t_bphtb_registration_id = regis.t_bphtb_registration_id) {SQL_OrderBy}";
...
//Operation Method @3-E14E1524
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_list_update.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_list_update.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_list_update.html";
$BlockToParse = "main";
...
//Include events file @1-4DF21450
include_once("./t_bphtb_registration_list_update_events.php");
