...
//Page_OnInitializeView @1-D5E6DB97
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_bphtb_registration_list_kb; //Compatibility
...
// -------------------------
	...
	if(CCGetFromGet("submit_bphtb")==1){
		...
		$dbConn->close();
		header('Location:t_bphtb_registration_list_kb.php');
		exit;
	}
// -------------------------
//End Custom Code
