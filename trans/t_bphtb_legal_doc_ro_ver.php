<?php
//Include Common Files @1-16E4410F
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_legal_doc_ro_ver.php");
...
//Class_Initialize Event @2-8C60CF1B
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_bphtb_legal_doc_ro_ver.php";
        ...
        $this->Insert_Link->Page = "t_bphtb_legal_doc_ro_ver.php";
...
//Operation Method @3-56D94330
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_legal_doc_ro_ver.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_legal_doc_ro_ver.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @94-1A428D17
    function clsRecordt_cust_order_legal_docForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->p_legal_doc_type_id = & new clsControl(ccsListBox, "p_legal_doc_type_id", "p_legal_doc_type_id", ccsText, "", CCGetRequestParam("p_legal_doc_type_id", $Method, NULL), $this);
            $this->p_legal_doc_type_id->DSType = dsSQL;
            $this->p_legal_doc_type_id->DataSource = new clsDBConnSIKP();
            $this->p_legal_doc_type_id->ds = & $this->p_legal_doc_type_id->DataSource;
            list($this->p_legal_doc_type_id->BoundColumn, $this->p_legal_doc_type_id->TextColumn, $this->p_legal_doc_type_id->DBFormat) = array("", "", "");
            $this->p_legal_doc_type_id->DataSource->Parameters["urlt_bphtb_registration_id"] = CCGetFromGet("t_bphtb_registration_id", NULL);
            $this->p_legal_doc_type_id->DataSource->Parameters["ctrlp_legal_doc_type_id"] = $this->p_legal_doc_type_id->GetValue(true);
            $this->p_legal_doc_type_id->DataSource->Parameters["urlt_cust_order_legal_doc_id"] = CCGetFromGet("t_cust_order_legal_doc_id", NULL);
            $this->p_legal_doc_type_id->DataSource->Parameters["urlt_customer_order_id"] = CCGetFromGet("t_customer_order_id", NULL);
            $this->p_legal_doc_type_id->DataSource->wp = new clsSQLParameters();
            $this->p_legal_doc_type_id->DataSource->wp->AddParameter("1", "urlt_bphtb_registration_id", ccsText, "", "", $this->p_legal_doc_type_id->DataSource->Parameters["urlt_bphtb_registration_id"], "", false);
            $this->p_legal_doc_type_id->DataSource->wp->AddParameter("2", "ctrlp_legal_doc_type_id", ccsFloat, "", "", $this->p_legal_doc_type_id->DataSource->Parameters["ctrlp_legal_doc_type_id"], 0, false);
            $this->p_legal_doc_type_id->DataSource->wp->AddParameter("3", "urlt_cust_order_legal_doc_id", ccsText, "", "", $this->p_legal_doc_type_id->DataSource->Parameters["urlt_cust_order_legal_doc_id"], 0, false);
            $this->p_legal_doc_type_id->DataSource->wp->AddParameter("4", "urlt_customer_order_id", ccsFloat, "", "", $this->p_legal_doc_type_id->DataSource->Parameters["urlt_customer_order_id"], 0, false);
            $this->p_legal_doc_type_id->DataSource->SQL = "SELECT\n" .
            "	bphtb_sspd_legal_doc.p_legal_doc_type_id_child AS p_bphtb_legal_doc_type_id,\n" .
            "	bphtb_sspd_legal_doc.code\n" .
            "FROM\n" .
            "	\"sikp\".\"t_bphtb_registration\"\n" .
            "LEFT JOIN p_bphtb_legal_doc_type ON p_bphtb_legal_doc_type.p_bphtb_legal_doc_type_id = t_bphtb_registration.p_bphtb_legal_doc_type_id\n" .
            "LEFT JOIN p_legal_doc_type ON p_legal_doc_type.p_legal_doc_type_id = p_bphtb_legal_doc_type.p_legal_doc_type_id\n" .
            "RIGHT JOIN bphtb_sspd_legal_doc ON p_legal_doc_type.p_legal_doc_type_id = bphtb_sspd_legal_doc.p_legal_doc_type_id\n" .
            "WHERE\n" .
            "	t_bphtb_registration.t_bphtb_registration_id = " . $this->p_legal_doc_type_id->DataSource->SQLValue($this->p_legal_doc_type_id->DataSource->wp->GetDBValue("1"), ccsText) . "\n" .
            "	and bphtb_sspd_legal_doc.p_legal_doc_type_id_child not in(select p_legal_doc_type_id from t_cust_order_legal_doc where t_customer_order_id=" . $this->p_legal_doc_type_id->DataSource->SQLValue($this->p_legal_doc_type_id->DataSource->wp->GetDBValue("4"), ccsFloat) . ")\n" .
            "UNION SELECT\n" .
            "	bphtb_sspd_legal_doc.p_legal_doc_type_id_child AS p_bphtb_legal_doc_type_id,\n" .
            "	bphtb_sspd_legal_doc.code\n" .
            "	from bphtb_sspd_legal_doc\n" .
            "	LEFT JOIN t_cust_order_legal_doc on bphtb_sspd_legal_doc.p_legal_doc_type_id_child = t_cust_order_legal_doc.p_legal_doc_type_id\n" .
            "where t_cust_order_legal_doc.t_cust_order_legal_doc_id=" . $this->p_legal_doc_type_id->DataSource->SQLValue($this->p_legal_doc_type_id->DataSource->wp->GetDBValue("3"), ccsText) . "";
...
//Show Method @94-3E33234E
    function Show()
    {
        ...
        $this->p_legal_doc_type_id->Prepare();
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_legal_doc_ro_ver.html";
$BlockToParse = "main";
...
//Include events file @1-5EDBC826
include_once("./t_bphtb_legal_doc_ro_ver_events.php");
