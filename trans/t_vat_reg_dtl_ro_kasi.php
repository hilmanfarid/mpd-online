<?php
//Include Common Files @1-F21CCDFB
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl_ro_kasi.php");
...
//Class_Initialize Event @2-76D06DC5
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl_ro_kasi.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl_ro_kasi.php";
...
//Operation Method @3-0D201142
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl_ro_kasi.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl_ro_kasi.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-39723312
...
//Class_Initialize Event @790-75CDEA2F
...
//Class_Initialize Event @814-F923F69D
...
//Class_Initialize Event @838-797D439F
...
//Class_Initialize Event @862-303041C4
...
//Class_Initialize Event @896-68CCEBFE
...
//Class_Initialize Event @915-C921A2E1
...
//Class_Initialize Event @952-1E65610A
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl_ro_kasi.html";
$BlockToParse = "main";
...
//Include events file @1-36F0E350
include_once("./t_vat_reg_dtl_ro_kasi_events.php");
