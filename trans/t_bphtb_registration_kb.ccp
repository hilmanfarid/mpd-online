...
where a.t_bphtb_registration_id = {t_bphtb_registration_id}" connection="ConnSIKP">
			<Components>
				...
				<Button id="96" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Submit" PathID="t_bphtb_registrationFormButton_Update" removeParameters="FLAG;t_bphtb_registration_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="97" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="t_bphtb_registrationFormButton_Delete" removeParameters="FLAG;t_bphtb_registration_id">
					<Components/>
					<Events>
				...
				<Button id="99" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" wizardCaption="Cancel" PathID="t_bphtb_registrationFormButton_Cancel" returnPage="t_bphtb_registration_list_kb.ccp" removeParameters="FLAG;t_bphtb_registration_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
" boundColumn="p_bphtb_legal_doc_type_id" textColumn="code" features="(assigned)" fieldSource="p_bphtb_legal_doc_type_id">
				...
				<TextBox id="955" visible="Yes" fieldSourceType="CodeExpression" dataType="Float" name="total_price" PathID="t_bphtb_registrationFormtotal_price" defaultValue="0" format="#,##0.00" fieldSource="$this-&gt;DataSource-&gt;land_total_price-&gt;GetValue()+$this-&gt;DataSource-&gt;building_total_price-&gt;GetValue()">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="1016" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="registration_no_ref" fieldSource="registration_no_ref" required="True" wizardCaption="ORGANIZATION CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_bphtb_registrationFormregistration_no_ref" caption="no_ref">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<Hidden id="1017" fieldSourceType="DBColumn" dataType="Float" name="t_bphtb_registration_id_old" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_bphtb_registrationFormt_bphtb_registration_id_old" fieldSource="t_bphtb_registration_id_old" caption="test">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Button id="1071" urlType="Relative" enableValidation="True" isDefault="False" name="Button4" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_bphtb_registrationFormButton4">
					<Components/>
					<Events>
						<Event name="OnClick" type="Server">
							<Actions>
								<Action actionName="Custom Code" actionCategory="General" id="1072" eventType="Server"/>
							</Actions>
						</Event>
					</Events>
					<Attributes/>
			...
			<ISQLParameters>
				<SQLParameter id="1018" variable="wp_kota" dataType="Text" parameterType="Control" parameterSource="wp_kota"/>
				<SQLParameter id="1019" variable="wp_kelurahan" dataType="Text" parameterType="Control" parameterSource="wp_kelurahan"/>
				<SQLParameter id="1020" variable="wp_p_region_id" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id"/>
				<SQLParameter id="1021" variable="wp_p_region_id_kecamatan" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id_kecamatan"/>
				<SQLParameter id="1022" variable="wp_p_region_id_kelurahan" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id_kelurahan"/>
				<SQLParameter id="1023" variable="wp_kecamatan" dataType="Text" parameterType="Control" parameterSource="wp_kecamatan"/>
				<SQLParameter id="1024" variable="object_kelurahan" dataType="Text" parameterType="Control" parameterSource="object_kelurahan"/>
				<SQLParameter id="1025" variable="object_p_region_id_kelurahan" dataType="Float" parameterType="Control" parameterSource="object_p_region_id_kelurahan"/>
				<SQLParameter id="1026" variable="object_kecamatan" dataType="Text" parameterType="Control" parameterSource="object_kecamatan"/>
				<SQLParameter id="1027" variable="object_p_region_id_kecamatan" dataType="Float" parameterType="Control" parameterSource="object_p_region_id_kecamatan"/>
				<SQLParameter id="1028" variable="object_kota" dataType="Text" parameterType="Control" parameterSource="object_kota"/>
				<SQLParameter id="1029" variable="object_p_region_id" dataType="Float" parameterType="Control" parameterSource="object_p_region_id"/>
			</ISQLParameters>
			<IFormElements>
			...
			<USQLParameters>
				<SQLParameter id="1032" variable="UserLogin" dataType="Text" parameterType="Session" parameterSource="UserLogin"/>
				<SQLParameter id="1033" variable="Expr0" dataType="Text" parameterType="Expression" parameterSource="date(&quot;Y-m-d H:i:s&quot;)" format="dd-mmm-yyyy"/>
				<SQLParameter id="1034" variable="wp_p_region_id" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id"/>
				<SQLParameter id="1035" variable="wp_p_region_id_kel" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id_kel"/>
				<SQLParameter id="1036" variable="wp_name" dataType="Text" parameterType="Control" parameterSource="wp_name"/>
				<SQLParameter id="1037" variable="wp_address_name" dataType="Text" parameterType="Control" parameterSource="wp_address_name"/>
				<SQLParameter id="1038" variable="npwp" dataType="Text" parameterType="Control" parameterSource="npwp"/>
				<SQLParameter id="1039" variable="object_p_region_id_kec" dataType="Text" parameterType="Control" parameterSource="object_p_region_id_kec"/>
				<SQLParameter id="1040" variable="object_p_region_id" dataType="Text" parameterType="Control" parameterSource="object_p_region_id"/>
				<SQLParameter id="1041" variable="land_area" dataType="Float" parameterType="Control" parameterSource="land_area"/>
				<SQLParameter id="1042" variable="land_price_per_m" dataType="Float" parameterType="Control" parameterSource="land_price_per_m"/>
				<SQLParameter id="1043" variable="land_total_price" dataType="Float" parameterType="Control" parameterSource="land_total_price"/>
				<SQLParameter id="1044" variable="building_area" dataType="Float" parameterType="Control" parameterSource="building_area"/>
				<SQLParameter id="1045" variable="building_price_per_m" dataType="Float" parameterType="Control" parameterSource="building_price_per_m"/>
				<SQLParameter id="1046" variable="building_total_price" dataType="Float" parameterType="Control" parameterSource="building_total_price"/>
				<SQLParameter id="1047" variable="wp_rt" dataType="Text" parameterType="Control" parameterSource="wp_rt"/>
				<SQLParameter id="1048" variable="wp_rw" dataType="Text" parameterType="Control" parameterSource="wp_rw"/>
				<SQLParameter id="1049" variable="object_rt" dataType="Text" parameterType="Control" parameterSource="object_rt"/>
				<SQLParameter id="1050" variable="object_rw" dataType="Text" parameterType="Control" parameterSource="object_rw"/>
				<SQLParameter id="1051" variable="njop_pbb" dataType="Text" parameterType="Control" parameterSource="njop_pbb"/>
				<SQLParameter id="1052" variable="object_address_name" dataType="Text" parameterType="Control" parameterSource="object_address_name"/>
				<SQLParameter id="1053" variable="p_bphtb_legal_doc_type_id" dataType="Text" parameterType="Control" parameterSource="p_bphtb_legal_doc_type_id"/>
				<SQLParameter id="1054" variable="npop" dataType="Float" parameterType="Control" parameterSource="npop"/>
				<SQLParameter id="1055" variable="npop_tkp" dataType="Float" parameterType="Control" parameterSource="npop_tkp"/>
				<SQLParameter id="1056" variable="npop_kp" dataType="Float" parameterType="Control" parameterSource="npop_kp"/>
				<SQLParameter id="1057" variable="bphtb_amt" dataType="Float" parameterType="Control" parameterSource="bphtb_amt"/>
				<SQLParameter id="1058" variable="bphtb_discount" dataType="Float" parameterType="Control" parameterSource="bphtb_discount"/>
				<SQLParameter id="1059" variable="description" dataType="Text" parameterType="Control" parameterSource="description"/>
				<SQLParameter id="1060" variable="market_price" dataType="Float" parameterType="Control" parameterSource="market_price"/>
				<SQLParameter id="1061" variable="mobile_phone_no" dataType="Text" parameterType="Control" parameterSource="mobile_phone_no"/>
				<SQLParameter id="1062" variable="wp_p_region_id_kec" dataType="Float" parameterType="Control" parameterSource="wp_p_region_id_kec"/>
				<SQLParameter id="1063" variable="object_p_region_id_kel" dataType="Float" parameterType="Control" parameterSource="object_p_region_id_kel"/>
				<SQLParameter id="1064" variable="jenis_harga_bphtb" dataType="Text" parameterType="Control" parameterSource="jenis_harga_bphtb"/>
				<SQLParameter id="1065" variable="bphtb_legal_doc_description" dataType="Text" parameterType="Control" parameterSource="bphtb_legal_doc_description"/>
				<SQLParameter id="1066" variable="add_disc_percent" dataType="Float" parameterType="Control" parameterSource="add_disc_percent"/>
				<SQLParameter id="1067" variable="bphtb_amt_final" dataType="Float" parameterType="Control" parameterSource="bphtb_amt_final"/>
				<SQLParameter id="1068" variable="t_bphtb_registration_id" parameterType="URL" dataType="Float" parameterSource="t_bphtb_registration_id" defaultValue="0"/>
			</USQLParameters>
			<UConditions>
			...
			<UFormElements>
				...
				<CustomParameter id="1031" field="bphtb_amt_final" dataType="Float" parameterType="Control" omitIfEmpty="True" parameterSource="bphtb_amt_final"/>
			</UFormElements>
			<DSPParameters>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_registration_kb_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_registration_kb.php" forShow="True" url="t_bphtb_registration_kb.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
