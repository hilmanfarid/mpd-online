<?php
//Include Common Files @1-29B2AD78
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_permohonan_bphtb_pengurangan.php");
...
//Class_Initialize Event @2-E6CBA6C3
    function clsRecordt_laporan_penerimaan_bphtb($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            list($this->p_bphtb_legal_doc_type_id->BoundColumn, $this->p_bphtb_legal_doc_type_id->TextColumn, $this->p_bphtb_legal_doc_type_id->DBFormat) = array("", "", "");
...
//Operation Method @2-BD4F1DC9
    function Operation()
    {
        ...
        $Redirect = "t_laporan_permohonan_bphtb_pengurangan.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_permohonan_bphtb_pengurangan.html";
$BlockToParse = "main";
...
//Include events file @1-F6238626
include_once("./t_laporan_permohonan_bphtb_pengurangan_events.php");
...
//Go to destination page @1-F3BF5E9D
if($Redirect)
{
