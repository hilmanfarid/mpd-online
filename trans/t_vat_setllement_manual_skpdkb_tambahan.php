<?php
//Include Common Files @1-8F232E29
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_manual_skpdkb_tambahan.php");
...
//Class_Initialize Event @23-1D9C4912
...
//Validate Method @23-F687AD27
    function Validate()
    {
        ...
        $Validation = ($this->mode_denda->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->mode_denda->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @23-7854A8BD
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->mode_denda->Errors->Count());
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_manual_skpdkb_tambahan.html";
$BlockToParse = "main";
...
//Include events file @1-1F3A3E72
include_once("./t_vat_setllement_manual_skpdkb_tambahan_events.php");
