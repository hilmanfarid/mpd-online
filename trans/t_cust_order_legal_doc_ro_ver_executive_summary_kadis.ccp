	...
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_cust_order_legal_docGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cust_order_legal_doc">
			<Components>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_cust_order_legal_doc_ro_ver_executive_summary_kadis.ccp" wizardThemeItem="GridA" PathID="t_cust_order_legal_docGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
...
WHERE t_cust_order_legal_doc_id = {t_cust_order_legal_doc_id} ">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_cust_order_legal_doc_ro_ver_executive_summary_kadis_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_cust_order_legal_doc_ro_ver_executive_summary_kadis.php" forShow="True" url="t_cust_order_legal_doc_ro_ver_executive_summary_kadis.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
