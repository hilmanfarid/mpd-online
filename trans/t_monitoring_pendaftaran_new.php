<?php
//Include Common Files @1-C883BAF1
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_monitoring_pendaftaran_new.php");
...
//Class_Initialize Event @3-47E170BE
...
//Operation Method @3-A20C05F9
    function Operation()
    {
        ...
        $Redirect = "t_monitoring_pendaftaran_new.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_monitoring_pendaftaran_new.html";
$BlockToParse = "main";
...
//Include events file @1-F0B0AFC4
include_once("./t_monitoring_pendaftaran_new_events.php");
