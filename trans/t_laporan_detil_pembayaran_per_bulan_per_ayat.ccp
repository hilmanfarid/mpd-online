...
from p_business_area ">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_laporan_detil_pembayaran_per_bulan_per_ayat_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_laporan_detil_pembayaran_per_bulan_per_ayat.php" forShow="True" url="t_laporan_detil_pembayaran_per_bulan_per_ayat.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
