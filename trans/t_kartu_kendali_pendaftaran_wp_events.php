...
//Page_OnInitializeView @1-BD965AF1
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_kartu_kendali_pendaftaran_wp; //Compatibility
...
function GetCetakHTML($param_arr) {
	...
	$output .='<table class="grid-table" border="0" cellspacing="0" cellpadding="0" width="900">
					...
					<tr>
                  		<td class="HeaderLeft"><img border="0" alt="" src="../Styles/sikp/Images/Spacer.gif"></td> 
                  		<td class="th" align="center"><h1><strong>PENDAFTARAN WAJIB PAJAK BARU</strong></td> 
                  		<td class="HeaderRight"><img border="0" alt="" src="../Styles/sikp/Images/Spacer.gif"></td>
                	</tr>
              		</table>';
	...
	$query="SELECT --t_cust_account_id,*
			...
			left join t_cust_account b on a.t_vat_registration_id=b.t_vat_registration_id
			left join p_finance_period c on c.p_finance_period_id=".$param_arr['p_finance_period_id']."
			where trunc(a.registration_date) BETWEEN c.start_date and c.end_date 
			and b.p_vat_type_id = ".$param_arr['p_vat_type_id']."
...
function GetCetakExcel($param_arr) {
	...
	startExcel("kartu_kendali_pendaftaran_wp.xls");
	...
	$output .= '<tr><td class="th" align="center" colspan=7><h1><strong>PENDAFTARAN WAJIB PAJAK BARU</strong></td></tr>';
	$output .= '</table></br>';
