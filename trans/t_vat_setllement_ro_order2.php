<?php
//Include Common Files @1-1694D1E4
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_order2.php");
...
//Class_Initialize Event @2-2E375FE3
...
//Operation Method @355-388432BE
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_order2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_order2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_order2.html";
$BlockToParse = "main";
...
//Include events file @1-B0910C47
include_once("./t_vat_setllement_ro_order2_events.php");
