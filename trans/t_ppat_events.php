...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->t_ppat_id->GetValue();
        $t_ppatForm->DataSource->Parameters["urlt_ppat_id"] = $selected_id;
...
// End Bdr  
  	...
  	// Start Bdr    
        ...
        if ($Component->DataSource->t_ppat_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-6FDB56B4
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_ppat; //Compatibility
