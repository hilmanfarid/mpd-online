<?php
//Include Common Files @1-CF8E3541
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_debt_legal_doc_ro.php");
...
//Class_Initialize Event @2-CB311029
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_debt_legal_doc_ro.php";
        ...
        $this->Insert_Link->Page = "t_debt_legal_doc_ro.php";
...
//Operation Method @3-0512A142
    function Operation()
    {
        ...
        $Redirect = "t_debt_legal_doc_ro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_debt_legal_doc_ro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_debt_legal_doc_ro.html";
$BlockToParse = "main";
...
//Include events file @1-6729BFD5
include_once("./t_debt_legal_doc_ro_events.php");
