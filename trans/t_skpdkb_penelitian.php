<?php
//Include Common Files @1-1CF819F1
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_skpdkb_penelitian.php");
...
//Operation Method @2-478AAE72
    function Operation()
    {
        ...
        $Redirect = "t_skpdkb_penelitian.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_skpdkb_penelitian.html";
$BlockToParse = "main";
...
//Include events file @1-AC0E7101
include_once("./t_skpdkb_penelitian_events.php");
