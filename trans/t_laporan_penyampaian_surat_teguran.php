<?php
//Include Common Files @1-ED9872C0
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_penyampaian_surat_teguran.php");
...
//Operation Method @3-D8990038
    function Operation()
    {
        ...
        $Redirect = "t_laporan_penyampaian_surat_teguran.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_penyampaian_surat_teguran.html";
$BlockToParse = "main";
...
//Include events file @1-758ACE8F
include_once("./t_laporan_penyampaian_surat_teguran_events.php");
