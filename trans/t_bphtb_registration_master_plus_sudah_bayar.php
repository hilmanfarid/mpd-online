<?php
//Include Common Files @1-87675111
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_master_plus_sudah_bayar.php");
    ...
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            ...
            if($this->PressedButton == "Button_Insert") {
                ...
                $Redirect = "t_bphtb_registration_list_update_master_sudah_bayar.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "FLAG"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_master_plus_sudah_bayar.html";
$BlockToParse = "main";
...
//Include events file @1-4A973792
include_once("./t_bphtb_registration_master_plus_sudah_bayar_events.php");
