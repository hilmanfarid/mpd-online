...
order by regis.t_bphtb_registration_id DESC">
			<Components>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" hrefSource="t_bphtb_registration_list_expired.ccp" removeParameters="FLAG" PathID="t_bphtb_registration_listDLink" wizardUseTemplateBlock="False">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="705" fieldSourceType="DBColumn" dataType="Text" html="False" name="tgl_verifikasi" fieldSource="tgl_verifikasi" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_bphtb_registration_listtgl_verifikasi">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_registration_list_expired_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_registration_list_expired.php" forShow="True" url="t_bphtb_registration_list_expired.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
