<?php
//Include Common Files @1-71F71D0D
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_cetak_skpd_tambahan.php");
...
//Class_Initialize Event @2-AA5317E3
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_cetak_skpd_tambahan.php";
...
//Open Method @2-67F7BDEA
    function Open()
    {
        ...
        ")\n" .
        "and a.p_settlement_type_id =6) cnt";
        ...
        "  upper(a.no_kohir) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")\n" .
        "and a.p_settlement_type_id =6 {SQL_OrderBy}";
...
//Operation Method @3-AD7D08AE
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_cetak_skpd_tambahan.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_cetak_skpd_tambahan.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_cetak_skpd_tambahan.html";
$BlockToParse = "main";
...
//Include events file @1-40B43984
include_once("./t_vat_setllement_cetak_skpd_tambahan_events.php");
