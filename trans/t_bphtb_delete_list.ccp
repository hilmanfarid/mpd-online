...
ORDER BY trim(a.wp_name) ASC" parameterTypeListName="ParameterTypeList">
		...
		<Record id="312" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="searchForm" returnPage="t_bphtb_delete_list.ccp" PathID="searchForm" connection="ConnSIKP">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_delete_list_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_delete_list.php" forShow="True" url="t_bphtb_delete_list.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
