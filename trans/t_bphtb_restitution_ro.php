<?php
//Include Common Files @1-AB751140
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_restitution_ro.php");
...
//Class_Initialize Event @94-77C602E5
...
//CheckErrors Method @94-347A2D0E
...
//DataSource Variables @94-30BA9507
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @94-3895AA16
...
//Prepare Method @94-AD5E0955
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlCURR_DOC_ID", ccsText, "", "", $this->Parameters["urlCURR_DOC_ID"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
    }
//End Prepare Method

//Open Method @94-1ECE3F8C
    function Open()
    {
        ...
        "where t_bphtb_restitusi.t_customer_order_id  = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "\n" .
...
class clsRecordt_bphtb_registrationForm1 { //t_bphtb_registrationForm1 Class @1016-4DB7155A

//Variables @1016-D6FF3E86
...
//Class_Initialize Event @1016-FF41B2A3
    function clsRecordt_bphtb_registrationForm1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record t_bphtb_registrationForm1/Error";
        $this->DataSource = new clst_bphtb_registrationForm1DataSource($this);
        $this->ds = & $this->DataSource;
        $this->UpdateAllowed = true;
        $this->DeleteAllowed = true;
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "t_bphtb_registrationForm1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
...
//Initialize Method @1016-830DBF3E
    function Initialize()
    {
...
//DeleteRow Method @1016-299D98C3
    function DeleteRow()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeDelete", $this);
        if(!$this->DeleteAllowed) return false;
...
} //End t_bphtb_registrationForm1 Class @1016-FCB6E20C
...
//Open Method @1016-426888F3
    function Open()
    {
        ...
        "where t_bphtb_restitusi.t_customer_order_id  = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "and t_bphtb_restitusi.t_customer_order_id = t_customer_order.t_customer_order_id\n" .
...
} //End t_bphtb_registrationForm1DataSource Class @1016-FCB6E20C

//Initialize Page @1-8E5981E3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_restitution_ro.html";
$BlockToParse = "main";
...
//Include events file @1-4A889E1D
include_once("./t_bphtb_restitution_ro_events.php");
...
$t_bphtb_registrationForm1 = & new clsRecordt_bphtb_registrationForm1("", $MainPage);
$MainPage->t_bphtb_registrationForm = & $t_bphtb_registrationForm;
$MainPage->t_bphtb_registrationForm1 = & $t_bphtb_registrationForm1;
$t_bphtb_registrationForm->Initialize();
$t_bphtb_registrationForm1->Initialize();
...
//Execute Components @1-FD34AF39
$t_bphtb_registrationForm->Operation();
$t_bphtb_registrationForm1->Operation();
//End Execute Components

//Go to destination page @1-B77630C4
if($Redirect)
{
    ...
    unset($t_bphtb_registrationForm1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-BB3A16E7
$t_bphtb_registrationForm->Show();
$t_bphtb_registrationForm1->Show();
$Tpl->block_path = "";
