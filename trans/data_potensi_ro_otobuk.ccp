	...
	<Components>
		<Grid id="688" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_restaurantGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cacc_dtl_restaurant">
			<Components>
				...
				<Link id="755" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_restaurantGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_restaurant_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1024" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_restaurantGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1031" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_restaurantGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE a.t_cust_account_id = {t_cust_account_id} ">
			<Components>
				...
				<Link id="794" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_hotelGrid1DLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_hotel_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="796" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_dtl_hotelGrid1ADLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_hotel_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1025" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_hotelGrid1valid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1032" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_hotelGrid1valid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="814" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="v_vat_reg_dtl_entertaintmentGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cacc_dtl_entertaintment">
			<Components>
				...
				<Link id="818" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="v_vat_reg_dtl_entertaintmentGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_entertaintment_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1026" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="v_vat_reg_dtl_entertaintmentGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1035" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="v_vat_reg_dtl_entertaintmentGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="838" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_parkingGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_acc_dtl_parking">
			<Components>
				...
				<Link id="842" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_parkingGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_acc_dtl_parking_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1027" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_parkingGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1036" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_parkingGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="862" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_ppjGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cacc_dtl_ppj">
			<Components>
				...
				<Link id="866" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_ppjGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_ppj_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="868" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_dtl_ppjGridADLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_ppj_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1028" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_ppjGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1037" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_ppjGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
AND is_pln = 'N' ">
			<Components>
				...
				<Link id="900" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_ppj_nplGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cacc_dtl_ppj_pln_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="1029" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_ppj_nplGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1033" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_ppj_nplGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="915" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_hotel_srvcGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="t_cacc_dtl_hotel_srvc">
			<Components>
				...
				<Label id="1030" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_hotel_srvcGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="1034" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_dtl_hotel_srvcGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="1005" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_employeeGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_cust_acc_employee">
			<Components>
				...
				<Link id="1010" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_employeeGridDLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cust_acc_employee_id">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="1011" sourceType="DataField" name="t_cust_acc_employee_id" source="t_cust_acc_employee_id"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Link id="1012" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_employeeGridADLink" hrefSource="data_potensi_ro_otobuk.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_cust_acc_employee_id">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="1013" sourceType="DataField" name="t_cust_acc_employee_id" source="t_cust_acc_employee_id"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="1014" fieldSourceType="DBColumn" dataType="Text" html="False" name="description" fieldSource="description" wizardCaption="Valid From" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_vat_reg_employeeGriddescription">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="1015" fieldSourceType="DBColumn" dataType="Float" html="False" name="t_cust_account_id" fieldSource="t_cust_account_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="t_vat_reg_employeeGridt_cust_account_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Label id="1016" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_from" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_employeeGridvalid_from" fieldSource="valid_from">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="1017" fieldSourceType="DBColumn" dataType="Text" html="False" name="valid_to" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_reg_employeeGridvalid_to" fieldSource="valid_to">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<Events>
				<Event name="BeforeShowRow" type="Server">
					<Actions>
						<Action actionName="Set Row Style" actionCategory="General" id="1018" styles="Row;AltRow" name="rowStyle" eventType="Server"/>
						<Action actionName="Custom Code" actionCategory="General" id="1019"/>
					</Actions>
				</Event>
			...
			<TableParameters>
				<TableParameter id="1021" conditionType="Parameter" useIsNull="False" field="t_cust_account_id" dataType="Float" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="t_cust_account_id"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="1022" tableName="v_cust_acc_employee" posLeft="10" posTop="10" posWidth="160" posHeight="180"/>
			</JoinTables>
			<JoinLinks/>
			<Fields>
				<Field id="1023" fieldName="*"/>
			</Fields>
			<SPParameters/>
			<SQLParameters>
			</SQLParameters>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="data_potensi_ro_otobuk_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="data_potensi_ro_otobuk.php" forShow="True" url="data_potensi_ro_otobuk.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
