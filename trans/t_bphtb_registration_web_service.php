<?php
//Include Common Files @1-0286FC21
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_web_service.php");
...
//Class_Initialize Event @2-A708A564
    function clsGridt_bphtb_registration_list($RelativePath, & $Parent)
    {
        ...
        $this->origin_file_name = & new clsControl(ccsLabel, "origin_file_name", "origin_file_name", ccsText, "", CCGetRequestParam("origin_file_name", ccsGet, NULL), $this);
        $this->DLink = & new clsControl(ccsLink, "DLink", "DLink", ccsText, "", CCGetRequestParam("DLink", ccsGet, NULL), $this);
        $this->DLink->HTML = true;
        $this->DLink->Page = "t_bphtb_registration_web_service.php";
...
//Open Method @2-08B63CCB
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select 1) cnt";
        $this->SQL = "select 1";
...
//Operation Method @3-B4F97477
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_web_service.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_web_service.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_web_service.html";
$BlockToParse = "main";
...
//Include events file @1-C7A5FA0F
include_once("./t_bphtb_registration_web_service_events.php");
