<?php
//Include Common Files @1-B56D154D
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_send_sms_to_app_user_whatsapp.php");
...
//Class_Initialize Event @2-9AEF4470
...
//Operation Method @2-6CB4B428
    function Operation()
    {
        ...
        $Redirect = "t_send_sms_to_app_user_whatsapp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_send_sms_to_app_user_whatsapp.html";
$BlockToParse = "main";
...
//Include events file @1-DB9163F3
include_once("./t_send_sms_to_app_user_whatsapp_events.php");
