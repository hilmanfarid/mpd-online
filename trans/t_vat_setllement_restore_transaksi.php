<?php
//Include Common Files @1-6F223163
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_restore_transaksi.php");
...
//Class_Initialize Event @3-07766F51
...
//Operation Method @3-D3D818EB
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_restore_transaksi.php";
        if($this->Validate()) {
...
//DataSource Variables @3-6EDB4FC5
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-91258098
...
//Insert Method @3-3067A1C9
    function Insert()
    {
        ...
        $this->SQL = "SELECT f_restore_trans(" . $this->SQLValue($this->cp["t_vat_setllement_id"]->GetDBValue(), ccsInteger) . ",'" . $this->SQLValue($this->cp["user_name"]->GetDBValue(), ccsText) . "','" . $this->SQLValue($this->cp["alasan"]->GetDBValue(), ccsText) . "', 0, '') AS msg";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_restore_transaksi.html";
$BlockToParse = "main";
...
//Include events file @1-F08333A9
include_once("./t_vat_setllement_restore_transaksi_events.php");
