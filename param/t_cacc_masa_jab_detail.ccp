...
AND a.t_cust_acc_masa_jab_id = {t_cust_acc_masa_jab_id}

ORDER BY a.t_cust_account_id">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_cacc_masa_jab_detail.ccp" wizardThemeItem="GridA" PathID="t_custAccountGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
			...
			<SQLParameters>
				...
				<SQLParameter id="476" variable="t_cust_acc_masa_jab_id" parameterType="URL" defaultValue="0" dataType="Integer" parameterSource="t_cust_acc_masa_jab_id"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
AND v.t_cust_acc_masa_jab_id = {t_cust_acc_masa_jab_id}
" activeTableType="customUpdate" customUpdateType="SQL" customUpdate="UPDATE t_cust_acc_masa_jab_detail
   SET t_customer_id={t_customer_id}, 
       company_owner='{company_owner}', p_job_position_id={p_job_position_id}, address_name_owner='{address_name_owner}', address_no_owner='{address_no_owner}', 
       address_rt_owner='{address_rt_owner}', address_rw_owner='{address_rw_owner}', p_region_id_kel_owner={p_region_id_kel_owner}, 
       p_region_id_kec_owner={p_region_id_kec_owner}, p_region_id_owner={p_region_id_owner}, phone_no_owner='{phone_no_owner}', 
       mobile_no_owner='{mobile_no_owner}', fax_no_owner='{fax_no_owner}', zip_code_owner='{zip_code_owner}', email_address='{email_address}', 
       
			 t_cust_account_id={t_cust_account_id}, npwd='{npwd}', p_vat_type_id={p_vat_type_id},
       activation_no='{activation_no}', 
       wp_name='{wp_name}', wp_address_name='{wp_address_name}', 
       wp_address_no='{wp_address_no}', wp_address_rt='{wp_address_rt}', wp_address_rw='{wp_address_rw}', wp_p_region_id_kelurahan={wp_p_region_id_kelurahan}, 
       wp_p_region_id_kecamatan={wp_p_region_id_kecamatan}, wp_p_region_id={wp_p_region_id}, wp_phone_no='{wp_phone_no}', 
       wp_mobile_no='{wp_mobile_no}', wp_fax_no='{wp_fax_no}', wp_zip_code='{wp_zip_code}', wp_email='{wp_email}', company_name='{company_name}', 
       address_name='{address_name}', address_no='{address_no}', address_rt='{address_rt}', address_rw='{address_rw}', p_region_id_kelurahan={p_region_id_kelurahan}, 
       p_region_id_kecamatan={p_region_id_kecamatan}, p_region_id={p_region_id}, phone_no='{phone_no}', mobile_no='{mobile_no}', 
       fax_no='{fax_no}', zip_code='{zip_code}', company_brand='{company_brand}', brand_address_name='{brand_address_name}', 
       brand_address_no='{brand_address_no}', brand_address_rt='{brand_address_rt}', brand_address_rw='{brand_address_rw}', brand_p_region_id_kel={brand_p_region_id_kel}, 
       brand_p_region_id_kec={brand_p_region_id_kec}, brand_p_region_id={brand_p_region_id}, brand_phone_no='{brand_phone_no}', 
       brand_mobile_no='{brand_mobile_no}', brand_fax_no='{brand_fax_no}', brand_zip_code='{brand_zip_code}', updated_date=sysdate, 
       updated_by='{modification_by}', p_vat_type_dtl_id={p_vat_type_dtl_id}
	 WHERE t_cust_acc_masa_jab_detail_id={t_cust_acc_masa_jab_detail_id};">
			<Components>
				...
				<Hidden id="669" fieldSourceType="DBColumn" dataType="Float" name="t_cust_acc_masa_jab_detail_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cust_account_updateFormt_cust_acc_masa_jab_detail_id" fieldSource="t_cust_acc_masa_jab_detail_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="289" variable="t_cust_acc_masa_jab_id" parameterType="URL" defaultValue="0" dataType="Integer" parameterSource="t_cust_acc_masa_jab_id"/>
			...
			<USQLParameters>
				...
				<SQLParameter id="670" variable="t_cust_acc_masa_jab_detail_id" parameterType="Control" defaultValue="0" dataType="Integer" parameterSource="t_cust_acc_masa_jab_detail_id"/>
</USQLParameters>
			<UConditions>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="p_cust_account_updateSearch" wizardCaption="Search P App Role " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="t_customer.ccp" PathID="p_cust_account_updateSearch" pasteActions="pasteActions">
			<Components>
				...
				<Hidden id="667" fieldSourceType="DBColumn" dataType="Text" name="t_cust_account_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="p_cust_account_updateSearcht_cust_account_id" fieldSource="t_cust_account_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="668" fieldSourceType="DBColumn" dataType="Float" name="t_cust_acc_masa_jab_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="p_cust_account_updateSearcht_cust_acc_masa_jab_id" fieldSource="t_cust_acc_masa_jab_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_cacc_masa_jab_detail_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_cacc_masa_jab_detail.php" forShow="True" url="t_cacc_masa_jab_detail.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
