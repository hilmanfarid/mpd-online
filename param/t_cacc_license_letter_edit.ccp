<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Record id="94" sourceType="SQL" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="ConnSIKP" name="t_license_letterForm" errorSummator="Error" wizardCaption="Add/Edit V P App User " wizardFormMethod="post" PathID="t_license_letterForm" activeCollection="USQLParameters" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" customDeleteType="SQL" parameterTypeListName="ParameterTypeList" customUpdateType="SQL" customInsertType="SQL" customInsert="INSERT INTO t_cacc_license_letter(t_cacc_license_letter_id, description, created_by, updated_by, creation_date, updated_date, license_no, p_license_type_id, t_cust_account_id, valid_from, valid_to) 
VALUES(generate_id('sikp','t_cacc_license_letter','t_cacc_license_letter_id'), '{description}', '{created_by}', '{updated_by}', sysdate, sysdate, '{license_no}', {p_license_type_id}, {t_cust_account_id}, to_date('{valid_from}','DD-MON-YYYY'), case when '{valid_to}' = '' then null else to_date('{valid_to}','DD-MON-YYYY') end)" customUpdate="UPDATE t_cacc_license_letter SET 
...
WHERE t_cacc_license_letter_id={t_cacc_license_letter_id}" customDelete="DELETE FROM t_cacc_license_letter
WHERE t_cacc_license_letter_id = {t_cacc_license_letter_id}" dataSource="SELECT * 
FROM v_cacc_license_letter
WHERE t_cacc_license_letter_id = {t_cacc_license_letter_id} ">
			<Components>
				...
				<Hidden id="101" fieldSourceType="DBColumn" dataType="Float" name="t_cacc_license_letter_id" fieldSource="t_cacc_license_letter_id" caption="Id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_license_letterFormt_cacc_license_letter_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="619" fieldSourceType="DBColumn" dataType="Float" name="t_cust_account_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_license_letterFormt_cust_account_id" fieldSource="t_cust_account_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
FROM p_license_type " activeCollection="TableParameters" boundColumn="p_license_type_id" textColumn="code" fieldSource="p_license_type_id" required="True">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="683" parameterType="URL" variable="t_cacc_license_letter_id" dataType="Float" parameterSource="t_cacc_license_letter_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="644" variable="t_cust_account_id" dataType="Float" parameterType="Control" parameterSource="t_cust_account_id" defaultValue="0"/>
			...
			<USQLParameters>
				<SQLParameter id="659" variable="t_cacc_license_letter_id" dataType="Float" parameterType="Control" parameterSource="t_cacc_license_letter_id" defaultValue="0"/>
				...
				<SQLParameter id="668" variable="t_cust_account_id" dataType="Float" parameterType="Control" parameterSource="t_cust_account_id" defaultValue="0"/>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="684" variable="t_cacc_license_letter_id" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="t_cacc_license_letter_id"/>
			</DSQLParameters>
			<DConditions>
			</DConditions>
			<SecurityGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_cacc_license_letter_edit_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_cacc_license_letter_edit.php" forShow="True" url="t_cacc_license_letter_edit.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
