<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="CoffeeBreak" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="p_vat_groupGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" dataSource="SELECT p_vat_group_id, group_code, description, creation_date, created_by, updated_date, updated_by
FROM p_vat_group
WHERE upper(group_code) LIKE '%{s_keyword}%'
...
ORDER BY p_vat_group_id" orderBy="p_vat_type_id">
			<Components>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="p_vat_group.ccp" wizardThemeItem="GridA" PathID="p_vat_groupGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="219" sourceType="DataField" name="p_vat_group_id" source="p_vat_group_id"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				...
				<Label id="15" fieldSourceType="DBColumn" dataType="Text" html="False" name="group_code" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="p_vat_groupGridgroup_code" fieldSource="group_code">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="13" fieldSourceType="DBColumn" dataType="Float" html="False" name="p_vat_group_id" fieldSource="p_vat_group_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="p_vat_groupGridp_vat_group_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE  p_vat_group_id = {p_vat_group_id}" dataSource="SELECT p_vat_group_id, group_code, description, to_char(creation_date,'DD-MON-YYYY')as creation_date, created_by, to_char(updated_date,'DD-MON-YYYY')as updated_date, updated_by
FROM p_vat_group
WHERE p_vat_group_id = {p_vat_group_id} ">
			<Components>
				...
				<Hidden id="30" fieldSourceType="DBColumn" dataType="Float" name="p_vat_group_id" fieldSource="p_vat_group_id" required="False" caption="Id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_vat_groupFormp_vat_group_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="243" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="group_code" fieldSource="group_code" required="True" caption="Kode" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_vat_groupFormgroup_code">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="182" parameterType="URL" variable="p_vat_group_id" dataType="Float" parameterSource="p_vat_group_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_vat_group_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_vat_group.php" forShow="True" url="p_vat_group.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
