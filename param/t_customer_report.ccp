	   ...
	   and b.p_account_status_id = 1">
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_customerSearch" wizardCaption="Search P App Role " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="t_customer_report.ccp" PathID="t_customerSearch" pasteActions="pasteActions">
			<Components>
				...
				<TextBox id="526" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="vat_code" fieldSource="vat_code" required="False" caption="Jenis Pajak" wizardCaption="Description" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_customerSearchvat_code">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE t_customer_id = {t_customer_id}">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_customer_report_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_customer_report.php" forShow="True" url="t_customer_report.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
