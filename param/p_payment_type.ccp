...
ORDER BY code" name="p_app_userGrid" orderBy="p_app_user_id" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters">
			<Components>
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Insert_Link" hrefSource="p_payment_type.ccp" removeParameters="p_payment_type_id" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="p_app_userGridInsert_Link">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="p_payment_type.ccp" wizardThemeItem="GridA" PathID="p_app_userGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="12" sourceType="DataField" format="yyyy-mm-dd" name="p_payment_type_id" source="p_payment_type_id"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="15" fieldSourceType="DBColumn" dataType="Text" html="False" name="code" fieldSource="code" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="p_app_userGridcode">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="13" fieldSourceType="DBColumn" dataType="Float" html="False" name="p_payment_type_id" fieldSource="p_payment_type_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="p_app_userGridp_payment_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="94" sourceType="SQL" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="ConnSIKP" name="p_app_userForm" dataSource="SELECT p_payment_type_id, description,code,
to_char(updated_date,'DD-MON-YYYY') AS updated_date,
to_char(creation_date,'DD-MON-YYYY') AS creation_date,
updated_by , created_by
FROM p_payment_type
WHERE p_payment_type_id = {p_payment_type_id} " errorSummator="Error" wizardCaption="Add/Edit V P App User " wizardFormMethod="post" PathID="p_app_userForm" activeCollection="DSQLParameters" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" customDelete="DELETE FROM p_payment_type WHERE  p_payment_type_id = {p_payment_type_id}" customDeleteType="SQL" activeTableType="customDelete" parameterTypeListName="ParameterTypeList" customUpdateType="SQL" customUpdate="UPDATE p_payment_type SET  
code='{code}',
description='{description}', 
updated_by='{updated_by}', 
updated_date=sysdate
WHERE p_payment_type_id={p_payment_type_id}" customInsertType="SQL" customInsert="INSERT INTO p_payment_type(code, 
description, 
created_by,
creation_date,
updated_by, 
...
sysdate)">
			<Components>
				...
				<Hidden id="101" fieldSourceType="DBColumn" dataType="Float" name="p_payment_type_id" fieldSource="p_payment_type_id" required="False" caption="p_payment_type_id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormp_payment_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="127" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="updated_by" fieldSource="updated_by" required="False" caption="Update By" wizardCaption="Updated By" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormupdated_by" defaultValue="CCGetUserLogin()">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="125" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="updated_date" fieldSource="updated_date" required="False" caption="Update Date" wizardCaption="Updated Date" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormupdated_date" defaultValue="date(&quot;d-M-Y&quot;)" format="dd-mmm-yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<TextBox id="122" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="creation_date" fieldSource="creation_date" required="False" caption="Creation Date" wizardCaption="Creation Date" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormcreation_date" format="dd-mmm-yyyy" defaultValue="date(&quot;d-M-Y&quot;)">
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="288" parameterType="URL" variable="p_payment_type_id" dataType="Float" parameterSource="p_payment_type_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="292" variable="updated_by" parameterType="Control" dataType="Text" parameterSource="updated_by"/>
				<SQLParameter id="297" variable="created_by" parameterType="Control" dataType="Text" parameterSource="created_by"/>
</ISQLParameters>
			<IFormElements>
			...
			<USQLParameters>
				...
				<SQLParameter id="296" variable="p_payment_type_id" parameterType="Control" dataType="Integer" parameterSource="p_payment_type_id" defaultValue="0"/>
			</USQLParameters>
			<UConditions/>
			<UFormElements>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="131" variable="p_payment_type_id" parameterType="Control" dataType="Float" parameterSource="p_payment_type_id" defaultValue="0"/>
			</DSQLParameters>
			<DConditions>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_payment_type_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_payment_type.php" forShow="True" url="p_payment_type.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
