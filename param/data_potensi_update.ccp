...
WHERE t_cust_account_id = {t_cust_account_id} ">
			<Components>
				...
				<Label id="1067" fieldSourceType="DBColumn" dataType="Text" html="False" name="makanan" fieldSource="makanan" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_vat_reg_dtl_restaurantGridmakanan">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
