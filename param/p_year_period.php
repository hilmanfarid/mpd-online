<?php
//Include Common Files @1-81B73876
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_year_period.php");
...
//Class_Initialize Event @2-95359F5C
    function clsGridp_year_periodGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "p_year_period.php";
        ...
        $this->ImageLink1->Page = "p_journal_period.php";
        $this->Insert_Link = & new clsControl(ccsLink, "Insert_Link", "Insert_Link", ccsText, "", CCGetRequestParam("Insert_Link", ccsGet, NULL), $this);
        $this->Insert_Link->Page = "p_year_period.php";
...
//Operation Method @3-1309C7DB
    function Operation()
    {
        ...
        $Redirect = "p_year_period.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_year_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_year_period.html";
$BlockToParse = "main";
...
//Include events file @1-9B3F7256
include_once("./p_year_period_events.php");
