<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_customerGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" dataSource="select a.*, c.vat_code, b.company_brand, b.brand_address_name, b.npwd
FROM t_cust_account b 
...
AND b.t_customer_id NOT IN (select t_customer_id from t_customer_user)
AND b.p_account_status_id = 1">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_customer_create_uname.ccp" wizardThemeItem="GridA" PathID="t_customerGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="526" fieldSourceType="DBColumn" dataType="Text" html="False" name="company_brand" fieldSource="company_brand" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_customerGridcompany_brand">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="527" fieldSourceType="DBColumn" dataType="Text" html="False" name="brand_address_name" fieldSource="brand_address_name" wizardCaption="Valid From" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_customerGridbrand_address_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Button id="528" urlType="Relative" enableValidation="True" isDefault="False" name="Button1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_customerGridButton1">
<Components/>
<Events/>
<Attributes/>
<Features/>
</Button>
<Label id="530" fieldSourceType="DBColumn" dataType="Text" html="False" name="npwd" fieldSource="npwd" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_customerGridnpwd">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
WHERE t_customer_id = {t_customer_id}">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_customer_create_uname_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_customer_create_uname.php" forShow="True" url="t_customer_create_uname.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
...
<Actions>
<Action actionName="Custom Code" actionCategory="General" id="529"/>
</Actions>
</Event>
</Events>
</Page>
