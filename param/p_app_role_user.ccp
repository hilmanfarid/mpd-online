<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\param" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" dataSource="SELECT a.*
FROM p_app_user a
LEFT JOIN p_app_user_role b on a.p_app_user_id = b.p_app_user_id
WHERE b.p_app_role_id = {p_app_role_id}
AND (
upper(a.app_user_name) LIKE '%{s_keyword}%'
OR upper(a.full_name) LIKE '%{s_keyword}%'
OR upper(a.email_address) LIKE '%{s_keyword}%'
OR upper(a.description) LIKE '%{s_keyword}%'
)
ORDER BY a.p_app_user_id" name="p_app_userGrid" orderBy="p_app_user_id" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Insert_Link" hrefSource="p_app_role_user.ccp" removeParameters="p_app_user_id;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="p_app_userGridInsert_Link">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="p_app_role_user.ccp" wizardThemeItem="GridA" PathID="p_app_userGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Label id="21" fieldSourceType="DBColumn" dataType="Text" html="False" name="email_address" fieldSource="email_address" wizardCaption="Valid To" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="p_app_userGridemail_address">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<ImageLink id="279" visible="Yes" fieldSourceType="DBColumn" dataType="Text" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ImageLink1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="p_app_userGridImageLink1" hrefSource="p_pass_byadmin.ccp">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="280" sourceType="URL" format="yyyy-mm-dd" name="s_keyword" source="s_keyword"/>
						<LinkParameter id="281" sourceType="DataField" format="yyyy-mm-dd" name="p_app_user_id" source="p_app_user_id"/>
						<LinkParameter id="282" sourceType="DataField" name="app_user_name" source="app_user_name"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</ImageLink>
...
<SQLParameter id="288" variable="p_app_role_id" parameterType="URL" defaultValue="0" dataType="Integer" parameterSource="p_app_role_id"/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="p_app_userSearch" wizardCaption="Search P App Role " wizardOrientation="Vertical" wizardFormMethod="post" returnPage="p_app_role_user.ccp" PathID="p_app_userSearch" pasteActions="pasteActions">
			<Components>
				...
				<Hidden id="113" fieldSourceType="DBColumn" dataType="Float" html="False" name="p_app_role_id" wizardCaption="P Module Role Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="p_app_userSearchp_app_role_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
<Hidden id="166" fieldSourceType="DBColumn" dataType="Text" name="role_s_keyword" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="p_app_userSearchrole_s_keyword">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
expired_user=case when '{expired_user}'= '' then null else to_date('{expired_user}','DD-MON-YYYY') end, 
expired_pwd=case when '{expired_pwd}'= '' then null else to_date('{expired_pwd}','DD-MON-YYYY') end,   
updated_by='{updated_by}', 
updated_date=sysdate, 
ip_address_v6='{ip_address_v6}',
is_employee='{is_employee}'
WHERE p_app_user_id={p_app_user_id}" customInsertType="SQL" customInsert="INSERT INTO p_app_user(p_app_user_id, 
app_user_name, 
user_pwd,
full_name, 
email_address, 
...
'{is_employee}')">
			<Components>
				...
				<TextBox id="102" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="app_user_name" fieldSource="app_user_name" required="True" caption="Nama User" wizardCaption="User Name" wizardSize="16" wizardMaxLength="16" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormapp_user_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="104" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="full_name" fieldSource="full_name" required="True" caption="Nama Lengkap" wizardCaption="Full Name" wizardSize="50" wizardMaxLength="96" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_app_userFormfull_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<DatePicker id="117" name="DatePicker_expired_user" control="expired_user" wizardSatellite="True" wizardControl="expired_user" wizardDatePickerType="Image" wizardPicture="../Styles/RWNet/Images/DatePicker.gif" style="../Styles/RWNet/Style.css" PathID="p_app_userFormDatePicker_expired_user">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<DatePicker id="119" name="DatePicker_expired_pwd" control="expired_pwd" wizardSatellite="True" wizardControl="expired_pwd" wizardDatePickerType="Image" wizardPicture="../Styles/RWNet/Images/DatePicker.gif" style="../Styles/RWNet/Style.css" PathID="p_app_userFormDatePicker_expired_pwd">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_app_role_user_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_app_role_user.php" forShow="True" url="p_app_role_user.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
