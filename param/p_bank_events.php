...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->p_bank_id->GetValue();
        $p_app_userForm->DataSource->Parameters["urlp_bank_id"] = $selected_id;
...
// Start Bdr    
    ...
    if ($Component->DataSource->p_bank_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-FA7EAD8F
...
// -------------------------
    ...
    global $selected_id;
    $selected_id = -1;
    $selected_id=CCGetFromGet("p_bank_id", $selected_id);
// -------------------------
//End Custom Code
