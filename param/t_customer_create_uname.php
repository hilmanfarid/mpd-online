<?php
//Include Common Files @1-25238C2A
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "t_customer_create_uname.php");
...
//Class_Initialize Event @2-8A4626D4
...
//DataSource Variables @2-560CA0CF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-38CA5DC5
...
//Open Method @2-FE81190A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select a.*, c.vat_code, b.company_brand, b.brand_address_name, b.npwd\n" .
        ...
        $this->SQL = "select a.*, c.vat_code, b.company_brand, b.brand_address_name, b.npwd\n" .
        "FROM t_cust_account b \n" .
        "LEFT JOIN t_customer a ON b.t_customer_id = a.t_customer_id\n" .
        "LEFT JOIN p_vat_type c ON b.p_vat_type_id = c.p_vat_type_id\n" .
        "\n" .
...
//Operation Method @3-17CE2D07
    function Operation()
    {
        ...
        $Redirect = "t_customer_create_uname.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_customer_create_uname.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_customer_create_uname.html";
$BlockToParse = "main";
...
//Include events file @1-6FE6D16B
include_once("./t_customer_create_uname_events.php");
