<?php
//Include Common Files @1-275151DF
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_payment_type.php");
...
//Class_Initialize Event @2-95BD658B
    function clsGridp_app_userGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "p_payment_type.php";
        $this->code = & new clsControl(ccsLabel, "code", "code", ccsText, "", CCGetRequestParam("code", ccsGet, NULL), $this);
        $this->description = & new clsControl(ccsLabel, "description", "description", ccsText, "", CCGetRequestParam("description", ccsGet, NULL), $this);
        $this->p_payment_type_id = & new clsControl(ccsHidden, "p_payment_type_id", "p_payment_type_id", ccsFloat, "", CCGetRequestParam("p_payment_type_id", ccsGet, NULL), $this);
        $this->Insert_Link = & new clsControl(ccsLink, "Insert_Link", "Insert_Link", ccsText, "", CCGetRequestParam("Insert_Link", ccsGet, NULL), $this);
        $this->Insert_Link->Page = "p_payment_type.php";
...
//Show Method @2-ED1B670F
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["p_payment_type_id"] = $this->p_payment_type_id->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->DLink->Parameters = CCAddParam($this->DLink->Parameters, "p_payment_type_id", $this->DataSource->f("p_payment_type_id"));
        ...
        $this->Insert_Link->Parameters = CCGetQueryString("QueryString", array("p_payment_type_id", "ccsForm"));
...
//GetErrors Method @2-923C94D7
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->p_payment_type_id->Errors->ToString());
...
//DataSource Variables @2-391545A6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-10B7DC1D
    function clsp_app_userGridDataSource(& $Parent)
    {
        ...
        $this->p_payment_type_id = new clsField("p_payment_type_id", ccsFloat, "");
        

    }
//End DataSourceClass_Initialize Event

//SetOrder Method @2-A137401A
...
//SetValues Method @2-D37BD607
    function SetValues()
    {
        $this->code->SetDBValue($this->f("code"));
        $this->description->SetDBValue($this->f("description"));
        $this->p_payment_type_id->SetDBValue(trim($this->f("p_payment_type_id")));
    }
...
//Operation Method @3-0F9C1DFA
    function Operation()
    {
        ...
        $Redirect = "p_payment_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_payment_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @94-559A6314
    function clsRecordp_app_userForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->p_payment_type_id = & new clsControl(ccsHidden, "p_payment_type_id", "p_payment_type_id", ccsFloat, "", CCGetRequestParam("p_payment_type_id", $Method, NULL), $this);
            $this->description = & new clsControl(ccsTextBox, "description", "Description", ccsText, "", CCGetRequestParam("description", $Method, NULL), $this);
            $this->code = & new clsControl(ccsTextBox, "code", "Kode", ccsText, "", CCGetRequestParam("code", $Method, NULL), $this);
            $this->updated_by = & new clsControl(ccsTextBox, "updated_by", "Update By", ccsText, "", CCGetRequestParam("updated_by", $Method, NULL), $this);
            $this->updated_date = & new clsControl(ccsTextBox, "updated_date", "Update Date", ccsText, "", CCGetRequestParam("updated_date", $Method, NULL), $this);
...
//Initialize Method @94-00D1E194
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlp_payment_type_id"] = CCGetFromGet("p_payment_type_id", NULL);
    }
//End Initialize Method

//Validate Method @94-3C8BFB31
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//CheckErrors Method @94-4026FE3C
    function CheckErrors()
    {
        $errors = false;
...
//UpdateRow Method @94-ACB46985
    function UpdateRow()
    {
        ...
        $this->DataSource->code->SetValue($this->code->GetValue(true));
        $this->DataSource->description->SetValue($this->description->GetValue(true));
        $this->DataSource->p_payment_type_id->SetValue($this->p_payment_type_id->GetValue(true));
...
//DataSource Variables @94-4443C81E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @94-175CC042
...
//Prepare Method @94-4C0C5D4D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlp_payment_type_id", ccsFloat, "", "", $this->Parameters["urlp_payment_type_id"], 0, false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
    }
//End Prepare Method

//Open Method @94-B56A0167
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT p_payment_type_id, description,code,\n" .
        "to_char(updated_date,'DD-MON-YYYY') AS updated_date,\n" .
        "to_char(creation_date,'DD-MON-YYYY') AS creation_date,\n" .
        "updated_by , created_by\n" .
        "FROM p_payment_type\n" .
        "WHERE p_payment_type_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . " ";
        $this->Order = "";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
...
//Insert Method @94-5441E957
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO p_payment_type(code, \n" .
        "description, \n" .
        "created_by,\n" .
        "creation_date,\n" .
        "updated_by, \n" .
...
//Update Method @94-13722E25
    function Update()
    {
        ...
        $this->cp["code"] = new clsSQLParameter("ctrlcode", ccsText, "", "", $this->code->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["description"] = new clsSQLParameter("ctrldescription", ccsText, "", "", $this->description->GetValue(true), "", false, $this->ErrorBlock);
        $this->cp["p_payment_type_id"] = new clsSQLParameter("ctrlp_payment_type_id", ccsInteger, "", "", $this->p_payment_type_id->GetValue(true), 0, false, $this->ErrorBlock);
        ...
        if (!is_null($this->cp["description"]->GetValue()) and !strlen($this->cp["description"]->GetText()) and !is_bool($this->cp["description"]->GetValue())) 
            $this->cp["description"]->SetValue($this->description->GetValue(true));
        if (!is_null($this->cp["p_payment_type_id"]->GetValue()) and !strlen($this->cp["p_payment_type_id"]->GetText()) and !is_bool($this->cp["p_payment_type_id"]->GetValue())) 
            $this->cp["p_payment_type_id"]->SetValue($this->p_payment_type_id->GetValue(true));
        if (!strlen($this->cp["p_payment_type_id"]->GetText()) and !is_bool($this->cp["p_payment_type_id"]->GetValue(true))) 
            $this->cp["p_payment_type_id"]->SetText(0);
        $this->SQL = "UPDATE p_payment_type SET  \n" .
        "code='" . $this->SQLValue($this->cp["code"]->GetDBValue(), ccsText) . "',\n" .
        "description='" . $this->SQLValue($this->cp["description"]->GetDBValue(), ccsText) . "', \n" .
        "updated_by='" . $this->SQLValue($this->cp["updated_by"]->GetDBValue(), ccsText) . "', \n" .
        "updated_date=sysdate\n" .
        "WHERE p_payment_type_id=" . $this->SQLValue($this->cp["p_payment_type_id"]->GetDBValue(), ccsInteger) . "";
...
//Delete Method @94-B2B192AF
    function Delete()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->CmdExecution = true;
        $this->cp["p_payment_type_id"] = new clsSQLParameter("ctrlp_payment_type_id", ccsFloat, "", "", $this->p_payment_type_id->GetValue(true), 0, false, $this->ErrorBlock);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildDelete", $this->Parent);
        if (!is_null($this->cp["p_payment_type_id"]->GetValue()) and !strlen($this->cp["p_payment_type_id"]->GetText()) and !is_bool($this->cp["p_payment_type_id"]->GetValue())) 
            $this->cp["p_payment_type_id"]->SetValue($this->p_payment_type_id->GetValue(true));
        if (!strlen($this->cp["p_payment_type_id"]->GetText()) and !is_bool($this->cp["p_payment_type_id"]->GetValue(true))) 
            $this->cp["p_payment_type_id"]->SetText(0);
        $this->SQL = "DELETE FROM p_payment_type WHERE  p_payment_type_id = " . $this->SQLValue($this->cp["p_payment_type_id"]->GetDBValue(), ccsFloat) . "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_payment_type.html";
$BlockToParse = "main";
...
//Include events file @1-5795BE0B
include_once("./p_payment_type_events.php");
