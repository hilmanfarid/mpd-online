<?php
//Include Common Files @1-5C2C8673
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_app_role_user.php");
...
//Class_Initialize Event @2-0052C570
    function clsGridp_app_userGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "p_app_role_user.php";
        ...
        $this->ImageLink1->Page = "p_pass_byadmin.php";
        $this->Insert_Link = & new clsControl(ccsLink, "Insert_Link", "Insert_Link", ccsText, "", CCGetRequestParam("Insert_Link", ccsGet, NULL), $this);
        $this->Insert_Link->Page = "p_app_role_user.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->ImageLink1->Parameters = CCAddParam($this->ImageLink1->Parameters, "p_app_user_id", $this->DataSource->f("p_app_user_id"));
                $this->ImageLink1->Parameters = CCAddParam($this->ImageLink1->Parameters, "app_user_name", $this->DataSource->f("app_user_name"));
...
//DataSource Variables @2-8953EA44
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-7EB05CC5
...
//Prepare Method @2-8B6950B9
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urlp_app_role_id", ccsInteger, "", "", $this->Parameters["urlp_app_role_id"], 0, false);
    }
//End Prepare Method

//Open Method @2-0FA648AE
    function Open()
    {
        ...
        "WHERE b.p_app_role_id = " . $this->SQLValue($this->wp->GetDBValue("2"), ccsInteger) . "\n" .
        "AND (\n" .
        "upper(a.app_user_name) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
        "OR upper(a.full_name) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
        "OR upper(a.email_address) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
...
//Class_Initialize Event @3-1B716559
    function clsRecordp_app_userSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->p_app_role_id = & new clsControl(ccsHidden, "p_app_role_id", "p_app_role_id", ccsFloat, "", CCGetRequestParam("p_app_role_id", $Method, NULL), $this);
            $this->role_s_keyword = & new clsControl(ccsHidden, "role_s_keyword", "role_s_keyword", ccsText, "", CCGetRequestParam("role_s_keyword", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-2B828F23
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        ...
        $Validation = ($this->role_s_keyword->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->s_keyword->Errors->Count() == 0);
        $Validation =  $Validation && ($this->p_app_role_id->Errors->Count() == 0);
        $Validation =  $Validation && ($this->role_s_keyword->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-7F76F5CD
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->s_keyword->Errors->Count());
        $errors = ($errors || $this->p_app_role_id->Errors->Count());
        $errors = ($errors || $this->role_s_keyword->Errors->Count());
...
//Operation Method @3-AD907236
    function Operation()
    {
        ...
        $Redirect = "p_app_role_user.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_app_role_user.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @3-FB766FE5
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->role_s_keyword->Errors->ToString());
...
//Class_Initialize Event @94-664D5DF3
...
"FROM p_user_status {SQL_Where} {SQL_OrderBy}";
            ...
            $this->p_user_status_id->Required = true;
            ...
            $this->DatePicker_expired_user = & new clsDatePicker("DatePicker_expired_user", "p_app_userForm", "expired_user", $this);
            ...
            $this->DatePicker_expired_pwd = & new clsDatePicker("DatePicker_expired_pwd", "p_app_userForm", "expired_pwd", $this);
            ...
            $this->is_employee->Required = true;
            if(!$this->FormSubmitted) {
...
//CheckErrors Method @94-99074DB3
    function CheckErrors()
    {
        $errors = false;
        ...
        $errors = ($errors || $this->DatePicker_expired_user->Errors->Count());
        $errors = ($errors || $this->expired_pwd->Errors->Count());
        $errors = ($errors || $this->DatePicker_expired_pwd->Errors->Count());
...
//Show Method @94-22CE9780
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->DatePicker_expired_user->Errors->ToString());
            $Error = ComposeStrings($Error, $this->expired_pwd->Errors->ToString());
            $Error = ComposeStrings($Error, $this->DatePicker_expired_pwd->Errors->ToString());
        ...
        $this->DatePicker_expired_user->Show();
        $this->expired_pwd->Show();
        $this->DatePicker_expired_pwd->Show();
...
//DataSource Variables @94-F35820D3
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//Update Method @94-A3F508ED
    function Update()
    {
        ...
        "app_user_name='" . $this->SQLValue($this->cp["app_user_name"]->GetDBValue(), ccsText) . "', \n" .
        ...
        "p_user_status_id='" . $this->SQLValue($this->cp["p_user_status_id"]->GetDBValue(), ccsText) . "', \n" .
        "description='" . $this->SQLValue($this->cp["description"]->GetDBValue(), ccsText) . "', \n" .
        "ip_address_v4='" . $this->SQLValue($this->cp["ip_address_v4"]->GetDBValue(), ccsText) . "', \n" .
        "expired_user=case when '" . $this->SQLValue($this->cp["expired_user"]->GetDBValue(), ccsText) . "'= '' then null else to_date('" . $this->SQLValue($this->cp["expired_user"]->GetDBValue(), ccsText) . "','DD-MON-YYYY') end, \n" .
        "expired_pwd=case when '" . $this->SQLValue($this->cp["expired_pwd"]->GetDBValue(), ccsText) . "'= '' then null else to_date('" . $this->SQLValue($this->cp["expired_pwd"]->GetDBValue(), ccsText) . "','DD-MON-YYYY') end,   \n" .
        "updated_by='" . $this->SQLValue($this->cp["updated_by"]->GetDBValue(), ccsText) . "', \n" .
        "updated_date=sysdate, \n" .
        "ip_address_v6='" . $this->SQLValue($this->cp["ip_address_v6"]->GetDBValue(), ccsText) . "',\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_app_role_user.html";
$BlockToParse = "main";
...
//Include events file @1-272310D1
include_once("./p_app_role_user_events.php");
