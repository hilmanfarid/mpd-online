<?php
//Include Common Files @1-BFDD2973
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "t_cacc_masa_jab_detail.php");
...
//Class_Initialize Event @2-41192B3C
    function clsGridt_custAccountGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cacc_masa_jab_detail.php";
...
//Prepare Method @2-3C6BF2B1
    function Prepare()
    {
        ...
        $this->wp->AddParameter("2", "urlt_cust_acc_masa_jab_id", ccsInteger, "", "", $this->Parameters["urlt_cust_acc_masa_jab_id"], 0, false);
    }
//End Prepare Method

//Open Method @2-AA58FD95
    function Open()
    {
...
//Class_Initialize Event @94-2F0D5345
    function clsRecordt_cust_account_updateForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->t_cust_acc_masa_jab_detail_id = & new clsControl(ccsHidden, "t_cust_acc_masa_jab_detail_id", "t_cust_acc_masa_jab_detail_id", ccsFloat, "", CCGetRequestParam("t_cust_acc_masa_jab_detail_id", $Method, NULL), $this);
...
//Validate Method @94-F9C80249
    function Validate()
    {
        ...
        $Validation = ($this->t_cust_acc_masa_jab_detail_id->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->t_cust_acc_masa_jab_detail_id->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @94-C2EB9AE3
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->t_cust_acc_masa_jab_detail_id->Errors->Count());
...
//UpdateRow Method @94-8400B683
    function UpdateRow()
    {
        ...
        $this->DataSource->t_cust_acc_masa_jab_detail_id->SetValue($this->t_cust_acc_masa_jab_detail_id->GetValue(true));
...
//Show Method @94-87BAB050
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->t_cust_acc_masa_jab_detail_id->SetValue($this->DataSource->t_cust_acc_masa_jab_detail_id->GetValue());
                }
            } else {
                $this->EditMode = false;
            }
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->t_cust_acc_masa_jab_detail_id->Errors->ToString());
        ...
        $this->t_cust_acc_masa_jab_detail_id->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
        $this->DataSource->close();
    }
...
//DataSource Variables @94-86CAC2C7
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $t_cust_acc_masa_jab_detail_id;
//End DataSource Variables

//DataSourceClass_Initialize Event @94-7033830F
    function clst_cust_account_updateFormDataSource(& $Parent)
    {
        ...
        $this->t_cust_acc_masa_jab_detail_id = new clsField("t_cust_acc_masa_jab_detail_id", ccsFloat, "");
        

    }
//End DataSourceClass_Initialize Event

//Prepare Method @94-84175896
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlt_cust_acc_masa_jab_id", ccsInteger, "", "", $this->Parameters["urlt_cust_acc_masa_jab_id"], 0, false);
        $this->wp->AddParameter("2", "urlt_cust_account_id", ccsInteger, "", "", $this->Parameters["urlt_cust_account_id"], 0, false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
    }
//End Prepare Method

//Open Method @94-629E259A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
...
//SetValues Method @94-DA5C9960
    function SetValues()
    {
        ...
        $this->t_cust_acc_masa_jab_detail_id->SetDBValue(trim($this->f("t_cust_acc_masa_jab_detail_id")));
    }
//End SetValues Method

//Update Method @94-39F63EE7
    function Update()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Class_Initialize Event @3-BE0488B5
    function clsRecordp_cust_account_updateSearch($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->t_cust_account_id = & new clsControl(ccsHidden, "t_cust_account_id", "t_cust_account_id", ccsText, "", CCGetRequestParam("t_cust_account_id", $Method, NULL), $this);
            $this->t_cust_acc_masa_jab_id = & new clsControl(ccsHidden, "t_cust_acc_masa_jab_id", "t_cust_acc_masa_jab_id", ccsFloat, "", CCGetRequestParam("t_cust_acc_masa_jab_id", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-BD603925
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cacc_masa_jab_detail.html";
$BlockToParse = "main";
...
//Include events file @1-97772CAF
include_once("./t_cacc_masa_jab_detail_events.php");
