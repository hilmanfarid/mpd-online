...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->p_payment_type_id->GetValue();
        $p_app_userForm->DataSource->Parameters["urlp_payment_type_id"] = $selected_id;
...
// Start Bdr    
    ...
    if ($Component->DataSource->p_payment_type_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-C747E8E9
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_payment_type; //Compatibility
...
// -------------------------
    ...
    global $selected_id;
    $selected_id = -1;
    $selected_id=CCGetFromGet("p_payment_type_id", $selected_id);
// -------------------------
//End Custom Code
