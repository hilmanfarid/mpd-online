...
<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_change_pass_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_change_pass.php" forShow="True" url="p_change_pass.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
