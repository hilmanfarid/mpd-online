<?php
//Include Common Files @1-70F7D05A
define("RelativePath", "..");
define("PathToCurrentPage", "/main/");
define("FileName", "sikp_login.php");
...
//Class_Initialize Event @2-B3808F4C
    function clsRecordLogin($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->Button_DoLogin1 = & new clsButton("Button_DoLogin1", $Method, $this);
        }
    }
    ...
    function Operation()
    {
        ...
        if($this->FormSubmitted) {
            ...
            if($this->Button_DoLogin->Pressed) {
                $this->PressedButton = "Button_DoLogin";
            } else if($this->Button_DoLogin1->Pressed) {
                $this->PressedButton = "Button_DoLogin1";
            }
        }
        $Redirect = "../index.php";
        if($this->Validate()) {
            ...
            } else if($this->PressedButton == "Button_DoLogin1") {
                if(!CCGetEvent($this->Button_DoLogin1->CCSEvents, "OnClick", $this->Button_DoLogin1)) {
                    $Redirect = "";
                }
            }
        } else {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "sikp_login.html";
$BlockToParse = "main";
...
//Include events file @1-A53F8100
include_once("./sikp_login_events.php");
