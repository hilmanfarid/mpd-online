<?php
//Include Common Files @1-69B4A6F3
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "jenis_bulan.php");
...
//Class_Initialize Event @2-F91242FB
...
//DataSource Variables @2-FD480042
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-52419C5C
...
//Open Method @2-D2B10334
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select sum(target_amount) as target_amount, sum(realisasi_amt) as realisasi_amt, bulan, vat_code from v_revenue_target_vs_realisasi_month\n" .
        "where t_revenue_target_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "group by bulan, vat_code, start_date) cnt";
        $this->SQL = "select sum(target_amount) as target_amount, sum(realisasi_amt) as realisasi_amt, bulan, vat_code from v_revenue_target_vs_realisasi_month\n" .
        "where t_revenue_target_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "\n" .
        "group by bulan, vat_code, start_date {SQL_OrderBy}";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "jenis_bulan.html";
$BlockToParse = "main";
