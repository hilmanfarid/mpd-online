<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\services" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="True" cachingEnabled="False" cachingDuration="1 minutes" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" connection="ConnSIKP" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList" dataSource="select sum(target_amount) as target_amount, sum(realisasi_amt) as realisasi_amt, bulan, vat_code from v_revenue_target_vs_realisasi_month
where t_revenue_target_id = {t_revenue_target_id}
group by bulan, vat_code, start_date
...
order By
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="jenis_bulan.php" forShow="True" url="jenis_bulan.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
