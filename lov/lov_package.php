<?php
//Include Common Files @1-ADB9A4E2
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_package.php");
...
//Class_Initialize Event @2-B421170E
    function clsGridLovGrid($RelativePath, & $Parent)
    {
        ...
        $this->object_name = & new clsControl(ccsLabel, "object_name", "object_name", ccsText, "", CCGetRequestParam("object_name", ccsGet, NULL), $this);
...
//Show Method @2-4CE09D20
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["object_name"] = $this->object_name->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->object_name->SetValue($this->DataSource->object_name->GetValue());
                $this->Attributes->SetValue("rowNumber", $this->RowNumber);
                $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeShowRow", $this);
                $this->Attributes->Show();
                $this->owner->Show();
                $this->PILIH->Show();
                $this->object_name->Show();
                $Tpl->block_path = $ParentPath . "/" . $GridBlock;
                $Tpl->parse("Row", true);
            }
        }
...
//DataSource Variables @2-1C148FC1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-73064D8E
    function clsLovGridDataSource(& $Parent)
    {
        ...
        $this->object_name = new clsField("object_name", ccsText, "");
...
//Open Method @2-32486835
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT owner, object_name \n" .
        "FROM user_objects \n" .
        "WHERE object_type = 'PACKAGE'\n" .
        "AND upper(object_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT owner, object_name \n" .
        "FROM user_objects \n" .
        "WHERE object_type = 'PACKAGE'\n" .
...
//SetValues Method @2-CFDF1930
    function SetValues()
    {
        $this->owner->SetDBValue($this->f("owner"));
        $this->object_name->SetDBValue($this->f("object_name"));
    }
...
//Operation Method @3-C329565C
    function Operation()
    {
        ...
        $Redirect = "lov_package.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_package.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_package.html";
$BlockToParse = "main";
...
//Include events file @1-CD5C9FDE
include_once("./lov_package_events.php");
