<?php
//Include Common Files @1-651B98FC
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_finance_period.php");
...
class clsGridLOV_PERIOD { //LOV_PERIOD class @2-C8A86068
...
//Class_Initialize Event @2-ADFFCE59
    function clsGridLOV_PERIOD($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "LOV_PERIOD";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid LOV_PERIOD";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsLOV_PERIODDataSource($this);
...
} //End LOV_PERIOD Class @2-FCB6E20C

class clsLOV_PERIODDataSource extends clsDBConnSIKP {  //LOV_PERIODDataSource Class @2-C1022BF6

//DataSource Variables @2-54A3195D
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-283E4293
    function clsLOV_PERIODDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid LOV_PERIOD";
        $this->Initialize();
...
//Open Method @2-26F88F68
    function Open()
    {
        ...
        $this->SQL = "SELECT * \n\n" .
        "FROM p_finance_period {SQL_Where} {SQL_OrderBy}";
...
} //End LOV_PERIODDataSource Class @2-FCB6E20C
...
//Operation Method @3-1AB002E8
    function Operation()
    {
        ...
        $Redirect = "lov_finance_period.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_finance_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_finance_period.html";
$BlockToParse = "main";
...
//Include events file @1-9E23CBFF
include_once("./lov_finance_period_events.php");
...
// Controls
$LOV_PERIOD = & new clsGridLOV_PERIOD("", $MainPage);
$LOV = & new clsRecordLOV("", $MainPage);
$MainPage->LOV_PERIOD = & $LOV_PERIOD;
$MainPage->LOV = & $LOV;
$LOV_PERIOD->Initialize();
...
//Go to destination page @1-5293091D
if($Redirect)
{
