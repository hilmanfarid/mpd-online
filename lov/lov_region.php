<?php
//Include Common Files @1-17568830
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_region.php");
...
//Class_Initialize Event @2-A9CCCEF9
    function clsGridLOV_REGION($RelativePath, & $Parent)
    {
        ...
        $this->p_region_id = & new clsControl(ccsTextBox, "p_region_id", "p_region_id", ccsText, "", CCGetRequestParam("p_region_id", ccsGet, NULL), $this);
        $this->p_region_id->Visible = false;
...
//Show Method @2-470053AA
    function Show()
    {
        ...
        $this->DataSource->Parameters["expr34"] = 3;
        $this->DataSource->Parameters["expr38"] = 4;
...
//DataSource Variables @2-2B31CA69
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-6B3CC12F
...
//Prepare Method @2-717B3722
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "expr34", ccsFloat, "", "", $this->Parameters["expr34"], "", false);
        $this->wp->AddParameter("2", "expr38", ccsFloat, "", "", $this->Parameters["expr38"], "", false);
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "p_region_level_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsFloat),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "p_region_level_id", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsFloat),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "upper(region_name)", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
//Operation Method @3-386AC6D3
    function Operation()
    {
        ...
        $Redirect = "lov_region.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_region.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_region.html";
$BlockToParse = "main";
...
//Include events file @1-236142FC
include_once("./lov_region_events.php");
