<?php
//Include Common Files @1-2C708196
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_field.php");
...
//Class_Initialize Event @2-8DFB3465
    function clsGridLovGrid($RelativePath, & $Parent)
    {
        ...
        $this->data_type = & new clsControl(ccsLabel, "data_type", "data_type", ccsText, "", CCGetRequestParam("data_type", ccsGet, NULL), $this);
...
//Show Method @2-3533B08B
    function Show()
    {
        ...
        $this->DataSource->Parameters["urltable_name"] = CCGetFromGet("table_name", NULL);
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["data_type"] = $this->data_type->Visible;
...
//DataSource Variables @2-B52B0E9C
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-77BFDEC0
...
//Prepare Method @2-A6EFD5CA
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urltable_name", ccsText, "", "", $this->Parameters["urltable_name"], "", false);
        $this->wp->AddParameter("2", "urls_keyword", ccsText, "", "", $this->Parameters["urls_keyword"], "", false);
    }
//End Prepare Method

//Open Method @2-5222FDEE
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * \n" .
        "FROM user_tab_columns \n" .
        "WHERE table_name = '" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "'\n" .
        "AND upper(column_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("2"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * \n" .
        "FROM user_tab_columns \n" .
        "WHERE table_name = '" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "'\n" .
        "AND upper(column_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("2"), ccsText) . "%')";
...
//Class_Initialize Event @3-F0FA41B2
    function clsRecordLOV($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->table_name = & new clsControl(ccsHidden, "table_name", "table_name", ccsText, "", CCGetRequestParam("table_name", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @3-4F44DBB3
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//Operation Method @3-F1BEEFF8
    function Operation()
    {
        ...
        $Redirect = "lov_field.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_field.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_field.html";
$BlockToParse = "main";
...
//Include events file @1-63650EB5
include_once("./lov_field_events.php");
