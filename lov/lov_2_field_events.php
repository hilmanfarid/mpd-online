...
// -------------------------
    // Write your own code here.
	$headerOne = CCGetFromGet("LABEL1", "Label 1");
	$headerTwo = CCGetFromGet("LABEL2", "Label 2");
	$LovGrid->Header1->SetValue($headerOne);
	$LovGrid->Header2->SetValue($headerTwo);
// -------------------------
//End Custom Code
...
// -------------------------
    // Write your own code here.
	$nilai = $LovGrid->FIELD_0->GetValue() ."#~#".$LovGrid->FIELD_1->GetValue();
