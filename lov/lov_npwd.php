<?php
//Include Common Files @1-51B4DEDD
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_npwd.php");
...
//Operation Method @3-E7B46BB2
    function Operation()
    {
        ...
        $Redirect = "lov_npwd.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_npwd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_npwd.html";
$BlockToParse = "main";
...
//Include events file @1-33EF3BDF
include_once("./lov_npwd_events.php");
