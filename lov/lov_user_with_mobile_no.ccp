...
FROM p_app_user 
WHERE upper(app_user_name) LIKE upper('%{s_keyword}%')
AND is_employee = 'Y'
AND mobile_no is not null" parameterTypeListName="ParameterTypeList" resultSetType="parameter">
			<Components>
				...
				<Label id="63" fieldSourceType="DBColumn" dataType="Text" html="False" name="mobile_no" fieldSource="mobile_no" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LovGridmobile_no">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="LOV" returnPage="lov_user_with_mobile_no.ccp" PathID="LOV" connection="ConnSIKP">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_user_with_mobile_no_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_user_with_mobile_no.php" forShow="True" url="lov_user_with_mobile_no.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
