<?php
//Include Common Files @1-BE45071C
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_user_with_mobile_no.php");
...
//Class_Initialize Event @2-B3D400A7
...
//DataSource Variables @2-3919B220
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-5F5A968C
...
//Open Method @2-D2965356
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT *\n" .
        "FROM p_app_user \n" .
        "WHERE upper(app_user_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "AND is_employee = 'Y'\n" .
        "AND mobile_no is not null) cnt";
        $this->SQL = "SELECT *\n" .
        "FROM p_app_user \n" .
        "WHERE upper(app_user_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "AND is_employee = 'Y'\n" .
...
//Operation Method @3-9C314A11
    function Operation()
    {
        ...
        $Redirect = "lov_user_with_mobile_no.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_user_with_mobile_no.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_user_with_mobile_no.html";
$BlockToParse = "main";
...
//Include events file @1-00E4F2DB
include_once("./lov_user_with_mobile_no_events.php");
