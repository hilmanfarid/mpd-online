<?php
//Include Common Files @1-C686D21F
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_balance_sheet.php");
...
//Class_Initialize Event @2-AEB24FE6
...
//DataSource Variables @2-BDCF6A57
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-97C48EB3
...
//SetOrder Method @2-7A83D65C
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "p_balance_sheet_id";
...
//Open Method @2-EC76460B
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * \n" .
        "FROM p_balance_sheet\n" .
        "WHERE upper(listing_no) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "OR upper(report_label) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * \n" .
        "FROM p_balance_sheet\n" .
        "WHERE upper(listing_no) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        "OR upper(report_label) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') {SQL_OrderBy}";
...
//Operation Method @3-267D37DE
    function Operation()
    {
        ...
        $Redirect = "lov_balance_sheet.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_balance_sheet.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_balance_sheet.html";
$BlockToParse = "main";
...
//Include events file @1-26EF49BA
include_once("./lov_balance_sheet_events.php");
