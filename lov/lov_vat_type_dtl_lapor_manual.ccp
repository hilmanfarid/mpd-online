...
and
(upper(nomor_ayat) like '%{s_keyword}%' or
upper(nama_ayat) like '%{s_keyword}%')">
			<Components>
				<Label id="14" fieldSourceType="DBColumn" dataType="Text" html="False" name="nama_ayat" fieldSource="nama_ayat" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LOV_REGIONnama_ayat">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="27" visible="No" fieldSourceType="DBColumn" dataType="Float" name="p_vat_type_dtl_id" PathID="LOV_REGIONp_vat_type_dtl_id" fieldSource="p_vat_type_dtl_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<Label id="41" fieldSourceType="DBColumn" dataType="Text" html="False" name="nomor_ayat" fieldSource="nomor_ayat" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LOV_REGIONnomor_ayat">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="LOV" wizardCaption="Search P CUSTOMER SEGMENT " wizardOrientation="Horizontal" wizardFormMethod="post" returnPage="lov_vat_type_dtl_lapor_manual.ccp" PathID="LOV" pasteActions="pasteActions" connection="ConnSIKP">
			<Components>
				...
				<Hidden id="39" fieldSourceType="DBColumn" dataType="Float" name="p_vat_type_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOVp_vat_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_vat_type_dtl_lapor_manual_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_vat_type_dtl_lapor_manual.php" forShow="True" url="lov_vat_type_dtl_lapor_manual.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
