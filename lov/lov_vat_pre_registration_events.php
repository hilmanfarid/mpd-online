...
// -------------------------
    // Write your own code here.
	$nilai = $LOV_REGION->t_vat_pre_registration_id->GetValue() ."#~#".
	$LOV_REGION->company_brand->GetValue() ."#~#".
	$LOV_REGION->company_brand->GetValue() ."#~#".
	$LOV_REGION->brand_address_name->GetValue() ."#~#".
	$LOV_REGION->brand_address_no->GetValue() ."#~#".
	$LOV_REGION->brand_address_rt->GetValue() ."#~#".
	$LOV_REGION->brand_address_rw->GetValue() ."#~#".
	$LOV_REGION->brand_p_region_id_kel->GetValue() ."#~#".
	$LOV_REGION->brand_p_region_id_kec->GetValue() ."#~#".
	$LOV_REGION->brand_p_region_id->GetValue() ."#~#".
