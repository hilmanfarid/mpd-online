<?php
//Include Common Files @1-619C2F08
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_vat_type_dtl_lapor_manual.php");
...
//Operation Method @3-9BAB5C21
    function Operation()
    {
        ...
        $Redirect = "lov_vat_type_dtl_lapor_manual.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_vat_type_dtl_lapor_manual.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_vat_type_dtl_lapor_manual.html";
$BlockToParse = "main";
...
//Include events file @1-E32A6F9F
include_once("./lov_vat_type_dtl_lapor_manual_events.php");
