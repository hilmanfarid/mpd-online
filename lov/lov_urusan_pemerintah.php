<?php
//Include Common Files @1-C790E9F5
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_urusan_pemerintah.php");
...
class clsGridLOV_URUSAN_PEMERINTAH { //LOV_URUSAN_PEMERINTAH class @2-BE059DFB
...
//Class_Initialize Event @2-5BD7C027
    function clsGridLOV_URUSAN_PEMERINTAH($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "LOV_URUSAN_PEMERINTAH";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid LOV_URUSAN_PEMERINTAH";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsLOV_URUSAN_PEMERINTAHDataSource($this);
        ...
        $this->p_organization_id = & new clsControl(ccsTextBox, "p_organization_id", "p_organization_id", ccsText, "", CCGetRequestParam("p_organization_id", ccsGet, NULL), $this);
        $this->p_organization_id->Visible = false;
...
} //End LOV_URUSAN_PEMERINTAH Class @2-FCB6E20C

class clsLOV_URUSAN_PEMERINTAHDataSource extends clsDBConnSIKP {  //LOV_URUSAN_PEMERINTAHDataSource Class @2-F83744AA

//DataSource Variables @2-873F60CD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-45906746
    function clsLOV_URUSAN_PEMERINTAHDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid LOV_URUSAN_PEMERINTAH";
        $this->Initialize();
        ...
        $this->p_organization_id = new clsField("p_organization_id", ccsText, "");
        

    }
//End DataSourceClass_Initialize Event

//SetOrder Method @2-86D2EC56
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "organization_code";
...
//Open Method @2-05AFE55E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select p_organization_id, organization_code, organization_name organization_name, description\n" .
        "from p_organization\n" .
        "where length(organization_code) = 4 AND\n" .
        "(upper(organization_code) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%' OR\n" .
        "upper(organization_name) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "select p_organization_id, organization_code, organization_name organization_name, description\n" .
        "from p_organization\n" .
        "where length(organization_code) = 4 AND\n" .
        "(upper(organization_code) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%' OR\n" .
        "upper(organization_name) LIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') {SQL_OrderBy}";
...
//SetValues Method @2-4D834296
    function SetValues()
    {
        ...
        $this->p_organization_id->SetDBValue($this->f("p_organization_id"));
    }
//End SetValues Method

} //End LOV_URUSAN_PEMERINTAHDataSource Class @2-FCB6E20C
...
//Operation Method @3-9DBCC2B3
    function Operation()
    {
        ...
        $Redirect = "lov_urusan_pemerintah.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_urusan_pemerintah.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_urusan_pemerintah.html";
$BlockToParse = "main";
...
//Include events file @1-D7155A26
include_once("./lov_urusan_pemerintah_events.php");
...
// Controls
$LOV_URUSAN_PEMERINTAH = & new clsGridLOV_URUSAN_PEMERINTAH("", $MainPage);
$LOV = & new clsRecordLOV("", $MainPage);
$MainPage->LOV_URUSAN_PEMERINTAH = & $LOV_URUSAN_PEMERINTAH;
$MainPage->LOV = & $LOV;
$LOV_URUSAN_PEMERINTAH->Initialize();
...
//Go to destination page @1-D85CBB2A
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnSIKP->close();
    header("Location: " . $Redirect);
    unset($LOV_URUSAN_PEMERINTAH);
    unset($LOV);
    unset($Tpl);
    exit;
}
...
//Show Page @1-60A484C6
$LOV_URUSAN_PEMERINTAH->Show();
$LOV->Show();
$Tpl->block_path = "";
