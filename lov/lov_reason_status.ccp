...
">
			<Components>
				...
				<Label id="16" fieldSourceType="DBColumn" dataType="Text" html="False" name="reference_name" fieldSource="reference_name" wizardCaption="DESCRIPTION" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LOV_PAJAKreference_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="27" visible="No" fieldSourceType="DBColumn" dataType="Text" name="p_reference_list_id" PathID="LOV_PAJAKp_reference_list_id" fieldSource="p_reference_list_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_reason_status_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_reason_status.php" forShow="True" url="lov_reason_status.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
