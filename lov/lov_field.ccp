...
AND upper(column_name) LIKE upper('%{s_keyword}%')" parameterTypeListName="ParameterTypeList" resultSetType="parameter">
			<Components>
				<Label id="14" fieldSourceType="DBColumn" dataType="Text" html="False" name="column_name" fieldSource="column_name" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LovGridcolumn_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="57" fieldSourceType="DBColumn" dataType="Text" html="False" name="data_type" fieldSource="data_type" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LovGriddata_type">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Action actionName="Custom Code" actionCategory="General" id="63"/>
			...
			<SQLParameters>
				<SQLParameter id="60" variable="table_name" parameterType="URL" dataType="Text" parameterSource="table_name"/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="LOV" returnPage="lov_field.ccp" PathID="LOV" connection="ConnSIKP">
			<Components>
				...
				<Hidden id="62" fieldSourceType="DBColumn" dataType="Text" name="table_name" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOVtable_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_field_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_field.php" forShow="True" url="lov_field.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
