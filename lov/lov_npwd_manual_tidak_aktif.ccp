...
and ( upper(a.npwd) like '%{s_keyword}%' OR
...
upper(a.company_brand) like '%{s_keyword}%')">
			<Components>
				...
				<Label id="54" fieldSourceType="DBColumn" dataType="Text" html="False" name="last_satatus_date" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOV_ORDERlast_satatus_date" fieldSource="last_satatus_date">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
<Label id="55" fieldSourceType="DBColumn" dataType="Text" html="False" name="code" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOV_ORDERcode" fieldSource="code">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_npwd_manual_tidak_aktif_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_npwd_manual_tidak_aktif.php" forShow="True" url="lov_npwd_manual_tidak_aktif.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
