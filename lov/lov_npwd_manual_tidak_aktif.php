<?php
//Include Common Files @1-2E05AE64
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_npwd_manual_tidak_aktif.php");
...
//Class_Initialize Event @2-A9837AC7
...
//DataSource Variables @2-4C5EA8F2
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-39C11E91
...
//Open Method @2-374AC712
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select a.t_cust_account_id, a.npwd, wp_name,a.wp_address_name, \n" .
        "a.p_vat_type_id, vat_code, a.p_vat_type_dtl_id, vat_code_dtl,A.last_satatus_date, b.code\n" .
        "from f_get_npwd_by_username('ADMIN') AS tbl\n" .
        "LEFT JOIN t_cust_account A ON A.t_cust_account_id= tbl.t_cust_account_id\n" .
        "left join p_account_status b on a.p_account_status_id = b.p_account_status_id\n" .
        "WHERE a.p_account_status_id != 1\n" .
        "and ( upper(a.npwd) like '%" . $this->SQLValue($this->wp->GetDBValue("2"), ccsText) . "%' OR\n" .
...
//Operation Method @3-6217231A
    function Operation()
    {
        ...
        $Redirect = "lov_npwd_manual_tidak_aktif.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_npwd_manual_tidak_aktif.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_npwd_manual_tidak_aktif.html";
$BlockToParse = "main";
...
//Include events file @1-18A1EF19
include_once("./lov_npwd_manual_tidak_aktif_events.php");
