<?php
//Include Common Files @1-50469276
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_region_kel.php");
...
//Show Method @2-D84038F0
    function Show()
    {
        ...
        $this->DataSource->Parameters["expr38"] = 6;
...
//Operation Method @3-1555CC3A
    function Operation()
    {
        ...
        $Redirect = "lov_region_kel.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_region_kel.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_region_kel.html";
$BlockToParse = "main";
...
//Include events file @1-416597DA
include_once("./lov_region_kel_events.php");
