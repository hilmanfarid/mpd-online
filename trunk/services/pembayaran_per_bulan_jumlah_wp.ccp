...
left join 
 ...
 WHERE P Year Period Id = {p Year Period Id} " wizardAllowInsert="False" pasteActions="pasteActions">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="pembayaran_per_bulan_jumlah_wp_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="pembayaran_per_bulan_jumlah_wp.php" forShow="True" url="pembayaran_per_bulan_jumlah_wp.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
