...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data, $user) {
		...
		$this->Cell($this->lengthCell-$lbody1-$lbody1-2, $this->height, "Pengurangan BPHTB Waris a.n. ".$data["wp_name"], "B", 0, "");
		$this->Ln();$this->Ln();
		...
		$this->barisBaru("", "2 Fasilitas Untuk", ": Fasos");
