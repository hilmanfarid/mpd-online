...
define("FileName", "cetak_sptpd_ppj_pdf.php");
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data) {
		...
		// $this->Cell($lengthCell, $this->height, "2.	BENTUK SURAT PEMBERITAHUAN PAJAK DAERAH UNTUK PAJAK PENERANGAN JALAN", 0, 0, 'L');
		// $this->Ln(6);
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "PAJAK PENERANGAN JALAN", "LR", 0, 'C');
		$this->Ln();
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "1.	Harap diisi dalam rangkap (5) ditulis dengan huruf CETAK.", "LR", 0, 'L');
		$this->Ln();
		...
		$this->Ln();
		$this->SetFont('Arial', 'B', 10);
		$this->Cell($lengthCell, $this->height, "C. DIISI OLEH PETUGAS PENERIMA", 1, 0, 'C');
		$this->Ln();
		$this->SetFont('Arial', '', 9);
