...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data) {
		...
		$this->Cell($lcek1, $this->height, "               No. Urut : ".$data["no_urut"], "", 0, 'L');
		...
		$this->Cell($ltable4, $this->height + 2, $tot, "TBLR", 0, 'R');
		...
		$this->Cell($lowTable1, $this->height + 2, "Ruang untuk Teraan", "LTR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, "Diterima oleh", "LTR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, "............................. Tahun", "LTR", 0, 'C');
		
		$this->Ln();
		$this->Cell($lowTable1, $this->height + 2, "Kas Register/Tanda Tangan", "LR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, "Petugas Tempat Pembayaran", "LR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, ".....................", "LR", 0, 'C');
		
		$this->Ln();
		$this->Cell($lowTable1, $this->height + 2, "Petugas Penerima", "LR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, "Tanggal         :", "LR", 0, 'L');
		...
		$this->Ln();
		$this->Cell($lowTable1, $this->height + 2, "", "LR", 0, 'C');
		$this->Cell($lowTable1, $this->height + 2, "Tanda Tangan:", "LR", 0, 'L');
		$this->Cell($lowTable1, $this->height + 2, "", "LR", 0, 'C');
		...
		$this->Cell($lowTable1, $this->height + 2, "Nama Terang:", "BLR", 0, 'L');
		$this->Cell($lowTable1, $this->height + 2, "(.............................)", "BLR", 0, 'C');
