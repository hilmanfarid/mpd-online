...
define("FileName", "cetak_sptpd_restoran_pdf.php");
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data) {
		...
		// $this->Cell($lengthCell, $this->height, "2.	BENTUK SURAT PEMBERITAHUAN PAJAK DAERAH UNTUK PAJAK RESTORAN", 0, 0, 'L');
		// $this->Ln(6);
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "PAJAK RESTORAN", "LR", 0, 'C');
		$this->Ln();
		...
		$kelas3 = ($lengthCell * 3) / 16;
		$kelas4 = ($lengthCell * 7) / 16;
		...
		$this->Cell($kel1, $this->height, " 1. Menggunakan Kas Register", "L", 0, 'L');
		...
		$this->Ln();
		$this->Cell($kel1, $this->height, " 2. Mengadakan pembukuan/pencetakan", "L", 0, 'L');
		$this->Cell($spcs, $this->height, "", 0, 0, 'L');
		$this->Cell($kela1, $this->height, "", 1, 0, 'C'); //isi
		$this->Cell($kela2, $this->height, "", 0, 0, 'C');	
		$this->Cell($kel3, $this->height, "1.  Ya", 0, 0, 'L');
		...
		$this->Cell($lengthCell, $this->height, "", "LR", 0, 'L');
		$this->Ln();
		$this->Cell($kel1, $this->height, " 3. Mengadakan Bon", "L", 0, 'L');
		$this->Cell($spcs, $this->height, "", 0, 0, 'L');
		$this->Cell($kela1, $this->height, "", 1, 0, 'C'); //isi
		$this->Cell($kela2, $this->height, "", 0, 0, 'C');	
		$this->Cell($kel3, $this->height, "1.  Ya", 0, 0, 'L');
