...
define("FileName", "cetak_formulir_ppj_pdf.php");
...
$query="begin;";
$dbConn->query($query);
$query="select * from f_cetak_pajak_ppj(".$custId.", NULL, NULL, NULL, NULL, NULL, NULL, NULL, "
...
$dbConn->query($query);
while ($dbConn->next_record()) {
	$dataBaru["pwr_classification_desc"][] = $dbConn->f("pwr_classification_desc");
	$dataBaru["power_capacity"][] = $dbConn->f("power_capacity");
	$dataBaru["power_factor"][] = $dbConn->f("power_factor");
	$dataBaru["service_charge"][] = $dbConn->f("service_charge");	
	$dataBaru["description"][] = $dbConn->f("description");
	$dataBaru["pwr_classification_code"][] = $dbConn->f("pwr_classification_code");
}

$query = "fetch all in \"refone3\";";
$dbConn->query($query);
while ($dbConn->next_record()) {
	$dataBaru2["owner_qty"][] = $dbConn->f("owner_qty");
	$dataBaru2["power_capacity"][] = $dbConn->f("power_capacity");
	$dataBaru2["description"][] = $dbConn->f("description");
}
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data,$dataArr,$dataBaru,$dataBaru2) {
		$this->AliasNbPages();
		$this->AddPage("P");		
		$startY = $this->GetY();
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "WAJIB PAJAK PENERANGAN JALAN", "LR", 0, 'C');
		$this->Ln();
		...
		*/
		...
		$this->Cell($per2, $this->height, "Pendataan Pajak Penerangan Jalan Non PLN", "TB", 0, 'L');
		$this->Cell($per3, $this->height, "", "TBR", 0, 'L');
		$this->Ln();
		...
		$this->Cell($kol7, $this->height, "", "RT", 0, 'C');
		$this->Ln();
		...
		$this->Cell($kol7, $this->height*2, "", "R", 0, 'C');
		$this->Ln($this->height-5);
		$this->Cell($kol1, $this->height*2, "", "L", 0, 'C');
		$this->Cell($kol2, $this->height*2, "Golongan", 0, 0, 'C');
		$this->Cell($kol3, $this->height*2, "Kapasitas Daya", 0, 0, 'C');
		$this->Cell($kol4, $this->height+2, "Harga Satuan", 0, 0, 'C');
		$this->Cell($kol5, $this->height*2, "Faktor Daya", 0, 0, 'C');
		$this->Cell($kol6, $this->height*2, "Keterangan", 0, 0, 'C');
		$this->Cell($kol7, $this->height*2, "", "R", 0, 'C');
		$this->Ln($this->height);
		$this->Cell($kol1, $this->height, "", "L", 0, 'C');
		$this->Cell($kol2, $this->height, "", 0, 0, 'C');
		$this->Cell($kol3, $this->height, "", 0, 0, 'C');
		$this->Cell($kol4, $this->height-2, "Listrik", 0, 0, 'C');
		$this->Cell($kol5, $this->height, "", 0, 0, 'C');
		$this->Cell($kol6, $this->height, "", 0, 0, 'C');
		$this->Cell($kol7, $this->height, "", "R", 0, 'C');
		$this->Ln();
		
		//isi kolom
		$this->SetWidths(array($kol1, $kol2, $kol3, $kol4, $kol5, $kol6, $kol7));
		$this->SetAligns(array("C", "L", "C", "C", "C", "L", "C"));
		for ($i=0; $i<count($dataBaru['pwr_classification_desc']); $i++) {
		$this->RowMultiBorderWithHeight(array("",
											  $dataBaru["pwr_classification_desc"][$i],
											  $dataBaru["power_capacity"][$i],
											  $dataBaru["service_charge"][$i],
											  $dataBaru["power_factor"][$i],
											  $dataBaru["description"][$i],
											  "")
											 ,
										array('L',
										      'TBL',
		...
		$this->Cell($kol7, $this->height, "", "RB", 0, 'C');
		$this->Ln();
		
		$this->Cell($per1, $this->height, "12. ", "TBL", 0, 'C');
		$this->Cell($per2, $this->height, "Pendataan Pajak Penerangan Jalan PLN", "TB", 0, 'L');
		$this->Cell($per3, $this->height, "", "TBR", 0, 'L');
		$this->Ln();
		...
		$this->Cell($kol_1, $this->height, "", "LT", 0, 'C');
		$this->Cell($kol_2, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol_3, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol_4, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol_5, $this->height, "", "RT", 0, 'C');
		$this->Ln();
		$this->Cell($kol_1, $this->height, "", "L", 0, 'C');
		$this->Cell($kol_2, $this->height, "Jumlah Pelanggan", 1, 0, 'C');
		$this->Cell($kol_3, $this->height, "Kapasitas Daya", 1, 0, 'C');
		$this->Cell($kol_4, $this->height, "Keterangan", 1, 0, 'C');
		$this->Cell($kol_5, $this->height, "", "R", 0, 'C');
		$this->Ln();
		//isi kolom 8 
		$this->SetWidths(array($kol_1, $kol_2, $kol_3, $kol_4, $kol_5));
		$this->SetAligns(array("C", "C", "C", "L", "C"));
		for ($i=0; $i<count($dataBaru2['owner_qty']); $i++) {
		$this->RowMultiBorderWithHeight(array("",
											  $dataBaru2["owner_qty"][$i],
											  $dataBaru2["power_capacity"][$i],
											  $dataBaru2["description"][$i],
											  "")
											 ,
										array('L',
										      'TBL',
		...
		$this->Cell($kol_1, $this->height, "", "LB", 0, 'C');
		$this->Cell($kol_2, $this->height, "", "B", 0, 'C');
		$this->Cell($kol_3, $this->height, "", "B", 0, 'C');
		$this->Cell($kol_4, $this->height, "", "B", 0, 'C');
		$this->Cell($kol_5, $this->height, "", "RB", 0, 'C');
		$this->Ln();
