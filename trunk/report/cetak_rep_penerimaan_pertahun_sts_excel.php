...
define("FileName", "cetak_rep_penerimaan_pertahun_sts_excel.php");
...
echo "<h3>Periode Belum Bayar : ".str_replace("'","",$params['start_piutang'])." s/d ".str_replace("'","",$params['end_piutang'])."<br/>";	
echo "Posisi Laporan Tanggal : ".str_replace("'","",$params['tgl_status'])."</h3>";	
