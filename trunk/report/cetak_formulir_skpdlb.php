...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data) {
		...
		$this->Cell($lheader3, $this->height, "SKPDLB", "R", 0, 'C');
		...
		$this->Cell($lheader3, $this->height-2, "(Surat Ketetapan Pajak Daerah Lebih Bayar)", "R", 0, 'C');
		$this->SetFont('Arial', '', 10);
		...
		$this->Cell(30, $this->height+1, "     Masa Pajak", "", 0, 'L');
		$this->Cell($lheader3-30, $this->height+1, ":", "R", 0, 'L');
		...
		*/
		...
		$this->SetFont('Arial', '', 10);
		$this->Cell(30, $this->height-1, "     Tahun Pajak", "", 0, 'L');
		$this->Cell($lheader3-30, $this->height-1, ":", "R", 0, 'L');
		$this->Cell($lheader2, $this->height-1, "", "R", 0, 'C');
		$this->Ln();
		...
		$this->Cell($lbody1 - 5, $this->height + 2, "NOP", "", 0, 'L');
		$this->Cell($lbody1, $this->height + 2, "", "", 0, 'L');
		$this->Cell($lbody2, $this->height + 2, "", "R", 0, 'L');
		$this->Ln($this->height-4);
		
		$this->Cell($lbody1, $this->height, "", "L", 0, 'R');
		...
		$this->Cell($lbody3, $this->height, ": ".$data["njop_pbb"], "", 0, 'L');
		$this->Ln();
		...
		$this->Cell($this->lengthCell - 10, $this->height+2, "I. Berdasarkan Pasal 76 Peraturan Daerah Nomor 20 Tahun 2011, telah dilakukan pemeriksaan atau keterangan lain diatas pelaksanaan", "", 0, "L");
		$this->Cell(5, $this->height+2, "", "R", 0, 'C');
		$this->Ln();
		$this->tulis("   kewajiban :","L");
		*/
		$this->SetWidths(array(5, 5, $this->lengthCell - 15, 5));
		$this->SetAligns(array("C", "L", "J", "C"));
		$this->RowMultiBorderWithHeight(
			array
			(
				"",
				"I.",
				"Berdasarkan Pasal 76 Peraturan Daerah Nomor 20 Tahun 2011, telah dilakukan pemeriksaan atau keterangan lain diatas pelaksanaan kewajiban :",
				""
			),
			array
			(
		...
		$this->Cell($lbody1 - 10, $this->height + 2, "Ayat Pajak", "", 0, 'L');
		...
		$this->Cell($lbody1 - 10, $this->height, "Nama Pajak", "", 0, 'L');
		$this->Cell($lbody3, $this->height, ": BPHTB", "R", 0, 'L');
		$this->Ln();
		$this->Cell($this->lengthCell, $this->height, "", "LR", 0, 'L');
		$this->Ln();
		...
		$this->RowMultiBorderWithHeight(
			...
			(
				"",
				"II.",
				"Dari pemeriksaan atau keterangan lain tersebut di atas, perhitungan jumlah yang masih harus dibayar adalah sebagai berikut:",
				""
			),
			array
			(
		...
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody3 - 10, $this->height, "2. Pajak yang Terutang", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		...
		$this->Cell(10, $this->height, "", "L", 0, 'R');
		$this->Cell($this->lengthCell - 10, $this->height, "3. Kredit Pajak", "R", 0, 'L');
		$this->Ln();
		//$this->tulis("3. Kredit Pajak", "L");
		
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody2 - 10, $this->height, "    a. Setoran yang dilakukan", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, number_format($data["bphtb_amt_final"],2,",","."), "", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		$this->Ln();
		
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody2 - 10, $this->height, "    b. Lain-lain", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, "-", "", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		...
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody2 - 10, $this->height, "    c. Dikurangi kompensasi kelebihan ke tahun yang akan datang", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "B", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, "-", "B", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		$this->Ln();
		
		$jumno3 = $data["bphtb_amt_final"];
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		...
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody3 - 10, $this->height, "4. Jumlah kelebihan pembayaran Pokok Pajak (3d-2)", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, number_format($jumno3-$data["restitusi_amt"],2,",","."), "", 0, 'R');
		$this->Cell(10, $this->height, "", "R", 0, 'R');
		$this->Ln();
		
		$this->Cell(10, $this->height, "", "L", 0, 'R');
		$this->Cell($this->lengthCell - 10, $this->height, "5. Sanksi Administrasi", "R", 0, 'L');
		$this->Ln();
		//$this->tulis("    5. Sanksi Administrasi", "L");
		
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody2 - 10, $this->height, "    a. Bunga Pasal 74 ayat(1)", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, "-", "", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		...
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody2 - 10, $this->height, "    b. Bunga Pasal 74 ayat(6)", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "B", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, "-", "B", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		...
		$this->Cell(5, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody1-5, $this->height+1, "PERHATIAN:", "", 0, 'L');
		$this->Cell($lbody3, $this->height, "", "R", 0, 'L');
		$this->Ln();
		$this->SetFont('Arial', '', 8);
		$this->Cell(5, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody1-5, $this->height+1, "Pengembalian Kelebihan Pajak dilakukan pada Kas Daerah menggunakan Surat Perintah Pencairan Dana (SP2D)", "", 0, 'L');
		$this->Cell($lbody3, $this->height, "", "R", 0, 'L');
		$this->Ln();
		$this->Cell($this->lengthCell, $this->height, "", "LR", 0, 'L');
		$this->Ln();
		...
		*/
		...
		$this->Cell($lbody1 + 10, $this->height, "Bandung, ..............................................."/*. $data["tanggal"]*/, "R", 0, 'C');
		$this->Ln();

		
		$this->Cell($lbody3 - 10, $this->height, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "An. KEPALA DINAS PELAYANAN PAJAK", "R", 0, 'C');
		$this->Ln();

		$this->Cell($lbody3 - 10, $this->height, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "KOTA BANDUNG", "R", 0, 'C');
		$this->Ln();
				
		$this->Cell($lbody3 - 10, $this->height, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "Kepala Bidang Pajak Pendaftaran", "R", 0, 'C');
		$this->Ln();
		...
		$this->Cell($lbody3 - 10, $this->height, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "H. SONI BAKHTIAR, S.Sos, M.Si.", "R", 0, 'C');
		$this->Ln();

		$this->Cell($lbody3 - 10, $this->height, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "Pembina", "R", 0, 'C');
		$this->Ln();

		$this->Cell($lbody3 - 10, $this->height-2, "", "L", 0, 'C');
		$this->Cell($lbody1 + 10, $this->height-2, "NIP. 19750625 199403 1 001", "R", 0, 'C');
		$this->Ln();
