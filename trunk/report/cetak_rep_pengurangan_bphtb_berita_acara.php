...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data, $user) {
		...
		$this->barisBaru_special("", "Akta/ Risalah Lelang/ Keputusan Pemberian Hak/ Putusan Hakim/ Dokumen", ": SK Kepala Kantor Pertanhan Kota Bandung");
		$this->barisBaru("", "- Nomor", ": " . "291/HM/BPN 32.73/2014");
		$this->barisBaru("", "- Tanggal", ": " . "08 Oktober 2014");
		$this->barisBaru("", "NJOP", ": " . "1.000.000,00");
		$this->barisBaru_special("", "NJOP (Harta Bersama dimana setengah bagian Alm. suami diberikan kepada istri yang", ": " . "1.000.000,00");
		$this->Cell($lbody1, $this->height, "", "", 0, "");
		...
		$this->RowMultiBorderWithHeight(
			array
			(	"Bahwa pemohon merupakan ahli waris dari : "."Departemen Dalam Negeri \n".
				"Berdasarkan "."SK Kepala Kantor Pertanahan Kota Bandung \n".
				"No "."291/HM/BPN 32.73/2014"." tanggal "."08 Oktober 2014"
			),
			array
			(
				""
		...
		$this->RowMultiBorderWithHeight(
			array
			(	"Secara normatif, bedasarkan Pasal 17 Ayat 3 huruf a angka 4 Peraturan Walikota Nomor 393 Tahun 2012 bahwa Pemberian pengurangan dan keringanan dapat diberikan kepada Wajib Pajak orang pribadi yang menerima hibah dari orang pribadi yang mempunyai hubungan keluarga sedarah dalam garis keturunan lurus satu derajat ke atas atau satu derajat ke bawah, sebesar 50% (lima puluh persen) yang didukung oleh bukti akta hibah dari notaris yang berdasarkan ketentuan yang berlaku. Di luar garis keturunan tersebut tidak memperoleh hak keringanan atau pengurangan."
			),
			array
			(
				""
