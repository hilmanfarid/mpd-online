	...
	*/
	...
	function PageCetak($data, $user) {
		...
		$this->RowMultiBorderWithHeight(
			...
			(
				"",
				"Tanah dan bangunan tersebut merupakan Harta Bersama (Gono-Gini) Suami-Istri dimana Istri masih hidup dan suami telah meninggal berdasarkan Ps. 35 UU No. 1 Th. 1973 tentang Perkawinan, maka objek waris yang dikenakan BPHTB adalah bagian dari Suami yang telah meninggal, maka perhitungan NJOP-nya adalah sebagai berikut:"
			),
			array
			(
				"",
