...
$query="select a.*, (a.address_name || a.address_no) AS address, b.vat_code from t_cust_account AS a
		...
		WHERE npwd IN ('P200342820103', 'P200279820302', 'P200318820502',
                        ...
                        'P200286251201', 'P200276841304', 'P200279010302',
                        'P200275490703', 'P200311250301')";
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data,$no_urut) {
		...
		$this->Cell($lkepada2, $this->height, "Bandung, 17 September 2014", "R", 0, 'L');
		$this->Ln();
		...
		// $this->newLine();
		$this->Cell($this->lengthCell, $this->height, "SURAT TEGURAN III", "LR", 0, 'C');
		$this->newLine();
		...
		$this->Cell($lbody4, $this->height, "", "", 0, 'C');
		$this->Cell($lbody4, $this->height, "Bandung, 17 September 2014" /*. $data["tanggal"]*/, "", 0, 'C');
