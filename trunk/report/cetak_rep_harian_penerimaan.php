...
class FormCetak extends FPDF {
	...
	*/
	...
	$cetak_summary		= CCGetFromGet("cetak_summary", "");
		...
		$this->SetWidths(array($ltable1,$ltable5,$ltable3,$ltable1+$ltable3+$ltable1+$ltable3+$ltable1+$ltable3+$ltable1,$ltable1 + $ltable3 + $ltable1 + $ltable3 + $ltable1 + $ltable3,$ltable1+$ltable3+$ltable3+$ltable3));
		$this->RowMultiBorderWithHeight(array("","","","PENERIMAAN SSPD","PELAPORAN SPTPD",""),array("LTR","LTR","LTR","BT","LTBR","LTBR"),$this->height);
		$this->Cell($ltable1, $this->height, "NO.", "LR", 0, 'C');
		$this->Cell($ltable5, $this->height, "JENIS PAJAK", "LR", 0, 'C');
		$this->Cell($ltable3, $this->height, "TARGET", "LR", 0, 'C');
		...
		$this->Cell($ltable1 + $ltable3, $this->height, "HARI INI", "TBLR", 0, 'C');
		$this->Cell($ltable1 + $ltable3, $this->height, "SD HARI LALU", "TBLR", 0, 'C');
		$this->Cell($ltable1 + $ltable3, $this->height, "SD HARI INI", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "SPTPD", "TLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "SISA LEBIH/KRG", "TLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "REALISASI THD", "TLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "JML REALISASI", "TLR", 0, 'C');
		$this->Ln();
		...
		$this->Cell($ltable3, $this->height, "PIUTANG", "BLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "", "BLR", 0, 'C');
		$this->Ln();		
		$this->Cell($ltable1, $this->height, "A", "BLR", 0, 'C');
		$this->Cell($ltable5, $this->height, "B", "BLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "C", "BLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "D", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "E", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "F", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "G", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "H", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "I", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "J", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "K", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "L", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "M", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "N", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "O", "TBLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "P", "TBLR", 0, 'C');
		$this->Cell($ltable1, $this->height, "K - D", "BLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "|P - I|", "BLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "Q", "BLR", 0, 'C');
		$this->Cell($ltable3, $this->height, "I + Q", "BLR", 0, 'C');
		$this->Ln();
		...
		$this->SetWidtHs(array($lbody3 - 10,$lbody1 + 10));
		$this->SetAligns(array("C", "C","C","C","C"));
		$this->RowMultiBorderWithHeight(array("","KEPALA SEKSI VERIFIKASI OTORISASI DAN PEMBUKUAN"),array("",""),$this->height);
		$this->Ln();
		$this->Cell($lbody3 - 10, $this->height, "", "", 0, 'L');
		...
		//$this->newLine();
		$this->Cell($lbody3 - 10, $this->height, "", "", 0, 'L');
		$this->Cell($lbody1 + 10, $this->height, "(Drs. H. UGAS RAHMANSYAH, SAP, MAP)", "", 0, 'C');
		$this->Ln();
		$this->Cell($lbody3 - 10, $this->height, "", "", 0, 'L');
		$this->Cell($lbody1 + 10, $this->height, "(NIP 19640127 199703 1001)", "", 0, 'C');
	}
