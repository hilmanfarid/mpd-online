...
AND upper(object_name) LIKE upper('%{s_keyword}%')" parameterTypeListName="ParameterTypeList" resultSetType="parameter">
			<Components>
				...
				<Label id="57" fieldSourceType="DBColumn" dataType="Text" html="False" name="object_name" fieldSource="object_name" wizardCaption="CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="LovGridobject_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="LOV" returnPage="lov_package.ccp" PathID="LOV" connection="ConnSIKP">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_package_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_package.php" forShow="True" url="lov_package.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
