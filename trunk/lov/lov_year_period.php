<?php
//Include Common Files @1-7AA824C6
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_year_period.php");
...
//Class_Initialize Event @2-DD9962D4
    function clsGridLOV_ORDER($RelativePath, & $Parent)
    {
        ...
        $this->p_year_period_id = & new clsControl(ccsTextBox, "p_year_period_id", "p_year_period_id", ccsText, "", CCGetRequestParam("p_year_period_id", ccsGet, NULL), $this);
...
//DataSource Variables @2-4BF01C77
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E9BF2D3A
...
//Open Method @2-DC28115E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select * from p_year_period\n" .
        "where upper(year_code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') cnt";
        $this->SQL = "select * from p_year_period\n" .
        "where upper(year_code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%' {SQL_OrderBy}";
...
//Operation Method @3-F13470EE
    function Operation()
    {
        ...
        $Redirect = "lov_year_period.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_year_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_year_period.html";
$BlockToParse = "main";
...
//Include events file @1-A65330C6
include_once("./lov_year_period_events.php");
