<?php
//Include Common Files @1-7F485096
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_reason_status.php");
...
//Class_Initialize Event @2-530E1575
    function clsGridLOV_PAJAK($RelativePath, & $Parent)
    {
        ...
        $this->p_reference_list_id = & new clsControl(ccsTextBox, "p_reference_list_id", "p_reference_list_id", ccsText, "", CCGetRequestParam("p_reference_list_id", ccsGet, NULL), $this);
        $this->p_reference_list_id->Visible = false;
...
//DataSource Variables @2-8948A40E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-7774164C
...
//Open Method @2-E2402B0F
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select p_reference_list_id, code, reference_name \n" .
        "from p_reference_list\n" .
        "where p_reference_type_id =1 and\n" .
        "upper(code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
        ") cnt";
        $this->SQL = "select p_reference_list_id, code, reference_name \n" .
        "from p_reference_list\n" .
        "where p_reference_type_id =1 and\n" .
        "upper(code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%'\n" .
        "";
...
//Operation Method @3-CC32F490
    function Operation()
    {
        ...
        $Redirect = "lov_reason_status.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_reason_status.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_reason_status.html";
$BlockToParse = "main";
...
//Include events file @1-64E71796
include_once("./lov_reason_status_events.php");
