<?php
//BindEvents Method @1-88B93F02
function BindEvents()
{
    global $V_SUBMITTER;
    $V_SUBMITTER->Button_Update->CCSEvents["OnClick"] = "V_SUBMITTER_Button_Update_OnClick";
    $V_SUBMITTER->Button_Reject->CCSEvents["OnClick"] = "V_SUBMITTER_Button_Reject_OnClick";
    $V_SUBMITTER->Button_Back->CCSEvents["OnClick"] = "V_SUBMITTER_Button_Back_OnClick";
...
//V_SUBMITTER_Button_Reject_OnClick @144-34DC5553
function V_SUBMITTER_Button_Reject_OnClick(& $sender)
{
    $V_SUBMITTER_Button_Reject_OnClick = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_SUBMITTER; //Compatibility
//End V_SUBMITTER_Button_Reject_OnClick
...
// -------------------------
	...
	if(empty($btn_call)){
		...
		$s = "begin " 
		. "pack_workflow_mpd.reject_engine("
		. $o_submitter_id.", "
		. $ais_create_doc.", "
		. $ais_manual.", "
		. $auser_id_doc.", "
...
//Close V_SUBMITTER_Button_Reject_OnClick @144-B9D9CEAA
    return $V_SUBMITTER_Button_Reject_OnClick;
}
//End Close V_SUBMITTER_Button_Reject_OnClick

//V_SUBMITTER_Button_Back_OnClick @147-8C5D7843
function V_SUBMITTER_Button_Back_OnClick(& $sender)
{
    $V_SUBMITTER_Button_Back_OnClick = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $V_SUBMITTER; //Compatibility
//End V_SUBMITTER_Button_Back_OnClick
...
//Close V_SUBMITTER_Button_Back_OnClick @147-8D710DBF
    return $V_SUBMITTER_Button_Back_OnClick;
}
//End Close V_SUBMITTER_Button_Back_OnClick
