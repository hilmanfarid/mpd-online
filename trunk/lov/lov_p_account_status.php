<?php
//Include Common Files @1-D67ED92C
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_account_status.php");
...
//Class_Initialize Event @2-C7DE9C91
    function clsGridLOV_PAJAK($RelativePath, & $Parent)
    {
        ...
        $this->p_account_status_id = & new clsControl(ccsTextBox, "p_account_status_id", "p_account_status_id", ccsText, "", CCGetRequestParam("p_account_status_id", ccsGet, NULL), $this);
        $this->p_account_status_id->Visible = false;
...
//DataSource Variables @2-609BC780
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E6C10773
...
//Operation Method @3-F8CDADC4
    function Operation()
    {
        ...
        $Redirect = "lov_p_account_status.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_account_status.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_account_status.html";
$BlockToParse = "main";
...
//Include events file @1-C98CF9EB
include_once("./lov_p_account_status_events.php");
