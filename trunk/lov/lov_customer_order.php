<?php
//Include Common Files @1-307FEB9C
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_customer_order.php");
...
//Class_Initialize Event @2-95933DE0
    function clsGridLOV_ORDER($RelativePath, & $Parent)
    {
        ...
        $this->t_customer_order_id = & new clsControl(ccsTextBox, "t_customer_order_id", "t_customer_order_id", ccsText, "", CCGetRequestParam("t_customer_order_id", ccsGet, NULL), $this);
        $this->t_customer_order_id->Visible = false;
...
//DataSource Variables @2-CCDF94A1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-11887368
...
//Open Method @2-2CC5CF4C
    function Open()
    {
        ...
        $this->SQL = "SELECT * \n\n" .
        "FROM t_customer_order {SQL_Where} {SQL_OrderBy}";
...
//Operation Method @3-C4E1BE69
    function Operation()
    {
        ...
        $Redirect = "lov_customer_order.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_customer_order.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_customer_order.html";
$BlockToParse = "main";
...
//Include events file @1-9889F937
include_once("./lov_customer_order_events.php");
