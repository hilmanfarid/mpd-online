<?php
//Include Common Files @1-03FD7808
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_bphtb.php");
...
//Class_Initialize Event @2-D282E74F
...
//DataSource Variables @2-E91F7304
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-0CE662BD
...
//Operation Method @3-EB0EC35A
    function Operation()
    {
        ...
        $Redirect = "lov_bphtb.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_bphtb.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_bphtb.html";
$BlockToParse = "main";
...
//Include events file @1-F9DD9193
include_once("./lov_bphtb_events.php");
