<?php
//Include Common Files @1-6FA6D5FC
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_user.php");
...
//Class_Initialize Event @2-F6BFA514
...
//DataSource Variables @2-51B79C80
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-CAD0DC53
...
//Open Method @2-17954D12
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT DISTINCT owner\n" .
        "FROM user_objects \n" .
        "WHERE upper(object_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT DISTINCT owner\n" .
        "FROM user_objects \n" .
        "WHERE upper(object_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')";
...
//Operation Method @3-DC5CB9B1
    function Operation()
    {
        ...
        $Redirect = "lov_user.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_user.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_user.html";
$BlockToParse = "main";
...
//Include events file @1-B41E1F6D
include_once("./lov_user_events.php");
