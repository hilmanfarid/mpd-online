...
">
			<Components>
				...
				<TextBox id="27" visible="No" fieldSourceType="DBColumn" dataType="Text" name="p_account_status_id" PathID="LOV_PAJAKp_account_status_id" fieldSource="p_account_status_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="lov_p_account_status_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="lov_p_account_status.php" forShow="True" url="lov_p_account_status.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
