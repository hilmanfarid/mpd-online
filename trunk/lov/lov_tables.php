<?php
//Include Common Files @1-998E6044
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_tables.php");
...
//Class_Initialize Event @2-5A864ACB
...
//DataSource Variables @2-327ADCC3
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2E972802
...
//Open Method @2-926F5E60
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * \n" .
        "FROM user_tables \n" .
        "WHERE upper(table_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * \n" .
        "FROM user_tables \n" .
        "WHERE upper(table_name) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')";
...
//Operation Method @3-1BFF13B2
    function Operation()
    {
        ...
        $Redirect = "lov_tables.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_tables.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_tables.html";
$BlockToParse = "main";
...
//Include events file @1-12A108CF
include_once("./lov_tables_events.php");
