<?php
//Include Common Files @1-94C7A551
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_region_kec.php");
...
//Show Method @2-0E1C7344
    function Show()
    {
        ...
        $this->DataSource->Parameters["expr38"] = 5;
...
//Prepare Method @2-A8E9D345
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "expr38", ccsFloat, "", "", $this->Parameters["expr38"], "", false);
        $this->wp->AddParameter("2", "urls_keyword", ccsText, "", "", $this->Parameters["urls_keyword"], "", false);
        $this->wp->AddParameter("3", "urls_keyword", ccsText, "", "", $this->Parameters["urls_keyword"], "", false);
        $this->wp->AddParameter("4", "urlp_region_id", ccsFloat, "", "", $this->Parameters["urlp_region_id"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "upper(region_name)", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        ...
        $this->wp->Criterion[4] = $this->wp->Operation(opEqual, "parent_id", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsFloat),false);
...
//Class_Initialize Event @3-1B55EE23
...
//Operation Method @3-0F6258AD
    function Operation()
    {
        ...
        $Redirect = "lov_region_kec.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_region_kec.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_region_kec.html";
$BlockToParse = "main";
...
//Include events file @1-15ED5447
include_once("./lov_region_kec_events.php");
