...
//End Custom Code
  ...
  // -------------------------
	...
	$p_vat_type_dtl_cls_id = $LOV_ORDER->p_vat_type_dtl_id->GetValue();
	/*$p_vat_type_dtl_cls_id = $LOV_ORDER->p_vat_type_dtl_cls_id->GetValue();*/

	//$nilai = "$t_cust_account_id#~#$npwd#~#$company_name#~#$p_vat_type_id#~#$vat_code#~#$p_vat_type_dtl_id#~#$vat_code_dtl";
	$p_vat_type_dtl_cls_id = $LOV_ORDER->p_vat_type_dtl_cls_id->GetValue();
	$vat_code = $LOV_ORDER->vat_code->GetValue();
	$vat_pct = $LOV_ORDER->vat_pct->GetValue();
	$nilai = "$p_vat_type_dtl_cls_id#~#$vat_code#~#$vat_pct";
