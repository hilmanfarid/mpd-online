<?php
//Include Common Files @1-71F2358B
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_vat_type.php");
...
//Class_Initialize Event @2-51C6CD69
    function clsGridLOV_PAJAK($RelativePath, & $Parent)
    {
        ...
        $this->p_vat_type_id = & new clsControl(ccsTextBox, "p_vat_type_id", "p_vat_type_id", ccsText, "", CCGetRequestParam("p_vat_type_id", ccsGet, NULL), $this);
...
//DataSource Variables @2-BC5BD10C
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F274A224
...
//Open Method @2-925FA999
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select p_vat_type_id, vat_code, description \n" .
        "from p_vat_type\n" .
        "where upper(vat_code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') cnt";
        $this->SQL = "select p_vat_type_id, vat_code, description \n" .
        "from p_vat_type\n" .
...
//Operation Method @3-36F00BFE
    function Operation()
    {
        ...
        $Redirect = "lov_vat_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_vat_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_vat_type.html";
$BlockToParse = "main";
...
//Include events file @1-6D9731BC
include_once("./lov_vat_type_events.php");
