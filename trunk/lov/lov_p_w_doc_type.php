<?php
//Include Common Files @1-C1C40FD1
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_w_doc_type.php");
...
//Class_Initialize Event @2-42A525A5
    function clsGridLovGrid($RelativePath, & $Parent)
    {
        ...
        $this->p_document_type_id = & new clsControl(ccsHidden, "p_document_type_id", "p_document_type_id", ccsText, "", CCGetRequestParam("p_document_type_id", ccsGet, NULL), $this);
...
//DataSource Variables @2-79929BC1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-EA47FF9B
    function clsLovGridDataSource(& $Parent)
    {
        ...
        $this->p_document_type_id = new clsField("p_document_type_id", ccsText, "");
...
//Prepare Method @2-220A9D5E
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "upper(display_name)", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "upper(tdoc)", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "upper(tctl)", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opContains, "upper(package_name)", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
...
//SetValues Method @2-3D748C18
    function SetValues()
    {
        ...
        $this->p_document_type_id->SetDBValue($this->f("p_document_type_id"));
    }
...
//Operation Method @3-3F00B4B4
    function Operation()
    {
        ...
        $Redirect = "lov_p_w_doc_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_w_doc_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_w_doc_type.html";
$BlockToParse = "main";
...
//Include events file @1-0D0F0A95
include_once("./lov_p_w_doc_type_events.php");
