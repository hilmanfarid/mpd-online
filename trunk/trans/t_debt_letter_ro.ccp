...
decode({p_hotel_grade_id},0,null,{p_hotel_grade_id}), decode({p_rest_service_type_id},0,null,{p_rest_service_type_id}), decode({p_entertaintment_type_id},0,null,{p_entertaintment_type_id}), decode({p_parking_classification_id},0,null,{p_parking_classification_id}))" activeTableType="customDelete">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_debt_letter_ro_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_debt_letter_ro.php" forShow="True" url="t_debt_letter_ro.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
