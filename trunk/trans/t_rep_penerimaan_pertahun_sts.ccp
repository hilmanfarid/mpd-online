	...
	<Components>
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_rep_penerimaan_pertahunSearch" returnPage="t_rep_penerimaan_pertahun_sts.ccp" PathID="t_rep_penerimaan_pertahunSearch" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<TextBox id="566" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="periode_piutang_start" PathID="t_rep_penerimaan_pertahunSearchperiode_piutang_start" format="dd-mm-yyyy" fieldSource="periode_piutang_start">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Button id="570" urlType="Relative" enableValidation="True" isDefault="False" name="Button_DoSearch1" PathID="t_rep_penerimaan_pertahunSearchButton_DoSearch1">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_rep_penerimaan_pertahun_sts_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_rep_penerimaan_pertahun_sts.php" forShow="True" url="t_rep_penerimaan_pertahun_sts.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
