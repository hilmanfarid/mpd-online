<?php
//Include Common Files @1-DB41DD9F
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "inquery_cek_pembayaran_bphtb.php");
...
//Class_Initialize Event @3-1595E21C
...
//Operation Method @3-325B9326
    function Operation()
    {
        ...
        $Redirect = "inquery_cek_pembayaran_bphtb.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "inquery_cek_pembayaran_bphtb.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "inquery_cek_pembayaran_bphtb.html";
$BlockToParse = "main";
...
//Include events file @1-AE00E9A9
include_once("./inquery_cek_pembayaran_bphtb_events.php");
