<?php
//Include Common Files @1-4D5E2292
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_sptpd_legal_doc_ro.php");
...
//Class_Initialize Event @2-85B70938
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_sptpd_legal_doc_ro.php";
        ...
        $this->Insert_Link->Page = "t_sptpd_legal_doc_ro.php";
...
//Operation Method @3-E97876F7
    function Operation()
    {
        ...
        $Redirect = "t_sptpd_legal_doc_ro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_sptpd_legal_doc_ro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_sptpd_legal_doc_ro.html";
$BlockToParse = "main";
...
//Include events file @1-6C036EFB
include_once("./t_sptpd_legal_doc_ro_events.php");
