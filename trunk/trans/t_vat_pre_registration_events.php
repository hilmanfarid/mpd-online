...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->t_vat_pre_registration_id->GetValue();
        $t_ppatForm->DataSource->Parameters["urlt_vat_pre_registration_id"] = $selected_id;
...
// End Bdr  
  	...
  	// Start Bdr    
        ...
        if ($Component->DataSource->t_vat_pre_registration_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-B5614F61
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_vat_pre_registration; //Compatibility
...
//End Custom Code
  ...
  // -------------------------
      // Write your own code here.
  	  global $selected_id;
        $selected_id = -1;
        $selected_id=CCGetFromGet("t_vat_pre_registration_id", $selected_id);
  // -------------------------
