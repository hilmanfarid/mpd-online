<?php
//Include Common Files @1-EFFAB8E4
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_srt.php");
...
//Class_Initialize Event @2-E3FC4296
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_srt.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_srt.php";
...
//Operation Method @3-9D2A6B9F
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_srt.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_srt.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_srt.html";
$BlockToParse = "main";
...
//Include events file @1-399022AF
include_once("./t_cust_order_legal_doc_ro_srt_events.php");
