<?php
//Include Common Files @1-BC5302FF
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis2.php");
...
//Operation Method @3-B7D8CEA5
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis2.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis2.html";
$BlockToParse = "main";
...
//Include events file @1-FF2C498B
include_once("./t_order_log_kronologis2_events.php");
