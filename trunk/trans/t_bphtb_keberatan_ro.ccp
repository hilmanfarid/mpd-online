...
{t_cust_acc_status_modif_id}" activeTableType="customDelete" dataSource="SELECT wp_name,njop_pbb,bphtb_amt_final_sebelumnya,bphtb_amt_final_keberatan,
...
WHERE a.t_customer_order_id = {CURR_DOC_ID} ">
			<Components>
				...
				<TextBox id="5" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="njop_pbb" wizardCaption="Keyword" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" PathID="t_vat_registrationFormnjop_pbb" required="True" caption="NOP" fieldSource="njop_pbb">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
<Hidden id="158" fieldSourceType="DBColumn" dataType="Float" name="t_bphtb_registration_id" PathID="t_vat_registrationFormt_bphtb_registration_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
<TextBox id="166" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="wp_name" caption="Nama WP" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_vat_registrationFormwp_name" fieldSource="wp_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
<TextBox id="180" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="bphtb_amt_final_sebelumnya" caption="Nilai pajak sebelumnya" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_vat_registrationFormbphtb_amt_final_sebelumnya" fieldSource="bphtb_amt_final_sebelumnya" format="#,##0.00">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
<TextBox id="167" visible="Yes" fieldSourceType="DBColumn" dataType="Float" name="bphtb_amt_final_keberatan" wizardCaption="Keyword" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" PathID="t_vat_registrationFormbphtb_amt_final_keberatan" required="True" caption="nilai pajak yang diajukan" fieldSource="bphtb_amt_final_keberatan" format="#,##0.00">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
<TextBox id="179" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="alasan" fieldSource="alasan" wizardCaption="Created By" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_vat_registrationFormalasan" required="False" caption="keterangan alasan penutupan">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_keberatan_ro_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_keberatan_ro.php" forShow="True" url="t_bphtb_keberatan_ro.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
