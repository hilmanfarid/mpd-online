...
decode({p_hotel_grade_id},0,null,{p_hotel_grade_id}), decode({p_rest_service_type_id},0,null,{p_rest_service_type_id}), decode({p_entertaintment_type_id},0,null,{p_entertaintment_type_id}), decode({p_parking_classification_id},0,null,{p_parking_classification_id}))" activeTableType="customDelete">
			<Components>
				...
				<Hidden id="631" fieldSourceType="DBColumn" dataType="Float" name="p_region_id_owner" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_vat_registrationFormp_region_id_owner" fieldSource="p_region_id_owner" caption="p_order_status_id" defaultValue="749">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_registration_ro_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_vat_registration_ro.php" forShow="True" url="t_vat_registration_ro.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
