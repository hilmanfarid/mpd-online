<?php
//Include Common Files @1-2BB1876F
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl.php");
...
//Class_Initialize Event @2-DBBF7CA9
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl.php";
...
//Operation Method @3-BC78176C
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-6846ECDA
...
//Class_Initialize Event @790-50C64A65
...
//Class_Initialize Event @814-72575E32
...
//Class_Initialize Event @838-F1A77D9A
...
//Class_Initialize Event @862-A7AF368B
...
//Class_Initialize Event @896-CB47C9F7
...
//Class_Initialize Event @915-DA805E93
    function clsGridt_vat_reg_dtl_hotel_srvcGrid($RelativePath, & $Parent)
    {
        ...
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->Insert_Link2 = & new clsControl(ccsLink, "Insert_Link2", "Insert_Link2", ccsText, "", CCGetRequestParam("Insert_Link2", ccsGet, NULL), $this);
        $this->Insert_Link2->Parameters = CCGetQueryString("QueryString", array("t_vat_reg_dtl_hotel_srvc_id", "s_keyword", "ccsForm"));
        $this->Insert_Link2->Page = "";
    }
//End Class_Initialize Event
...
class clsGridt_vat_reg_employeeGrid { //t_vat_reg_employeeGrid class @936-B79C6852

//Variables @936-AC1EDBB9
...
//Class_Initialize Event @936-CD180E51
    function clsGridt_vat_reg_employeeGrid($RelativePath, & $Parent)
    {
        ...
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->Insert_Link1 = & new clsControl(ccsLink, "Insert_Link1", "Insert_Link1", ccsText, "", CCGetRequestParam("Insert_Link1", ccsGet, NULL), $this);
        $this->Insert_Link1->Parameters = CCGetQueryString("QueryString", array("t_vat_reg_employee_id", "s_keyword", "ccsForm"));
        $this->Insert_Link1->Page = "";
    }
//End Class_Initialize Event

//Initialize Method @936-90E704C5
    function Initialize()
    {
        if(!$this->Visible) return;
...
} //End t_vat_reg_employeeGrid Class @936-FCB6E20C

class clst_vat_reg_employeeGridDataSource extends clsDBConnSIKP {  //t_vat_reg_employeeGridDataSource Class @936-785B9916

//DataSource Variables @936-BC7AECF5
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @936-928FD6F7
...
} //End t_vat_reg_employeeGridDataSource Class @936-FCB6E20C

//Initialize Page @1-8618FBB7
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl.html";
$BlockToParse = "main";
...
//Include events file @1-DEECBD76
include_once("./t_vat_reg_dtl_events.php");
