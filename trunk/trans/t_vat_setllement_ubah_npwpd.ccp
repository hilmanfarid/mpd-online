<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" validateRequest="True" cachingDuration="1 minutes" wizardTheme="sikm" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="LOV" returnPage="t_vat_setllement_ubah_npwpd.ccp" PathID="LOV" connection="ConnSIKP" pasteActions="pasteActions" parameterTypeListName="ParameterTypeList" activeCollection="ISQLParameters" customInsertType="SQL" customInsert="SELECT f_update_npwpd({t_vat_setllement_id},'{npwpd}','{deskripsi}', '{user_name}') AS msg" dataSource="t_vat_setllement">
			<Components>
				<TextBox id="5" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="npwpd" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOVnpwpd" fieldSource="npwpd" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextArea id="6" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="deskripsi" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="LOVdeskripsi" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="19" variable="npwpd" parameterType="Control" defaultValue="0" dataType="Text" parameterSource="npwpd"/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_setllement_ubah_npwpd_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_vat_setllement_ubah_npwpd.php" forShow="True" url="t_vat_setllement_ubah_npwpd.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
