<?php
//Include Common Files @1-FC9B94EC
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_list.php");
...
//Open Method @2-E289FD52
    function Open()
    {
        ...
        "AND regis.p_bphtb_type_id = 1) cnt";
        ...
        "regis.wp_name ILIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') \n" .
        "AND cust_order.p_order_status_id = 1\n" .
        "AND regis.p_bphtb_type_id = 1{SQL_OrderBy}";
...
//Operation Method @3-F940B2C6
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_list.html";
$BlockToParse = "main";
...
//Include events file @1-ACE84466
include_once("./t_bphtb_registration_list_events.php");
