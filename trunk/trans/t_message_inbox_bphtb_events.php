...
//End Custom Code
  	...
  	// Start Bdr    
        ...
        $Style = $styles[0];
        if ($Component->DataSource->t_message_inbox_bphtb_id->GetValue()== $selected_id) {
...
//End Custom Code
  ...
  // -------------------------
      // Write your own code here.
	$t_message_inbox_id = $t_message_inboxForm->t_message_inbox_bphtb_id->GetValue();
	if(empty($t_message_inbox_id)){
...
//Page_OnInitializeView @1-E619B457
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_message_inbox_bphtb; //Compatibility
