<?php
//Include Common Files @1-AAFA9BB1
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis_srt.php");
...
//Operation Method @3-B9711ACA
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis_srt.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis_srt.html";
$BlockToParse = "main";
...
//Include events file @1-1EB82491
include_once("./t_order_log_kronologis_srt_events.php");
