<?php
//Include Common Files @1-5D3DEB67
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_customer_order_ro_kasi.php");
...
//Class_Initialize Event @629-1DF419B5
    function clsRecordt_vat_registrationForm($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->company_additional_addr = & new clsControl(ccsTextArea, "company_additional_addr", "Alamat Lokasi Usaha", ccsText, "", CCGetRequestParam("company_additional_addr", $Method, NULL), $this);
...
"FROM p_parking_classification {SQL_Where} {SQL_OrderBy}";
            ...
            $this->reg_letter_no = & new clsControl(ccsTextBox, "reg_letter_no", "Input Nomor Surat", ccsText, "", CCGetRequestParam("reg_letter_no", $Method, NULL), $this);
            $this->Button3 = & new clsButton("Button3", $Method, $this);
            $this->npwpd = & new clsControl(ccsTextBox, "npwpd", "NPWD", ccsText, "", CCGetRequestParam("npwpd", $Method, NULL), $this);
            ...
            $this->brand_address_rt1 = & new clsControl(ccsTextBox, "brand_address_rt1", "Rt - Usaha", ccsText, "", CCGetRequestParam("brand_address_rt1", $Method, NULL), $this);
...
//Validate Method @629-6DDE1548
    function Validate()
    {
        ...
        $Validation = ($this->reg_letter_no->Validate() && $Validation);
        ...
        $Validation = ($this->brand_address_rt1->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->reg_letter_no->Errors->Count() == 0);
        ...
        $Validation =  $Validation && ($this->brand_address_rt1->Errors->Count() == 0);
...
//CheckErrors Method @629-497E93BD
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->reg_letter_no->Errors->Count());
        ...
        $errors = ($errors || $this->brand_address_rt1->Errors->Count());
...
//UpdateRow Method @629-CB0A0418
    function UpdateRow()
    {
        ...
        $this->DataSource->t_vat_registration_id->SetValue($this->t_vat_registration_id->GetValue(true));
        $this->DataSource->t_customer_order_id->SetValue($this->t_customer_order_id->GetValue(true));
        $this->DataSource->reg_letter_no->SetValue($this->reg_letter_no->GetValue(true));
...
//Show Method @629-49EC1D2E
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->reg_letter_no->SetValue($this->DataSource->reg_letter_no->GetValue());
                    ...
                    $this->brand_address_rt1->SetValue($this->DataSource->brand_address_rt1->GetValue());
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->reg_letter_no->Errors->ToString());
            ...
            $Error = ComposeStrings($Error, $this->brand_address_rt1->Errors->ToString());
...
//DataSource Variables @629-E471E016
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @629-260190C8
    function clst_vat_registrationFormDataSource(& $Parent)
    {
        ...
        $this->reg_letter_no = new clsField("reg_letter_no", ccsText, "");
        ...
        $this->brand_address_rt1 = new clsField("brand_address_rt1", ccsText, "");
...
//SetValues Method @629-DA8A442C
    function SetValues()
    {
        ...
        $this->reg_letter_no->SetDBValue($this->f("reg_letter_no"));
        $this->npwpd->SetDBValue($this->f("npwpd"));
        $this->Hidden1->SetDBValue($this->f("npwpd"));
        $this->Hidden2->SetDBValue($this->f("reg_letter_no"));
        ...
        $this->brand_address_rt1->SetDBValue($this->f("brand_address_rt"));
...
//Update Method @629-999E31C6
    function Update()
    {
        ...
        $this->cp["reg_letter_no"] = new clsSQLParameter("ctrlreg_letter_no", ccsText, "", "", $this->reg_letter_no->GetValue(true), "", false, $this->ErrorBlock);
        ...
        if (!is_null($this->cp["reg_letter_no"]->GetValue()) and !strlen($this->cp["reg_letter_no"]->GetText()) and !is_bool($this->cp["reg_letter_no"]->GetValue())) 
            $this->cp["reg_letter_no"]->SetValue($this->reg_letter_no->GetValue(true));
        ...
        "reg_letter_no = '" . $this->SQLValue($this->cp["reg_letter_no"]->GetDBValue(), ccsText) . "',\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_customer_order_ro_kasi.html";
$BlockToParse = "main";
...
//Include events file @1-507EACD7
include_once("./t_customer_order_ro_kasi_events.php");
