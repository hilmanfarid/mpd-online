<?php
//Include Common Files @1-067F8987
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl_ro_ver.php");
...
//Class_Initialize Event @2-077D3CFA
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl_ro_ver.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl_ro_ver.php";
...
//Operation Method @3-7A8B882F
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl_ro_ver.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl_ro_ver.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-331F92EE
...
//Class_Initialize Event @790-2FAB7723
...
//Class_Initialize Event @814-CCEFAFBC
...
//Class_Initialize Event @838-C083C28A
...
//Class_Initialize Event @862-EED80FFF
...
//Class_Initialize Event @896-8346E89C
...
//Class_Initialize Event @915-1DBBBACE
...
//Class_Initialize Event @952-65F91628
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl_ro_ver.html";
$BlockToParse = "main";
...
//Include events file @1-B34348E5
include_once("./t_vat_reg_dtl_ro_ver_events.php");
