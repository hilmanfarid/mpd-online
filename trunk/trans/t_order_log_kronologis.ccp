...
<Hidden id="328" fieldSourceType="DBColumn" dataType="Float" name="t_vat_registration_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_order_log_kronologisSearcht_vat_registration_id">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_order_log_kronologis_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_order_log_kronologis.php" forShow="True" url="t_order_log_kronologis.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
