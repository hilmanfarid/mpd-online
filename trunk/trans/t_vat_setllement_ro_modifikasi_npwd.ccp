...
ORDER BY d.wp_name ASC, b.start_date DESC" parameterTypeListName="ParameterTypeList">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_vat_setllement_ro_modifikasi_npwd.ccp" wizardThemeItem="GridA" PathID="t_vat_setllementGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Button id="311" urlType="Relative" enableValidation="True" isDefault="False" name="BtnUbahNPWD" PathID="t_vat_setllementGridBtnUbahNPWD">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="320" urlType="Relative" enableValidation="True" isDefault="False" name="BtnUbahMasaPajak" PathID="t_vat_setllementGridBtnUbahMasaPajak">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="312" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="searchForm" returnPage="t_vat_setllement_ro_modifikasi_npwd.ccp" PathID="searchForm" connection="ConnSIKP">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_setllement_ro_modifikasi_npwd_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_vat_setllement_ro_modifikasi_npwd.php" forShow="True" url="t_vat_setllement_ro_modifikasi_npwd.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
