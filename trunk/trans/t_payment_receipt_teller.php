<?php
//Include Common Files @1-6B5CB598
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_payment_receipt_teller.php");
...
//Class_Initialize Event @2-8A5F9CD3
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_payment_receipt_teller.php";
        ...
        $this->payment_vat_amount = & new clsControl(ccsLabel, "payment_vat_amount", "payment_vat_amount", ccsFloat, array(True, 0, Null, Null, False, array("#", "#", "#"), "", 1, True, ""), CCGetRequestParam("payment_vat_amount", ccsGet, NULL), $this);
        ...
        $this->payment_date = & new clsControl(ccsLabel, "payment_date", "payment_date", ccsText, "", CCGetRequestParam("payment_date", ccsGet, NULL), $this);
        $this->p_cg_terminal_id = & new clsControl(ccsLabel, "p_cg_terminal_id", "p_cg_terminal_id", ccsText, "", CCGetRequestParam("p_cg_terminal_id", ccsGet, NULL), $this);
        $this->ayat_pajak = & new clsControl(ccsLabel, "ayat_pajak", "ayat_pajak", ccsText, "", CCGetRequestParam("ayat_pajak", ccsGet, NULL), $this);
        $this->t_payment_receipt_id = & new clsControl(ccsHidden, "t_payment_receipt_id", "t_payment_receipt_id", ccsFloat, "", CCGetRequestParam("t_payment_receipt_id", ccsGet, NULL), $this);
...
//Show Method @2-469B4927
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["payment_date"] = $this->payment_date->Visible;
            $this->ControlsVisible["p_cg_terminal_id"] = $this->p_cg_terminal_id->Visible;
            $this->ControlsVisible["ayat_pajak"] = $this->ayat_pajak->Visible;
            $this->ControlsVisible["t_payment_receipt_id"] = $this->t_payment_receipt_id->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->DLink->Parameters = CCAddParam($this->DLink->Parameters, "t_payment_receipt_id", $this->DataSource->f("t_payment_receipt_id"));
                ...
                $this->ayat_pajak->SetValue($this->DataSource->ayat_pajak->GetValue());
                $this->t_payment_receipt_id->SetValue($this->DataSource->t_payment_receipt_id->GetValue());
                ...
                $this->ayat_pajak->Show();
                $this->t_payment_receipt_id->Show();
                $Tpl->block_path = $ParentPath . "/" . $GridBlock;
                $Tpl->parse("Row", true);
            }
        }
...
//GetErrors Method @2-AD37F52D
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->payment_date->Errors->ToString());
        $errors = ComposeStrings($errors, $this->p_cg_terminal_id->Errors->ToString());
        $errors = ComposeStrings($errors, $this->ayat_pajak->Errors->ToString());
        $errors = ComposeStrings($errors, $this->t_payment_receipt_id->Errors->ToString());
...
//DataSource Variables @2-4EE60C2F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $ayat_pajak;
    var $t_payment_receipt_id;
//End DataSource Variables

//DataSourceClass_Initialize Event @2-1695C26F
    function clst_vat_setllementGridDataSource(& $Parent)
    {
        ...
        $this->p_cg_terminal_id = new clsField("p_cg_terminal_id", ccsText, "");
        
        $this->ayat_pajak = new clsField("ayat_pajak", ccsText, "");
        
        $this->t_payment_receipt_id = new clsField("t_payment_receipt_id", ccsFloat, "");
        

    }
//End DataSourceClass_Initialize Event

//SetOrder Method @2-12E6A6A2
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "f.payment_date DESC";
...
//Open Method @2-F27E5FF5
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT f.t_payment_receipt_id, f.p_cg_terminal_id, f.npwd, d.wp_name, f.receipt_no, f.payment_date, a.no_kohir, f.finance_period_code, f.payment_vat_amount,\n" .
        ...
        "( upper(f.p_cg_terminal_id) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")) cnt";
        $this->SQL = "SELECT f.t_payment_receipt_id, f.p_cg_terminal_id, f.npwd, d.wp_name, f.receipt_no, f.payment_date, a.no_kohir, f.finance_period_code, f.payment_vat_amount,\n" .
        "c.vat_code as ayat_pajak\n" .
        "FROM t_payment_receipt f, t_vat_setllement a, p_vat_type_dtl c, t_cust_account d\n" .
        "WHERE \n" .
        "f.t_vat_setllement_id = a.t_vat_setllement_id AND\n" .
...
//SetValues Method @2-5EC23D79
    function SetValues()
    {
        ...
        $this->ayat_pajak->SetDBValue($this->f("ayat_pajak"));
        $this->t_payment_receipt_id->SetDBValue(trim($this->f("t_payment_receipt_id")));
    }
...
//Operation Method @3-7CC6185F
    function Operation()
    {
        ...
        $Redirect = "t_payment_receipt_teller.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_payment_receipt_teller.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_payment_receipt_teller.html";
$BlockToParse = "main";
...
//Include events file @1-03FF8DFF
include_once("./t_payment_receipt_teller_events.php");
