...
regis.wp_name ILIKE '%{s_keyword}%' OR
regis.registration_no ILIKE '%{s_keyword}%')
order by regis.t_bphtb_registration_id DESC">
			<Components>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" hrefSource="t_bphtb_registration_list_update_master_sudah_bayar.ccp" removeParameters="FLAG" PathID="t_bphtb_registration_listDLink">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Hidden id="704" fieldSourceType="DBColumn" dataType="Text" html="False" name="registration_no" fieldSource="registration_no" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_bphtb_registration_listregistration_no">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_bphtb_registration_list_update_master_sudah_bayar_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_bphtb_registration_list_update_master_sudah_bayar.php" forShow="True" url="t_bphtb_registration_list_update_master_sudah_bayar.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
