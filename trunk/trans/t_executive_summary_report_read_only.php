<?php
//Include Common Files @1-1169413B
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_executive_summary_report_read_only.php");
...
//Operation Method @2-5598BE18
    function Operation()
    {
        ...
        $Redirect = "t_executive_summary_report_read_only.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_executive_summary_report_read_only.html";
$BlockToParse = "main";
...
//Include events file @1-B7208E3D
include_once("./t_executive_summary_report_read_only_events.php");
