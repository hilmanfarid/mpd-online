<?php
//Include Common Files @1-3836E0DD
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_bpps_terakhir_bayar.php");
...
//Class_Initialize Event @3-E9D59012
...
//Operation Method @3-A5C91477
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_bpps_terakhir_bayar.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_bpps_terakhir_bayar.html";
$BlockToParse = "main";
...
//Include events file @1-3AA2D8E9
include_once("./t_rep_lap_bpps_terakhir_bayar_events.php");
