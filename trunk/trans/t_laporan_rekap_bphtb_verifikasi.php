<?php
//Include Common Files @1-33569DD6
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_rekap_bphtb_verifikasi.php");
...
//Operation Method @2-2B7F9196
    function Operation()
    {
        ...
        $Redirect = "t_laporan_rekap_bphtb_verifikasi.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_rekap_bphtb_verifikasi.html";
$BlockToParse = "main";
...
//Include events file @1-77B7555E
include_once("./t_laporan_rekap_bphtb_verifikasi_events.php");
