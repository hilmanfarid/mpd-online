<?php
//Include Common Files @1-3BE68BD0
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis_ver_penutupan.php");
...
//Operation Method @3-25BE9EBB
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis_ver_penutupan.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis_ver_penutupan.html";
$BlockToParse = "main";
...
//Include events file @1-3835736C
include_once("./t_order_log_kronologis_ver_penutupan_events.php");
