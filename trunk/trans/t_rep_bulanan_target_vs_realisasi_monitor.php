<?php
//Include Common Files @1-8690D394
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_bulanan_target_vs_realisasi_monitor.php");
...
//Operation Method @3-14DCBA63
    function Operation()
    {
        ...
        $Redirect = "t_rep_bulanan_target_vs_realisasi_monitor.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_bulanan_target_vs_realisasi_monitor.html";
$BlockToParse = "main";
...
//Include events file @1-497516C8
include_once("./t_rep_bulanan_target_vs_realisasi_monitor_events.php");
