<?php
//Include Common Files @1-C2DE7C2C
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_sptpd_legal_doc_ro_otobuk.php");
...
//Class_Initialize Event @2-F3958F43
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_sptpd_legal_doc_ro_otobuk.php";
        ...
        $this->Insert_Link->Page = "t_sptpd_legal_doc_ro_otobuk.php";
...
//Operation Method @3-F3D6ECB5
    function Operation()
    {
        ...
        $Redirect = "t_sptpd_legal_doc_ro_otobuk.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_sptpd_legal_doc_ro_otobuk.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_sptpd_legal_doc_ro_otobuk.html";
$BlockToParse = "main";
...
//Include events file @1-FF7E9AC3
include_once("./t_sptpd_legal_doc_ro_otobuk_events.php");
