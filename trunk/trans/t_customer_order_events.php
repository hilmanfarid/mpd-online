...
// -------------------------
	...
	//print kartu npwpd
	file_get_contents("http://172.16.20.1/mpd/report/cetak_kartu_npwpd.php?t_customer_order_id=".$CustId);
	file_get_contents("http://172.16.20.1/mpd/report/cetak_berita_acara_pemeriksaan_pdf.php?t_customer_order_id=".$CustId);
	/*
