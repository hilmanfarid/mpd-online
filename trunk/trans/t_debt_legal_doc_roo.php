<?php
//Include Common Files @1-C56322C8
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_debt_legal_doc_roo.php");
...
//Class_Initialize Event @2-84BEEA3B
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_debt_legal_doc_roo.php";
        ...
        $this->Insert_Link->Page = "t_debt_legal_doc_roo.php";
...
//Class_Initialize Event @3-AAA004BF
...
//Operation Method @3-810486E7
    function Operation()
    {
        ...
        $Redirect = "t_debt_legal_doc_roo.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_debt_legal_doc_roo.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_debt_legal_doc_roo.html";
$BlockToParse = "main";
...
//Include events file @1-326F4854
include_once("./t_debt_legal_doc_roo_events.php");
