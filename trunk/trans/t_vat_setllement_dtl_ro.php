<?php
//Include Common Files @1-1F3970EF
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_dtl_ro.php");
...
//Class_Initialize Event @2-893C5DC2
    function clsGridt_vat_setllement_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_dtl_ro.php";
...
//Operation Method @3-0D3C2EFE
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_dtl_ro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_dtl_ro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_dtl_ro.html";
$BlockToParse = "main";
...
//Include events file @1-FE03D73E
include_once("./t_vat_setllement_dtl_ro_events.php");
