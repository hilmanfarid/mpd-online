<?php
//Include Common Files @1-72400823
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_sptpd_legal_doc.php");
...
//Class_Initialize Event @2-40B36734
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_sptpd_legal_doc.php";
        ...
        $this->Insert_Link->Page = "t_sptpd_legal_doc.php";
...
//Class_Initialize Event @3-58B53028
...
//Operation Method @3-DE648108
    function Operation()
    {
        ...
        $Redirect = "t_sptpd_legal_doc.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_sptpd_legal_doc.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_sptpd_legal_doc.html";
$BlockToParse = "main";
...
//Include events file @1-B30F2846
include_once("./t_sptpd_legal_doc_events.php");
