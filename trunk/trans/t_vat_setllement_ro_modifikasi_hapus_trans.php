<?php
//Include Common Files @1-C80921B6
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ro_modifikasi_hapus_trans.php");
...
//Class_Initialize Event @2-AA9F1422
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_ro_modifikasi_hapus_trans.php";
...
//Operation Method @3-48DDF1AC
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ro_modifikasi_hapus_trans.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_ro_modifikasi_hapus_trans.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ro_modifikasi_hapus_trans.html";
$BlockToParse = "main";
...
//Include events file @1-ED6EFE9C
include_once("./t_vat_setllement_ro_modifikasi_hapus_trans_events.php");
