<?php
//Include Common Files @1-E42A2599
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_debt_letter_view_excel.php");
...
//Operation Method @3-0A5CE017
    function Operation()
    {
        ...
        $Redirect = "t_debt_letter_view_excel.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_debt_letter_view_excel.html";
$BlockToParse = "main";
...
//Include events file @1-6224274F
include_once("./t_debt_letter_view_excel_events.php");
