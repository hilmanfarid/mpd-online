...
//t_vat_reg_dtl_hotel_srvcGrid_btn_update_BeforeShow @927-C0AB7A5B
...
//Close t_vat_reg_dtl_hotel_srvcGrid_btn_update_BeforeShow @927-060A4A74
...
//t_vat_reg_employeeGrid_btn_update_BeforeShow @950-BC8372B3
...
//Custom Code @951-2A29BDB7
// -------------------------
    // Write your own code here.
	$nilai = $t_vat_reg_employeeGrid->t_vat_reg_employee_id->GetValue();
...
//Close t_vat_reg_employeeGrid_btn_update_BeforeShow @950-3174233E
    return $t_vat_reg_employeeGrid_btn_update_BeforeShow;
}
//End Close t_vat_reg_employeeGrid_btn_update_BeforeShow

//t_vat_reg_employeeGrid_BeforeShowRow @936-2BB77834
...
//Close t_vat_reg_employeeGrid_BeforeShowRow @936-894C7316
    return $t_vat_reg_employeeGrid_BeforeShowRow;
}
//End Close t_vat_reg_employeeGrid_BeforeShowRow

//t_vat_reg_employeeGrid_BeforeSelect @936-E8350169
...
//Close t_vat_reg_employeeGrid_BeforeSelect @936-F6C666B7
    return $t_vat_reg_employeeGrid_BeforeSelect;
}
//End Close t_vat_reg_employeeGrid_BeforeSelect

//Page_BeforeShow @1-9E59E895
function Page_BeforeShow(& $sender)
{
    $Page_BeforeShow = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_vat_reg_dtl; //Compatibility
//End Page_BeforeShow
...
// -------------------------
	...
	if ($id_req == "1"){
		...
		$t_vat_reg_employeeGrid->Visible = true;
