...
WHERE t_customer_order_id = {CURR_DOC_ID} ">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_customer_order_ro_srt_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_customer_order_ro_srt.php" forShow="True" url="t_customer_order_ro_srt.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
