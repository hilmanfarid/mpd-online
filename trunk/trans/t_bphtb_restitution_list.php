...
//Class_Initialize Event @2-0B697676
    function clsGridt_bphtb_registration_list($RelativePath, & $Parent)
    {
        ...
        $this->t_bphtb_registration_id = & new clsControl(ccsLabel, "t_bphtb_registration_id", "t_bphtb_registration_id", ccsFloat, "", CCGetRequestParam("t_bphtb_registration_id", ccsGet, NULL), $this);
        ...
        $this->Button_Add_Resitution = & new clsButton("Button_Add_Resitution", ccsGet, $this);
    }
...
//DataSourceClass_Initialize Event @2-2B9013AE
...
class clsRecordt_cust_order_legal_docSearch1 { //t_cust_order_legal_docSearch1 Class @708-D76FA151

//Variables @708-D6FF3E86
...
//Class_Initialize Event @708-EF5120FE
    function clsRecordt_cust_order_legal_docSearch1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record t_cust_order_legal_docSearch1/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "t_cust_order_legal_docSearch1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
            ...
            $this->FormSubmitted = ($FormName == $this->ComponentName);
            $Method = $this->FormSubmitted ? ccsPost : ccsGet;
            $this->t_bphtb_registration_id = & new clsControl(ccsTextBox, "t_bphtb_registration_id", "t_bphtb_registration_id", ccsFloat, "", CCGetRequestParam("t_bphtb_registration_id", $Method, NULL), $this);
            $this->t_bphtb_registration_listPage = & new clsControl(ccsTextBox, "t_bphtb_registration_listPage", "t_bphtb_registration_listPage", ccsFloat, "", CCGetRequestParam("t_bphtb_registration_listPage", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Validate Method @708-6F5F6261
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//CheckErrors Method @708-00A61F13
    function CheckErrors()
    {
        $errors = false;
...
} //End t_cust_order_legal_docSearch1 Class @708-FCB6E20C
...
$t_cust_order_legal_docSearch1 = & new clsRecordt_cust_order_legal_docSearch1("", $MainPage);
...
$MainPage->t_cust_order_legal_docSearch1 = & $t_cust_order_legal_docSearch1;
...
//Execute Components @1-BAEEFE2E
$t_cust_order_legal_docSearch->Operation();
$t_cust_order_legal_docSearch1->Operation();
//End Execute Components

//Go to destination page @1-9656C699
if($Redirect)
{
    ...
    unset($t_cust_order_legal_docSearch1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-B47FE6B9
$t_bphtb_registration_list->Show();
$t_cust_order_legal_docSearch->Show();
$t_cust_order_legal_docSearch1->Show();
$Tpl->block_path = "";
