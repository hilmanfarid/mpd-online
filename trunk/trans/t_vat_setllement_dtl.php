<?php
//Include Common Files @1-105F6359
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_dtl.php");
...
//Class_Initialize Event @2-B752DBAE
    function clsGridt_vat_setllement_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_dtl.php";
...
//DataSourceClass_Initialize Event @2-8CDBD41E
...
//Class_Initialize Event @3-7501810E
...
//Operation Method @3-D0D27261
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_dtl.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_dtl.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_dtl.html";
$BlockToParse = "main";
...
//Include events file @1-DD6FC027
include_once("./t_vat_setllement_dtl_events.php");
