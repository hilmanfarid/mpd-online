<?php
//Include Common Files @1-B6CDC6C9
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_daftar_bphtb.php");
...
//Operation Method @2-6D6C52BC
    function Operation()
    {
        ...
        $Redirect = "t_laporan_daftar_bphtb.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_daftar_bphtb.html";
$BlockToParse = "main";
...
//Include events file @1-5B2FDA79
include_once("./t_laporan_daftar_bphtb_events.php");
