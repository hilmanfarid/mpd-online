<?php
//Include Common Files @1-A9560650
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_target_realisasi_jenis2.php");
...
//Class_Initialize Event @2-FF2E14CA
    function clsGridt_target_realisasi_jenisGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_target_realisasi_jenis2.php";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_target_realisasi_jenis2.html";
$BlockToParse = "main";
...
//Include events file @1-C40000CD
include_once("./t_target_realisasi_jenis2_events.php");
...
$per_pajak->CallbackParameter = "t_target_realisasi_jenis2per_pajak";
$per_pajak->Title = "Target vs Realisasi Per Jenis Pajak";
$per_pajak->Width = 800;
$per_pajak->Height = 400;
$per_tahun = & new clsFlashChart("per_tahun", $MainPage);
$per_tahun->CallbackParameter = "t_target_realisasi_jenis2per_tahun";
