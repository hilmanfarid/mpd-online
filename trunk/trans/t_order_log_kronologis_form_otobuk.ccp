...
VALUES(
 ...
 '{input_type}')" dataSource="t_order_log_kronologis">
			<Components>
				...
				<Hidden id="326" fieldSourceType="DBColumn" dataType="Float" name="t_cust_account_id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_order_log_kronologisFormt_cust_account_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_order_log_kronologis_form_otobuk_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_order_log_kronologis_form_otobuk.php" forShow="True" url="t_order_log_kronologis_form_otobuk.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
