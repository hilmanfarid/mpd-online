<?php
//Include Common Files @1-3035EBFB
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_account_update_status.php");
...
//Class_Initialize Event @2-5A4DDEB8
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_account_update_status.php";
        ...
        $this->status_wp = & new clsControl(ccsLabel, "status_wp", "status_wp", ccsText, "", CCGetRequestParam("status_wp", ccsGet, NULL), $this);
        ...
        $this->last_satatus_date = & new clsControl(ccsLabel, "last_satatus_date", "last_satatus_date", ccsText, "", CCGetRequestParam("last_satatus_date", ccsGet, NULL), $this);
...
//Show Method @2-55054594
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["status_wp"] = $this->status_wp->Visible;
            $this->ControlsVisible["wp_name"] = $this->wp_name->Visible;
            $this->ControlsVisible["BtnUbahRegister"] = $this->BtnUbahRegister->Visible;
            $this->ControlsVisible["jenis_pajak"] = $this->jenis_pajak->Visible;
            $this->ControlsVisible["last_satatus_date"] = $this->last_satatus_date->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->status_wp->SetValue($this->DataSource->status_wp->GetValue());
...
//GetErrors Method @2-7703F514
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->status_wp->Errors->ToString());
        $errors = ComposeStrings($errors, $this->wp_name->Errors->ToString());
        $errors = ComposeStrings($errors, $this->jenis_pajak->Errors->ToString());
        $errors = ComposeStrings($errors, $this->last_satatus_date->Errors->ToString());
...
//DataSource Variables @2-70105F69
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-EF40C477
    function clst_vat_setllementGridDataSource(& $Parent)
    {
        ...
        $this->status_wp = new clsField("status_wp", ccsText, "");
...
//Operation Method @3-43382768
    function Operation()
    {
        ...
        $Redirect = "t_cust_account_update_status.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_account_update_status.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_account_update_status.html";
$BlockToParse = "main";
...
//Include events file @1-F8F48059
include_once("./t_cust_account_update_status_events.php");
