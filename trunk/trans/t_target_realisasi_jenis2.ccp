...
" orderBy="p_vat_type_id">
	...
	<CodeFiles>
		<CodeFile id="FlashChartXML696" language="PHPTemplates" name="t_target_realisasi_jenis2per_pajak.xml" forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
		<CodeFile id="FlashChartXML764" language="PHPTemplates" name="t_target_realisasi_jenis2per_tahun.xml" forShow="False" comment="&lt;!--" commentEnd="--&gt;" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="t_target_realisasi_jenis2_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_target_realisasi_jenis2.php" forShow="True" url="t_target_realisasi_jenis2.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
