...
function GetCetakGeneralHTML($param_arr) {
	...
	$output = '';
	$output .='<table id="table-piutang" class="grid-table-container" border="0" cellspacing="0" cellpadding="0" width="98%" style="margin-left:10px;margin-right:10px;padding:5px 5px 5px 5px;">
          		<tr>
            		<td valign="top">';
