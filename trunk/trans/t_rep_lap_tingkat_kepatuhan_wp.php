<?php
//Include Common Files @1-2C0D3913
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_lap_tingkat_kepatuhan_wp.php");
...
//Class_Initialize Event @3-76DD4396
...
//Operation Method @3-A2A0A9FD
    function Operation()
    {
        ...
        $Redirect = "t_rep_lap_tingkat_kepatuhan_wp.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_lap_tingkat_kepatuhan_wp.html";
$BlockToParse = "main";
...
//Include events file @1-BF1DD971
include_once("./t_rep_lap_tingkat_kepatuhan_wp_events.php");
