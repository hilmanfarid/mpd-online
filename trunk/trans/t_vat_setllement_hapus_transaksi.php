<?php
//Include Common Files @1-5D2DD8B4
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_hapus_transaksi.php");
...
//Operation Method @3-306FD672
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_hapus_transaksi.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_hapus_transaksi.html";
$BlockToParse = "main";
...
//Include events file @1-69969C0F
include_once("./t_vat_setllement_hapus_transaksi_events.php");
