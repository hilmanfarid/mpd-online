...
// -------------------------
    // Write your own code here.
		...
		$debtId = $t_order_log_kronologisForm->t_debt_letter_id->GetValue();

		$redirectloader = "t_order_log_kronologiss.php?t_customer_order_id=".$cusOrderId
													 ."&t_debt_letter_id=".$debtId
													 ."&TAKEN_CTL=".$takenCtl
													 ."&IS_TAKEN=".$isTaken
...
//Page_OnInitializeView @1-B5CA5D7C
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_debt_log_kronologis_forms; //Compatibility
