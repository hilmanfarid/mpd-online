...
// -------------------------
    // Write your own code here.
		...
		$redirectloader = "t_order_log_kronologis_ver.php?t_customer_order_id=".$cusOrderId
...
//Page_OnInitializeView @1-AF267DFD
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_order_log_kronologis_form_ver; //Compatibility
