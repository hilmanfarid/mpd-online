<?php
//Include Common Files @1-9D70EF25
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_ubah_npwpd.php");
...
//Class_Initialize Event @3-BE59FB36
...
//Operation Method @3-F24FB34A
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_ubah_npwpd.php";
        if($this->Validate()) {
...
//DataSource Variables @3-C692AC29
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-CD68B3F9
...
//Insert Method @3-7F0EDF2B
    function Insert()
    {
        ...
        $this->cp["npwpd"] = new clsSQLParameter("ctrlnpwpd", ccsText, "", "", $this->npwpd->GetValue(true), 0, false, $this->ErrorBlock);
        ...
        if (!strlen($this->cp["npwpd"]->GetText()) and !is_bool($this->cp["npwpd"]->GetValue(true))) 
            $this->cp["npwpd"]->SetText(0);
        ...
        $this->SQL = "SELECT f_update_npwpd(" . $this->SQLValue($this->cp["t_vat_setllement_id"]->GetDBValue(), ccsInteger) . ",'" . $this->SQLValue($this->cp["npwpd"]->GetDBValue(), ccsText) . "','" . $this->SQLValue($this->cp["deskripsi"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["user_name"]->GetDBValue(), ccsText) . "') AS msg";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_ubah_npwpd.html";
$BlockToParse = "main";
...
//Include events file @1-9D6FF605
include_once("./t_vat_setllement_ubah_npwpd_events.php");
