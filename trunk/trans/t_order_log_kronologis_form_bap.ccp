...
VALUES(
 ...
 '{input_type}')" dataSource="t_order_log_kronologis">
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_order_log_kronologis_form_bap_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_order_log_kronologis_form_bap.php" forShow="True" url="t_order_log_kronologis_form_bap.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
