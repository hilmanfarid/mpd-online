<?php
//Include Common Files @1-BF89CA96
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis_npwd.php");
...
//Operation Method @3-7FD67AA3
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis_npwd.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis_npwd.html";
$BlockToParse = "main";
...
//Include events file @1-BDAF4D7E
include_once("./t_order_log_kronologis_npwd_events.php");
