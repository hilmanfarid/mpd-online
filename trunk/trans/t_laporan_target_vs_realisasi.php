<?php
//Include Common Files @1-190D0BD3
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_target_vs_realisasi.php");
...
//Class_Initialize Event @3-9D0245F2
...
//Operation Method @3-DD001C53
    function Operation()
    {
        ...
        $Redirect = "t_laporan_target_vs_realisasi.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_target_vs_realisasi.html";
$BlockToParse = "main";
...
//Include events file @1-F1BD9062
include_once("./t_laporan_target_vs_realisasi_events.php");
