<?php
//Include Common Files @1-1EE0984C
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_delete_list.php");
...
//Operation Method @3-FD7F5F4D
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_delete_list.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_delete_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_delete_list.html";
$BlockToParse = "main";
...
//Include events file @1-E0286AC1
include_once("./t_bphtb_delete_list_events.php");
