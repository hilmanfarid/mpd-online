<?php
//Include Common Files @1-72A750E9
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_ver.php");
...
//Class_Initialize Event @2-822E1201
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_ver.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_ver.php";
...
//Operation Method @3-68FDB62C
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_ver.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_ver.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_ver.html";
$BlockToParse = "main";
...
//Include events file @1-F41ADC3A
include_once("./t_cust_order_legal_doc_ro_ver_events.php");
