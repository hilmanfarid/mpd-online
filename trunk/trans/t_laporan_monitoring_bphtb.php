<?php
//Include Common Files @1-E6436E8B
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_laporan_monitoring_bphtb.php");
...
//Class_Initialize Event @2-ED19CFB3
...
//Operation Method @2-19856321
    function Operation()
    {
        ...
        $Redirect = "t_laporan_monitoring_bphtb.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_laporan_monitoring_bphtb.html";
$BlockToParse = "main";
...
//Include events file @1-59ED6A9F
include_once("./t_laporan_monitoring_bphtb_events.php");
