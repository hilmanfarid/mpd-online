<?php
//Include Common Files @1-5862597D
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_kasi.php");
...
//Class_Initialize Event @2-36662BF5
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_kasi.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_kasi.php";
...
//Operation Method @3-186BCCAF
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_kasi.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_kasi.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_kasi.html";
$BlockToParse = "main";
...
//Include events file @1-20DB7581
include_once("./t_cust_order_legal_doc_ro_kasi_events.php");
