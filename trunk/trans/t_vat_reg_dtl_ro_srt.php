<?php
//Include Common Files @1-9B22618A
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl_ro_srt.php");
...
//Class_Initialize Event @2-0A03B8CD
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl_ro_srt.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl_ro_srt.php";
...
//Operation Method @3-8385A2E6
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl_ro_srt.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl_ro_srt.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-7513BBA4
...
//Class_Initialize Event @790-6B6D5112
...
//Class_Initialize Event @814-75A48E22
...
//Class_Initialize Event @838-F66EA348
...
//Class_Initialize Event @862-7EE97B3F
...
//Class_Initialize Event @896-67C5621B
...
//Class_Initialize Event @915-10C53EF9
...
//Class_Initialize Event @952-6887921F
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl_ro_srt.html";
$BlockToParse = "main";
...
//Include events file @1-7EC9B670
include_once("./t_vat_reg_dtl_ro_srt_events.php");
