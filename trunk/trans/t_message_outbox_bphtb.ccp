<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="CoffeeBreak" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Grid id="2" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_message_outboxGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="SQLParameters" dataSource="SELECT
	outbox.*, to_char(
		outbox.creation_date,
...
where p_app_role_id_to = 17
order by outbox.creation_date DESC" parameterTypeListName="ParameterTypeList">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_message_outbox_bphtb.ccp" wizardThemeItem="GridA" PathID="t_message_outboxGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
						<LinkParameter id="219" sourceType="DataField" name="t_message_inbox_id" source="t_message_inbox_id"/>
					</LinkParameters>
					<Attributes/>
					<Features/>
				</Link>
				<Label id="21" fieldSourceType="DBColumn" dataType="Text" html="False" name="message_status" fieldSource="message_status" wizardCaption="Valid To" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_message_outboxGridmessage_status" format="0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="19" fieldSourceType="DBColumn" dataType="Text" html="False" name="creation_date" fieldSource="creation_date" wizardCaption="Valid From" wizardSize="8" wizardMaxLength="100" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_message_outboxGridcreation_date" format="0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="17" fieldSourceType="DBColumn" dataType="Text" html="False" name="message_type" fieldSource="message_type" wizardCaption="Description" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_message_outboxGridmessage_type">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Hidden id="286" fieldSourceType="DBColumn" dataType="Float" name="t_message_outbox_id" PathID="t_message_outboxGridt_message_outbox_id" fieldSource="t_message_outbox_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
FROM
	t_message_outbox outbox
LEFT JOIN sikp.p_message_type mtype ON mtype.p_message_type_id = outbox.p_message_type_id
where t_message_outbox_id = {t_message_outbox_id}" customUpdate="select o_result_code, o_result_msg from f_first_submit_engine(501,{t_customer_order_id},'{UserName}')" customUpdateType="SQL" customDeleteType="SQL" customDelete="select * from f_del_vat_setllement({t_vat_setllement_id},null,null)">
			<Components>
				<Button id="24" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" operation="Insert" wizardCaption="Add" PathID="t_message_outboxFormButton_Insert" removeParameters="FLAG">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="25" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Update" operation="Update" wizardCaption="Submit" PathID="t_message_outboxFormButton_Update" removeParameters="FLAG">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Button id="26" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="t_message_outboxFormButton_Delete" removeParameters="FLAG;p_vat_type_id;p_vat_typeGridPage;s_keyword">
					<Components/>
					<Events>
				...
				<Label id="31" visible="Yes" fieldSourceType="DBColumn" dataType="Memo" name="message_body" fieldSource="message_body" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_message_outboxFormmessage_body" html="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<TextBox id="243" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="message_type" fieldSource="message_type" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_message_outboxFormmessage_type">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<Hidden id="223" fieldSourceType="DBColumn" dataType="Float" html="False" name="t_message_outbox_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="t_message_outboxFormt_message_outbox_id" fieldSource="t_message_outbox_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Button id="290" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert1" operation="Update" wizardCaption="Add" PathID="t_message_outboxFormButton_Insert1" removeParameters="FLAG">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="284" parameterType="URL" variable="t_message_outbox_id" dataType="Float" parameterSource="t_message_outbox_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_message_outbox_bphtb_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_message_outbox_bphtb.php" forShow="True" url="t_message_outbox_bphtb.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
