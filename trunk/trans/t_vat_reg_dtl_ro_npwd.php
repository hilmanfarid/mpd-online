<?php
//Include Common Files @1-0EB3FB48
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_reg_dtl_ro_npwd.php");
...
//Class_Initialize Event @2-BBA55C2A
    function clsGridt_vat_reg_dtlGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_reg_dtl_ro_npwd.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "t_vat_reg_dtl_ro_npwd.php";
...
//Operation Method @3-A311B76D
    function Operation()
    {
        ...
        $Redirect = "t_vat_reg_dtl_ro_npwd.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_reg_dtl_ro_npwd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @688-6165AC8B
...
//Class_Initialize Event @790-0AA78FC8
...
//Class_Initialize Event @814-1F141A37
...
//Class_Initialize Event @838-8E19FB75
...
//Class_Initialize Event @862-87518524
...
//Class_Initialize Event @896-FE27A967
...
//Class_Initialize Event @915-0454930E
...
//Class_Initialize Event @952-D31050E5
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_reg_dtl_ro_npwd.html";
$BlockToParse = "main";
...
//Include events file @1-6AC2EE02
include_once("./t_vat_reg_dtl_ro_npwd_events.php");
