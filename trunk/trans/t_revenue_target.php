<?php
//Include Common Files @1-5BE23E95
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_revenue_target.php");
...
class clsGridv_t_revenue_targetGrid { //v_t_revenue_targetGrid class @2-FA98B570
...
//Class_Initialize Event @2-03212DA8
    function clsGridv_t_revenue_targetGrid($RelativePath, & $Parent)
    {
        ...
        $this->ComponentName = "v_t_revenue_targetGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid v_t_revenue_targetGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsv_t_revenue_targetGridDataSource($this);
        ...
        $this->DLink->Page = "t_revenue_target.php";
...
//Show Method @2-3ABC29C3
    function Show()
    {
        ...
        $this->Insert_Link->Parameters = CCGetQueryString("QueryString", array("t_revenue_target_id", "s_keyword", "ccsForm"));
...
} //End v_t_revenue_targetGrid Class @2-FCB6E20C

class clsv_t_revenue_targetGridDataSource extends clsDBConnSIKP {  //v_t_revenue_targetGridDataSource Class @2-0FD76EC6

//DataSource Variables @2-E0A7FEF2
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//SetOrder Method @2-FAA7CC5E
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "t_revenue_target_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            "");
    }
//End SetOrder Method

//Prepare Method @2-166E89FA
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->wp->AddParameter("3", "urlp_year_period_id", ccsFloat, "", "", $this->Parameters["urlp_year_period_id"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "upper(year_code)", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "upper(vat_code)", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "p_year_period_id", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsFloat),false);
...
//Open Method @2-8A6801FB
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM v_t_revenue_target";
        $this->SQL = "SELECT * \n\n" .
        "FROM v_t_revenue_target {SQL_Where} {SQL_OrderBy}";
...
} //End v_t_revenue_targetGridDataSource Class @2-FCB6E20C

class clsRecordv_t_revenue_targetSearch { //v_t_revenue_targetSearch Class @3-B3DF8E3B
...
//Class_Initialize Event @3-99E9FC25
    function clsRecordv_t_revenue_targetSearch($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record v_t_revenue_targetSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "v_t_revenue_targetSearch";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
...
//Operation Method @3-A02269B0
    function Operation()
    {
        ...
        $Redirect = "t_revenue_target.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_revenue_target.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End v_t_revenue_targetSearch Class @3-FCB6E20C

class clsRecordv_t_revenue_targetForm { //v_t_revenue_targetForm Class @23-F0C99B06
...
//Class_Initialize Event @23-8C6ABF5D
    function clsRecordv_t_revenue_targetForm($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record v_t_revenue_targetForm/Error";
        $this->DataSource = new clsv_t_revenue_targetFormDataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "v_t_revenue_targetForm";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
...
//CheckErrors Method @23-8551B499
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->p_year_period_id->Errors->Count());
...
//Operation Method @23-26A9D477
    function Operation()
    {
        ...
        if($this->PressedButton == "Button_Delete") {
            $Redirect = $FileName . "?" . CCGetQueryString("QueryString", array("ccsForm", "FLAG", "t_revenue_target_id", "s_keyword", "t_revenue_targetGridPage"));
...
} //End v_t_revenue_targetForm Class @23-FCB6E20C

class clsv_t_revenue_targetFormDataSource extends clsDBConnSIKP {  //v_t_revenue_targetFormDataSource Class @23-50E0F832

//DataSource Variables @23-08CEAD90
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
    ...
    var $updated_by;
    var $p_vat_type_id;
    var $t_revenue_targetGridPage;
    var $t_revenue_target_id;
    var $target_amt;
//End DataSource Variables

//DataSourceClass_Initialize Event @23-649F7FCC
    function clsv_t_revenue_targetFormDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record v_t_revenue_targetForm/Error";
        $this->Initialize();
        ...
        $this->t_revenue_targetGridPage = new clsField("t_revenue_targetGridPage", ccsText, "");
...
//Prepare Method @23-33FF2701
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlt_revenue_target_id", ccsFloat, "", "", $this->Parameters["urlt_revenue_target_id"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "t_revenue_target_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsFloat),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @23-4C8D75B6
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
...
//Insert Method @23-D08B977A
    function Insert()
    {
        ...
        $this->cp["created_by"] = new clsSQLParameter("expr155", ccsText, "", "", CCGetUserLogin(), "", false, $this->ErrorBlock);
        $this->cp["updated_by"] = new clsSQLParameter("expr157", ccsText, "", "", CCGetUserLogin(), "", false, $this->ErrorBlock);
        ...
        $this->SQL = "INSERT INTO t_revenue_target(t_revenue_target_id, p_year_period_id, target_code, description, creation_date, created_by, updated_date, updated_by, p_vat_type_id, target_amt) \n" .
        "VALUES(generate_id('sikp','t_revenue_target','t_revenue_target_id'), " . $this->SQLValue($this->cp["p_year_period_id"]->GetDBValue(), ccsFloat) . ", '" . $this->SQLValue($this->cp["target_code"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["description"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["created_by"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["updated_by"]->GetDBValue(), ccsText) . "', " . $this->SQLValue($this->cp["p_vat_type_id"]->GetDBValue(), ccsFloat) . ", " . $this->SQLValue($this->cp["target_amt"]->GetDBValue(), ccsFloat) . ")";
...
//Update Method @23-DD00B475
    function Update()
    {
        ...
        if (!strlen($this->cp["target_amt"]->GetText()) and !is_bool($this->cp["target_amt"]->GetValue(true))) 
            $this->cp["target_amt"]->SetText(0);
        $this->SQL = "UPDATE t_revenue_target SET \n" .
        ...
        "WHERE t_revenue_target_id=" . $this->SQLValue($this->cp["t_revenue_target_id"]->GetDBValue(), ccsFloat) . "";
...
//Delete Method @23-A30EBFC2
    function Delete()
    {
        ...
        if (!strlen($this->cp["t_revenue_target_id"]->GetText()) and !is_bool($this->cp["t_revenue_target_id"]->GetValue(true))) 
            $this->cp["t_revenue_target_id"]->SetText(0);
        $this->SQL = "DELETE FROM t_revenue_target\n" .
        "WHERE t_revenue_target_id = " . $this->SQLValue($this->cp["t_revenue_target_id"]->GetDBValue(), ccsFloat) . "";
...
} //End v_t_revenue_targetFormDataSource Class @23-FCB6E20C

//Initialize Page @1-64158F2B
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_revenue_target.html";
$BlockToParse = "main";
...
//Include events file @1-14BD94CA
include_once("./t_revenue_target_events.php");
...
// Controls
$v_t_revenue_targetGrid = & new clsGridv_t_revenue_targetGrid("", $MainPage);
$v_t_revenue_targetSearch = & new clsRecordv_t_revenue_targetSearch("", $MainPage);
$v_t_revenue_targetForm = & new clsRecordv_t_revenue_targetForm("", $MainPage);
$year_code = & new clsControl(ccsLabel, "year_code", "year_code", ccsText, "", CCGetRequestParam("year_code", ccsGet, NULL), $MainPage);
$MainPage->v_t_revenue_targetGrid = & $v_t_revenue_targetGrid;
$MainPage->v_t_revenue_targetSearch = & $v_t_revenue_targetSearch;
$MainPage->v_t_revenue_targetForm = & $v_t_revenue_targetForm;
$MainPage->year_code = & $year_code;
$v_t_revenue_targetGrid->Initialize();
$v_t_revenue_targetForm->Initialize();
...
//Execute Components @1-8EC5F30F
$v_t_revenue_targetSearch->Operation();
$v_t_revenue_targetForm->Operation();
//End Execute Components

//Go to destination page @1-575FBF82
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnSIKP->close();
    header("Location: " . $Redirect);
    unset($v_t_revenue_targetGrid);
    unset($v_t_revenue_targetSearch);
    unset($v_t_revenue_targetForm);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-655F514B
$v_t_revenue_targetGrid->Show();
$v_t_revenue_targetSearch->Show();
$v_t_revenue_targetForm->Show();
$year_code->Show();
$Tpl->block_path = "";
