<?php
//Include Common Files @1-A4CD6FCE
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_cust_order_legal_doc_ro_npwd.php");
...
//Class_Initialize Event @2-5BF1CAE2
    function clsGridt_cust_order_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cust_order_legal_doc_ro_npwd.php";
        ...
        $this->Insert_Link->Page = "t_cust_order_legal_doc_ro_npwd.php";
...
//Operation Method @3-CA6D46CF
    function Operation()
    {
        ...
        $Redirect = "t_cust_order_legal_doc_ro_npwd.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cust_order_legal_doc_ro_npwd.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cust_order_legal_doc_ro_npwd.html";
$BlockToParse = "main";
...
//Include events file @1-7CE978D3
include_once("./t_cust_order_legal_doc_ro_npwd_events.php");
