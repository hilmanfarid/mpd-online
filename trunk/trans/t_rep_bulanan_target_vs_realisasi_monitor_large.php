<?php
//Include Common Files @1-E6065A3B
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_rep_bulanan_target_vs_realisasi_monitor_large.php");
...
//Operation Method @3-00AA682A
    function Operation()
    {
        ...
        $Redirect = "t_rep_bulanan_target_vs_realisasi_monitor_large.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_rep_bulanan_target_vs_realisasi_monitor_large.html";
$BlockToParse = "main";
...
//Include events file @1-D114521D
include_once("./t_rep_bulanan_target_vs_realisasi_monitor_large_events.php");
