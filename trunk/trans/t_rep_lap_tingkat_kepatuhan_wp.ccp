<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions" connection="ConnSIKP">
	<Components>
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="False" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="None" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="t_rep_sisa_piutangSearch" returnPage="t_rep_lap_tingkat_kepatuhan_wp.ccp" PathID="t_rep_sisa_piutangSearch" pasteActions="pasteActions" pasteAsReplace="pasteAsReplace">
			<Components>
				...
				<ListBox id="567" visible="Yes" fieldSourceType="DBColumn" sourceType="ListOfValues" dataType="Text" returnValueType="Number" name="ListBox1" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" wizardEmptyCaption="Select Value" PathID="t_rep_sisa_piutangSearchListBox1" connection="ConnSIKP" dataSource="1;PATUH;2;KURANG PATUH;3;TIDAK PATUH" _valueOfList="3" _nameOfList="TIDAK PATUH">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_rep_lap_tingkat_kepatuhan_wp_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="t_rep_lap_tingkat_kepatuhan_wp.php" forShow="True" url="t_rep_lap_tingkat_kepatuhan_wp.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
