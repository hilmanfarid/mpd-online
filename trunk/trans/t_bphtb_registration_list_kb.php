<?php
//Include Common Files @1-54E9766E
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_list_kb.php");
...
//Class_Initialize Event @2-56CE5BDC
    function clsGridt_bphtb_registration_list($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_bphtb_registration_list_kb.php";
        ...
        $this->Insert_Link->Page = "t_bphtb_registration_kb.php";
...
//Show Method @2-7B4A2ABB
    function Show()
    {
        ...
        $this->Insert_Link->Parameters = CCGetQueryString("QueryString", array("registration_no_ref", "t_bphtb_registration_id_old", "filltheform", "ccsForm"));
...
//Open Method @2-ED0CC920
    function Open()
    {
        ...
        "AND regis.p_bphtb_type_id = 3) cnt";
        ...
        "regis.wp_name ILIKE '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') \n" .
        "AND cust_order.p_order_status_id = 1\n" .
        "AND regis.p_bphtb_type_id = 3{SQL_OrderBy}";
...
//Operation Method @3-1CCBEED0
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_list_kb.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_list_kb.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_list_kb.html";
$BlockToParse = "main";
...
//Include events file @1-643A3938
include_once("./t_bphtb_registration_list_kb_events.php");
