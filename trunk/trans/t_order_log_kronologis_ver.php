<?php
//Include Common Files @1-37A773BC
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_order_log_kronologis_ver.php");
...
//Operation Method @3-5196F7B1
    function Operation()
    {
        ...
        $Redirect = "t_order_log_kronologis_ver.php";
    }
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_order_log_kronologis_ver.html";
$BlockToParse = "main";
...
//Include events file @1-D332DA04
include_once("./t_order_log_kronologis_ver_events.php");
