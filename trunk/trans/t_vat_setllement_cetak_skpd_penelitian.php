<?php
//Include Common Files @1-7AD90396
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_cetak_skpd_penelitian.php");
...
//Class_Initialize Event @2-F2D362E6
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_cetak_skpd_penelitian.php";
...
//DataSource Variables @2-4FC44507
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-882CBA5E
...
//Open Method @2-299214B1
    function Open()
    {
        ...
        ")\n" .
        "and a.p_settlement_type_id =2) cnt";
        ...
        "  upper(a.no_kohir) LIKE upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')\n" .
        ")\n" .
        "and a.p_settlement_type_id =2 {SQL_OrderBy}";
...
//Operation Method @3-298AE9AB
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_cetak_skpd_penelitian.php";
    }
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_cetak_skpd_penelitian.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_cetak_skpd_penelitian.html";
$BlockToParse = "main";
...
//Include events file @1-243A2E5E
include_once("./t_vat_setllement_cetak_skpd_penelitian_events.php");
