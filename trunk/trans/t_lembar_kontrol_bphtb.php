<?php
//Include Common Files @1-9F2A2564
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_lembar_kontrol_bphtb.php");
...
//Class_Initialize Event @2-90DC5794
...
//Operation Method @2-8D38724B
    function Operation()
    {
        ...
        $Redirect = "t_lembar_kontrol_bphtb.php";
        if($this->Validate()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_lembar_kontrol_bphtb.html";
$BlockToParse = "main";
...
//Include events file @1-599D3BFE
include_once("./t_lembar_kontrol_bphtb_events.php");
