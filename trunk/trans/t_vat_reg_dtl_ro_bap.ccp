<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\trans" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="RWNet" wizardThemeVersion="3.0" needGeneration="0" pasteActions="pasteActions">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtlGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_license_letter">
			<Components>
				...
				<Link id="52" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtlGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_license_letter_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="54" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_dtlGridADLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_license_letter_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="688" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_restaurantGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_restaurant">
			<Components>
				...
				<Link id="755" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_restaurantGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_restaurant_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="790" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_hotelGrid1" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_hotel">
			<Components>
				...
				<Link id="794" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_hotelGrid1DLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_hotel_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="814" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="v_vat_reg_dtl_entertaintmentGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_entertaintment">
			<Components>
				...
				<Link id="818" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="v_vat_reg_dtl_entertaintmentGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_entertaintment_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="838" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_parkingGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_parking">
			<Components>
				...
				<Link id="842" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_parkingGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_parking_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="862" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_ppjGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_ppj">
			<Components>
				...
				<Link id="866" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_ppjGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_ppj_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="868" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_dtl_ppjGridADLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_ppj_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="896" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_dtl_ppj_nplGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_dtl_ppj_non_pln">
			<Components>
				...
				<Link id="900" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_dtl_ppj_nplGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_ppj_npl_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="902" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_dtl_ppj_nplGridADLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_dtl_ppj_id">
					<Components/>
					<Events/>
					<LinkParameters>
		...
		<Grid id="952" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="5" connection="ConnSIKP" name="t_vat_reg_employeeGrid" pageSizeLimit="100" wizardCaption="List of P App Role " wizardGridType="Tabular" wizardAllowInsert="True" wizardAltRecord="True" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="-" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters" parameterTypeListName="ParameterTypeList" dataSource="v_vat_reg_employee">
			<Components>
				...
				<Link id="958" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" PathID="t_vat_reg_employeeGridDLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_employee_id">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="960" visible="Dynamic" fieldSourceType="DBColumn" dataType="Text" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="ADLink" PathID="t_vat_reg_employeeGridADLink" hrefSource="t_vat_reg_dtl_ro_bap.ccp" wizardUseTemplateBlock="True" removeParameters="FLAG" fieldSource="t_vat_reg_employee_id">
					<Components/>
					<Events/>
					<LinkParameters>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_vat_reg_dtl_ro_bap_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_vat_reg_dtl_ro_bap.php" forShow="True" url="t_vat_reg_dtl_ro_bap.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
