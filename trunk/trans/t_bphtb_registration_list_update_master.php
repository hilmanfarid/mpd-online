<?php
//Include Common Files @1-CCCD1FF4
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_bphtb_registration_list_update_master.php");
...
//Class_Initialize Event @2-EFEB3B69
    function clsGridt_bphtb_registration_list($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_bphtb_registration_list_update_master.php";
...
//Operation Method @3-28B9F9CC
    function Operation()
    {
        ...
        $Redirect = "t_bphtb_registration_list_update_master.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_bphtb_registration_list_update_master.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_bphtb_registration_list_update_master.html";
$BlockToParse = "main";
...
//Include events file @1-CCBFFFA3
include_once("./t_bphtb_registration_list_update_master_events.php");
