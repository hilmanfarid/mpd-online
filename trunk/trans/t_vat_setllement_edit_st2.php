<?php
//Include Common Files @1-90C16B27
define("RelativePath", "..");
define("PathToCurrentPage", "/trans/");
define("FileName", "t_vat_setllement_edit_st2.php");
...
//Class_Initialize Event @2-613CEB5A
    function clsGridt_vat_setllementGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_vat_setllement_edit_st2.php";
...
//Operation Method @3-ADD050D5
    function Operation()
    {
        ...
        $Redirect = "t_vat_setllement_edit_st2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_vat_setllement_edit_st2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_vat_setllement_edit_st2.html";
$BlockToParse = "main";
...
//Include events file @1-4F9CA993
include_once("./t_vat_setllement_edit_st2_events.php");
