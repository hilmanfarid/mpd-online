<?php
//Include Common Files @1-A56B3D21
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_wf_proc_list2.php");
...
//SetValues Method @67-1B4D43CC
    function SetValues()
    {
        ...
        $this->valid_from->SetDBValue($this->f("cvalid_from"));
        $this->valid_to->SetDBValue($this->f("cvalid_to"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_wf_proc_list2.html";
$BlockToParse = "main";
...
//Include events file @1-D8705A13
include_once("./p_wf_proc_list2_events.php");
