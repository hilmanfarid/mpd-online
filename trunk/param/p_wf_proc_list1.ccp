...
WHERE  p_w_chart_proc_id = {p_w_chart_proc_id} " PathID="p_workflowForm" pasteActions="pasteActions" activeCollection="USQLParameters" parameterTypeListName="ParameterTypeList" dataSource="v_wf_chart_edit">
			<Components>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_wf_proc_list1_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_wf_proc_list1.php" forShow="True" url="p_wf_proc_list1.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
