...
WHERE legal_doc_desc LIKE '%{s_keyword}%'
AND t_cust_account_id = {t_cust_account_id} ">
			<Components>
				<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Insert_Link" hrefSource="t_cacc_legal_doc_read_only.ccp" removeParameters="t_cacc_legal_doc_id;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="t_cacc_legal_docGridInsert_Link">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="t_cacc_legal_doc_read_only.ccp" wizardThemeItem="GridA" PathID="t_cacc_legal_docGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="15" fieldSourceType="DBColumn" dataType="Text" html="False" name="origin_file_name" fieldSource="origin_file_name" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_cacc_legal_docGridorigin_file_name" visible="Yes" hrefType="Database" urlType="Relative" preserveParameters="GET" hrefSource="file_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="13" fieldSourceType="DBColumn" dataType="Float" html="False" name="t_cacc_legal_doc_id" fieldSource="t_cacc_legal_doc_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="t_cacc_legal_docGridt_cacc_legal_doc_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Label id="17" fieldSourceType="DBColumn" dataType="Text" html="False" name="description" fieldSource="description" wizardCaption="Description" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_cacc_legal_docGriddescription">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="555" fieldSourceType="DBColumn" dataType="Text" html="False" name="legal_doc_desc" fieldSource="legal_doc_desc" wizardCaption="Code" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="t_cacc_legal_docGridlegal_doc_desc">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Record id="94" sourceType="SQL" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="ConnSIKP" name="t_cacc_legal_docForm" errorSummator="Error" wizardCaption="Add/Edit V P App User " wizardFormMethod="post" PathID="t_cacc_legal_docForm" activeCollection="DSQLParameters" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" customDeleteType="SQL" parameterTypeListName="ParameterTypeList" customUpdateType="SQL" customInsertType="SQL" customInsert="INSERT INTO t_cacc_legal_doc(t_cacc_legal_doc_id, description, created_by, updated_by, creation_date, updated_date, p_legal_doc_type_id, t_cust_account_id, origin_file_name, file_folder, file_name, legal_doc_desc) 
VALUES(generate_id('sikp','t_cacc_legal_doc','t_cacc_legal_doc_id'), '{description}', '{created_by}', '{updated_by}', sysdate, sysdate, {p_legal_doc_type_id}, {t_cust_account_id}, substr('{file_name}',17),'{file_folder}','{file_name}','{legal_doc_desc}')" customUpdate="UPDATE t_cacc_legal_doc SET 
...
FROM t_cacc_legal_doc
WHERE t_cacc_legal_doc_id = {t_cacc_legal_doc_id} ">
			<Components>
				...
				<Hidden id="101" fieldSourceType="DBColumn" dataType="Float" name="t_cacc_legal_doc_id" fieldSource="t_cacc_legal_doc_id" caption="Id" wizardCaption="P App User Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_cacc_legal_docFormt_cacc_legal_doc_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<TextBox id="114" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="description" fieldSource="description" required="False" caption="Description" wizardCaption="Description" wizardSize="50" wizardMaxLength="250" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_cacc_legal_docFormdescription">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<TextBox id="564" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="legal_doc_desc" fieldSource="legal_doc_desc" required="True" caption="Jenis Dokumen" wizardCaption="ORGANIZATION CODE" wizardSize="32" wizardMaxLength="32" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="t_cacc_legal_docFormlegal_doc_desc">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<Hidden id="566" fieldSourceType="DBColumn" dataType="Float" name="p_legal_doc_type_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cacc_legal_docFormp_legal_doc_type_id" fieldSource="p_legal_doc_type_id" caption="p_legal_doc_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="619" fieldSourceType="DBColumn" dataType="Float" name="t_cust_account_id" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cacc_legal_docFormt_cust_account_id" fieldSource="t_cust_account_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="647" fieldSourceType="DBColumn" dataType="Text" name="file_folder" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cacc_legal_docFormfile_folder" fieldSource="file_folder">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<Hidden id="648" fieldSourceType="DBColumn" dataType="Text" name="origin_file_name" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cacc_legal_docFormorigin_file_name" fieldSource="origin_file_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Hidden>
				<FileUpload id="693" fieldSourceType="DBColumn" allowedFileMasks="*" fileSizeLimit="2000000" dataType="Text" tempFileFolder="../files_tmp" name="file_name" wizardTheme="None" wizardThemeType="File" wizardThemeVersion="3.0" PathID="t_cacc_legal_docFormfile_name" processedFileFolder="../files" fieldSource="file_name">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="692" parameterType="URL" variable="t_cacc_legal_doc_id" dataType="Float" parameterSource="t_cacc_legal_doc_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
			...
			<USQLParameters>
				<SQLParameter id="663" variable="t_cacc_legal_doc_id" dataType="Float" parameterType="Control" parameterSource="t_cacc_legal_doc_id" defaultValue="0"/>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="674" variable="t_cacc_legal_doc_id" parameterType="Control" defaultValue="0" dataType="Float" parameterSource="t_cacc_legal_doc_id"/>
			</DSQLParameters>
			<DConditions>
			</DConditions>
			<SecurityGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="t_cacc_legal_doc_read_only_events.php" forShow="False" comment="//" codePage="windows-1252"/>
<CodeFile id="Code" language="PHPTemplates" name="t_cacc_legal_doc_read_only.php" forShow="True" url="t_cacc_legal_doc_read_only.php" comment="//" codePage="windows-1252"/>
</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
