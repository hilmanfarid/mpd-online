...
ORDER BY p_simple_parameter_type_id" orderBy="p_vat_type_id">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="CodeExpression" html="True" hrefType="Page" urlType="Relative" preserveParameters="GET" name="DLink" wizardCaption="Detail" wizardSize="50" wizardMaxLength="60" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" dataType="Text" wizardDefaultValue="DLink" hrefSource="p_simple_parameter_type.ccp" wizardThemeItem="GridA" PathID="p_simple_parameter_typeGridDLink" removeParameters="FLAG">
					<Components/>
					<Events/>
					<LinkParameters>
...
<Hidden id="13" fieldSourceType="DBColumn" dataType="Float" html="False" name="p_simple_parameter_type_id" fieldSource="p_simple_parameter_type_id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="p_simple_parameter_typeGridp_simple_parameter_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
...
<Link id="7" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="Insert_Link" hrefSource="p_simple_parameter_type.ccp" removeParameters="p_simple_parameter_type_id;s_keyword" wizardThemeItem="FooterA" wizardDefaultValue="Add New" wizardUseTemplateBlock="False" PathID="p_simple_parameter_typeGridInsert_Link">
					<Components/>
					<Events/>
					<LinkParameters>
...
updated_date, 
updated_by) 
VALUES(generate_id('sikp','p_simple_parameter_type','p_simple_parameter_type_id'), '{code}', '{description}', sysdate, '{created_by}', sysdate, '{updated_by}')" customInsertType="SQL" customUpdate="UPDATE p_simple_parameter_type SET 
code='{code}',
description='{description}', 
updated_date=sysdate, 
updated_by='{updated_by}'
WHERE p_simple_parameter_type_id={p_simple_parameter_type_id}" customDelete="DELETE FROM p_simple_parameter_type
WHERE  p_simple_parameter_type_id = {p_simple_parameter_type_id}" dataSource="SELECT p_simple_parameter_type_id, code,
...
FROM p_simple_parameter_type
WHERE p_simple_parameter_type_id = {p_simple_parameter_type_id} ">
			<Components>
				...
				<Button id="26" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Delete" operation="Delete" wizardCaption="Delete" PathID="p_simple_parameter_typeFormButton_Delete" removeParameters="FLAG;p_simple_parameter_type_id;p_simple_parameter_typeGridPage;s_keyword">
					<Components/>
					<Events>
				...
				<Button id="28" urlType="Relative" enableValidation="False" isDefault="False" name="Button_Cancel" operation="Cancel" wizardCaption="Cancel" PathID="p_simple_parameter_typeFormButton_Cancel" removeParameters="FLAG;p_simple_parameter_type_id;p_simple_parameter_typeGridPage;s_keyword">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Hidden id="30" fieldSourceType="DBColumn" dataType="Float" name="p_simple_parameter_type_id" fieldSource="p_simple_parameter_type_id" required="False" caption="Id" wizardCaption="Id" wizardSize="12" wizardMaxLength="12" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="p_simple_parameter_typeFormp_simple_parameter_type_id">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="182" parameterType="URL" variable="p_simple_parameter_type_id" dataType="Float" parameterSource="p_simple_parameter_type_id" defaultValue="0"/>
			</SQLParameters>
			<JoinTables>
			</JoinTables>
			<JoinLinks/>
			...
			<ISQLParameters>
				...
				<SQLParameter id="235" variable="p_simple_parameter_type_id" parameterType="Control" dataType="Integer" parameterSource="p_simple_parameter_type_id" defaultValue="0"/>
			...
			<USPParameters/>
			<USQLParameters>
				<SQLParameter id="209" variable="p_simple_parameter_type_id" dataType="Float" parameterType="Control" parameterSource="p_simple_parameter_type_id" defaultValue="0"/>
			...
			<DSPParameters/>
			<DSQLParameters>
				<SQLParameter id="218" variable="p_simple_parameter_type_id" parameterType="Control" dataType="Float" parameterSource="p_simple_parameter_type_id" defaultValue="0"/>
			</DSQLParameters>
			<DConditions>
			</DConditions>
			<SecurityGroups/>
	...
	<CodeFiles>
		<CodeFile id="Events" language="PHPTemplates" name="p_simple_parameter_type_events.php" forShow="False" comment="//" codePage="windows-1252"/>
		<CodeFile id="Code" language="PHPTemplates" name="p_simple_parameter_type.php" forShow="True" url="p_simple_parameter_type.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
