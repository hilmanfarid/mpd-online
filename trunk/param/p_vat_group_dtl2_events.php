...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->p_vat_type_group_id->GetValue();
        $p_vat_groupForm->DataSource->Parameters["urlp_vat_type_group_id"] = $selected_id;
...
// End Bdr  
  	...
  	// Start Bdr    
        ...
        $Style = $styles[0];
        if ($Component->DataSource->p_vat_type_group_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-EB513C5D
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_vat_group_dtl2; //Compatibility
...
//End Custom Code
  ...
  // -------------------------
      // Write your own code here.
  	  global $selected_id;
        $selected_id = -1;
        $selected_id=CCGetFromGet("p_vat_type_group_id", $selected_id);
  // -------------------------
