...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->t_cust_acc_card_id->GetValue();
        $t_cacc_legal_docForm->DataSource->Parameters["urlt_cust_acc_card_id"] = $selected_id;
...
// Start Bdr    
    ...
    if ($Component->DataSource->t_cust_acc_card_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-16269D61
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_cust_acc_card; //Compatibility
...
// -------------------------
    ...
    global $selected_id;
    $selected_id = -1;
    $selected_id=CCGetFromGet("t_cust_acc_card_id", $selected_id);
// -------------------------
//End Custom Code
