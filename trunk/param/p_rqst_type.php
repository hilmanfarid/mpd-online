<?php
//Include Common Files @1-4EEE4926
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_rqst_type.php");
...
class clsGridp_rqst_typeGrid { //p_rqst_typeGrid class @2-2F3A47A9
...
//Class_Initialize Event @2-D236CBE5
    function clsGridp_rqst_typeGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "p_rqst_typeGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid p_rqst_typeGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsp_rqst_typeGridDataSource($this);
        ...
        $this->DLink->Page = "p_rqst_type.php";
        ...
        $this->Insert_Link->Page = "p_rqst_type.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->DLink->Parameters = CCAddParam($this->DLink->Parameters, "p_rqst_type_id", $this->DataSource->f("p_rqst_type_id"));
        ...
        $this->Insert_Link->Parameters = CCGetQueryString("QueryString", array("p_rqst_type_id", "s_keyword", "ccsForm"));
...
} //End p_rqst_typeGrid Class @2-FCB6E20C

class clsp_rqst_typeGridDataSource extends clsDBConnSIKP {  //p_rqst_typeGridDataSource Class @2-8486EF6E

//DataSource Variables @2-A8871E26
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-79CF7914
    function clsp_rqst_typeGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid p_rqst_typeGrid";
        $this->Initialize();
...
//SetOrder Method @2-7E21C4C5
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "a.p_rqst_type_id";
...
//Open Method @2-7E95C4DB
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT to_char(a.updated_date,'DD-MON-YYYY') AS updated_date, a.p_rqst_type_id, a.code, a.description, a.updated_by,\n" .
        ...
        "WHERE (upper(a.code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%' OR\n" .
        "upper(b.vat_code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT to_char(a.updated_date,'DD-MON-YYYY') AS updated_date, a.p_rqst_type_id, a.code, a.description, a.updated_by,\n" .
        "a.created_by, to_char(a.creation_date,'DD-MON-YYYY') AS creation_date, a.p_vat_type_id,\n" .
        "b.vat_code \n" .
        "FROM p_rqst_type a INNER JOIN p_vat_type b ON\n" .
        "a.p_vat_type_id = b.p_vat_type_id \n" .
        "WHERE (upper(a.code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%' OR\n" .
        "upper(b.vat_code) like '%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%') {SQL_OrderBy}";
...
} //End p_rqst_typeGridDataSource Class @2-FCB6E20C

class clsRecordp_rqst_typeSearch { //p_rqst_typeSearch Class @3-CC06C3C0
...
//Class_Initialize Event @3-A6DAFCA4
    function clsRecordp_rqst_typeSearch($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record p_rqst_typeSearch/Error";
        $this->ReadAllowed = true;
        if($this->Visible)
        {
            $this->ComponentName = "p_rqst_typeSearch";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
...
//Operation Method @3-6955C0FF
    function Operation()
    {
        ...
        $Redirect = "p_rqst_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_rqst_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End p_rqst_typeSearch Class @3-FCB6E20C

class clsRecordp_rqst_typeForm { //p_rqst_typeForm Class @23-D6F3F9FE
...
//Class_Initialize Event @23-F20A2751
    function clsRecordp_rqst_typeForm($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record p_rqst_typeForm/Error";
        $this->DataSource = new clsp_rqst_typeFormDataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "p_rqst_typeForm";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
...
//CheckErrors Method @23-33C2F936
    function CheckErrors()
    {
        $errors = false;
...
} //End p_rqst_typeForm Class @23-FCB6E20C

class clsp_rqst_typeFormDataSource extends clsDBConnSIKP {  //p_rqst_typeFormDataSource Class @23-DBB1799A

//DataSource Variables @23-FC6CDA26
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @23-F8F4AC96
    function clsp_rqst_typeFormDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record p_rqst_typeForm/Error";
        $this->Initialize();
...
//Prepare Method @23-26038F01
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlp_rqst_type_id", ccsFloat, "", "", $this->Parameters["urlp_rqst_type_id"], 0, false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
    }
//End Prepare Method

//Open Method @23-C0A9DD5E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT to_char(a.updated_date,'DD-MON-YYYY') AS updated_date, a.p_rqst_type_id, a.code, a.description, a.updated_by,\n" .
        ...
        "FROM p_rqst_type a INNER JOIN p_vat_type b ON\n" .
        "a.p_vat_type_id = b.p_vat_type_id \n" .
        "WHERE p_rqst_type_id = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "";
        $this->Order = "";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->PageSize = 1;
        $this->query($this->OptimizeSQL(CCBuildSQL($this->SQL, $this->Where, $this->Order)));
...
//Insert Method @23-D7571B72
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO p_rqst_type(p_rqst_type_id, code, description, creation_date, created_by, updated_date, updated_by, p_vat_type_id) \n" .
        "VALUES(generate_id('sikp','p_rqst_type','p_rqst_type_id'), '" . $this->SQLValue($this->cp["code"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["description"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["created_by"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["updated_by"]->GetDBValue(), ccsText) . "', " . $this->SQLValue($this->cp["p_vat_type_id"]->GetDBValue(), ccsFloat) . ")";
...
//Update Method @23-E522363E
    function Update()
    {
        ...
        if (!strlen($this->cp["p_vat_type_id"]->GetText()) and !is_bool($this->cp["p_vat_type_id"]->GetValue(true))) 
            $this->cp["p_vat_type_id"]->SetText(0);
        $this->SQL = "UPDATE p_rqst_type SET \n" .
        ...
        "WHERE p_rqst_type_id = " . $this->SQLValue($this->cp["p_rqst_type_id"]->GetDBValue(), ccsFloat) . "";
...
//Delete Method @23-EECCA924
    function Delete()
    {
        ...
        if (!strlen($this->cp["p_rqst_type_id"]->GetText()) and !is_bool($this->cp["p_rqst_type_id"]->GetValue(true))) 
            $this->cp["p_rqst_type_id"]->SetText(0);
        $this->SQL = "DELETE FROM p_rqst_type \n" .
        "WHERE  p_rqst_type_id = " . $this->SQLValue($this->cp["p_rqst_type_id"]->GetDBValue(), ccsFloat) . "";
...
} //End p_rqst_typeFormDataSource Class @23-FCB6E20C

//Initialize Page @1-6C7E754F
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_rqst_type.html";
$BlockToParse = "main";
...
//Include events file @1-D72FE3B3
include_once("./p_rqst_type_events.php");
...
// Controls
$p_rqst_typeGrid = & new clsGridp_rqst_typeGrid("", $MainPage);
$p_rqst_typeSearch = & new clsRecordp_rqst_typeSearch("", $MainPage);
$p_rqst_typeForm = & new clsRecordp_rqst_typeForm("", $MainPage);
$MainPage->p_rqst_typeGrid = & $p_rqst_typeGrid;
$MainPage->p_rqst_typeSearch = & $p_rqst_typeSearch;
$MainPage->p_rqst_typeForm = & $p_rqst_typeForm;
$p_rqst_typeGrid->Initialize();
$p_rqst_typeForm->Initialize();
...
//Execute Components @1-52433931
$p_rqst_typeSearch->Operation();
$p_rqst_typeForm->Operation();
//End Execute Components

//Go to destination page @1-0661D452
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnSIKP->close();
    header("Location: " . $Redirect);
    unset($p_rqst_typeGrid);
    unset($p_rqst_typeSearch);
    unset($p_rqst_typeForm);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-8458DC42
$p_rqst_typeGrid->Show();
$p_rqst_typeSearch->Show();
$p_rqst_typeForm->Show();
$Tpl->block_path = "";
