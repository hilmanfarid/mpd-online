...
// -------------------------
    // Write your own code here.
		$id_vat = $t_license_letterForm->t_cust_account_id->GetValue();
		...
		$redirectloader = "data_potensi_update.php?t_cust_account_id=".$id_vat."&rqst_type_code=".$code."&p_rqst_type_id=".$id_req."&t_customer_order_id=".$id_cus."";
		*/
...
//Page_OnInitializeView @1-005AE3FF
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $t_cacc_license_letter_edit; //Compatibility
