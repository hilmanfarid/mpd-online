<?php
//Include Common Files @1-2361F692
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_app_user.php");
...
//Class_Initialize Event @2-DBFB5D48
    function clsGridp_app_userGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "p_app_user.php";
        ...
        $this->Insert_Link->Page = "p_app_user.php";
...
//SetOrder Method @2-CADCFF03
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "p_app_user_id";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            "");
    }
//End SetOrder Method

//Prepare Method @2-6854796C
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "upper(app_user_name)", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "upper(full_name)", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "upper(email_address)", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opContains, "upper(description)", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
...
//Operation Method @3-3D9B2316
    function Operation()
    {
        ...
        $Redirect = "p_app_user.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_app_user.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_app_user.html";
$BlockToParse = "main";
...
//Include events file @1-8A5616DD
include_once("./p_app_user_events.php");
