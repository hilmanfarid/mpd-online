<?php
//Include Common Files @1-08DF47CC
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "t_cacc_legal_doc_read_only.php");
...
//Class_Initialize Event @2-E5941D46
    function clsGridt_cacc_legal_docGrid($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "t_cacc_legal_doc_read_only.php";
        ...
        $this->Insert_Link->Page = "t_cacc_legal_doc_read_only.php";
...
//Operation Method @3-F7678A9B
    function Operation()
    {
        ...
        $Redirect = "t_cacc_legal_doc_read_only.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "t_cacc_legal_doc_read_only.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "t_cacc_legal_doc_read_only.html";
$BlockToParse = "main";
...
//Include events file @1-20772551
include_once("./t_cacc_legal_doc_read_only_events.php");
