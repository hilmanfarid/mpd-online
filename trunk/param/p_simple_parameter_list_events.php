...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->p_simple_parameter_list_id->GetValue();
        $p_simple_parameter_typeForm->DataSource->Parameters["urlp_simple_parameter_list_id"] = $selected_id;
...
// End Bdr  
  	...
  	// Start Bdr    
        ...
        if ($Component->DataSource->p_simple_parameter_list_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-176F9BFD
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_simple_parameter_list; //Compatibility
...
//End Custom Code
  ...
  // -------------------------
      // Write your own code here.
  	  global $selected_id;
        $selected_id = -1;
        $selected_id=CCGetFromGet("p_simple_parameter_list_id", $selected_id);
  // -------------------------
