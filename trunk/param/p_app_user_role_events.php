...
// Start Bdr
    ...
    if ($selected_id<0 && $add_flag!="ADD") {
    	$selected_id = $Component->DataSource->p_app_user_role_id->GetValue();
        $p_app_user_roleForm->DataSource->Parameters["urlp_app_user_role_id"] = $selected_id;
...
//Set Row Style @11-982C9472
    ...
    if ($Component->DataSource->p_app_user_role_id->GetValue()== $selected_id) {
...
//Page_OnInitializeView @1-2F19CFEA
function Page_OnInitializeView(& $sender)
{
    $Page_OnInitializeView = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $p_app_user_role; //Compatibility
...
// -------------------------
    ...
    global $add_flag;
    $selected_id = -1;
    $selected_id=CCGetFromGet("p_app_user_role_id", $selected_id);
    $add_flag=CCGetFromGet("FLAG", "NONE");
// -------------------------
//End Custom Code
