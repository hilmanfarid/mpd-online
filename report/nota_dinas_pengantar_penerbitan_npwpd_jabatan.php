...
class FormCetak extends FPDF {
    ...
    function PageCetak($data) {
        ...
        $this->Cell($lengthJudul2, $this->height, "Permohonan Pengukuhan NPWPD Secara Jabatan", "B", 0, 'L');
        $this->Ln(10);
		...
		$this->RowMultiBorderWithHeight(
				array("",
					"",
					"Dipermaklumkan  dengan  hormat, menindaklanjuti hasil pendataan  wajib  pajak"
				),
				array("",
					"",
					""
		...
		$this->RowMultiBorderWithHeight(
				array("",
					"Hotel, Restoran, Hiburan dan Parkir yang belum terdaftar bersama ini kami sampaikan draft pengukuhan NPWPD jabatan sebanyak  ".$data["jumlah"]." (".$data["huruf"].") lembar untuk kiranya berkenan Bapak tandatangani."
				),
				array("",
					""
				),
