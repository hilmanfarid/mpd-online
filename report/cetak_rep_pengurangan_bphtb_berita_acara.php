...
define("FileName", "cetak_rep_pengurangan_bphtb_berita_acara.php");
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data, $user) {
		...
		$this->barisBaru("", "3 Luas Tanah", ": " . number_format($data["land_area"], 0, ",", ".")." m2");
		$this->barisBaru("", "4 Luas Bangunan", ": " . number_format($data["building_area"], 0, ",", ".")." m2");
		$this->barisBaru("", "5 RT/RW", ": RT. " . trim($data["object_rt"]) . "/RW. " . $data["object_rw"]);
		...
		$this->Ln();
		$this->barisBaru2($lbody1+$lbody1, "- Besaran Pengenaan Pengurangan ", $data['persen_pengurangan']."%", "Rp", $data["bphtb_discount"]);
