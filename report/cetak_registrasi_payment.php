...
$pdf->AddPage('landscape',array(160,160));
...
$pdf->Image('../images/logo_pemda.png',10,5,15,15);
$pdf->ln(10);
$pdf->SetWidths(array(5,95, 45));
...
$pdf->SetWidths(array(5,35, 50, 55));
$pdf->SetAligns(array("L", "L", "L"));
$pdf->RowMultiBorderWithHeight(
			array
			(	
...
$pdf->ln();
$pdf->SetWidths(array(5,35, 12, 38, 55));
