<?php
	...
	$sql = "SELECT *, to_char(settlement_date,'DD Month YYYY') AS tgl_setllement FROM v_gen_skpd_kb_jabatan WHERE settlement_type = 'SKPDKB JABATAN' AND t_customer_order_id = ". $t_customer_order_id;
	print_r($sql);exit;
	$dbConn->query($sql);
	$items = array();
