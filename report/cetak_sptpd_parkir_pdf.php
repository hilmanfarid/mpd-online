...
define("FileName", "cetak_sptpd_parkir_pdf.php");
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data,$dataBaru) {
		$this->AliasNbPages();
		$this->AddPage("P");		
		$startY = $this->GetY();
		...
		// $this->Cell($lengthCell, $this->height, "2.	BENTUK SURAT PEMBERITAHUAN PAJAK DAERAH UNTUK PAJAK PARKIR", 0, 0, 'L');
		// $this->Ln(6);
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "PAJAK PARKIR", "LR", 0, 'C');
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "", "LR", 0, 'C');
		$this->Ln();
		...
		$no = 1;
		$this->SetWidths(array($Tabspc1, $Tab1, $Tab2, $Tab3, $Tab4, $Tab5, $Tab6, $Tab7, $Tab8, $Tabspc2));
		...
		$this->RowMultiBorderWithHeight(array("",
											  ...
											  "",
											  $dataBaru["first_service_charge"][$i],
											  $dataBaru["next_service_charge"][$i],
											  "",
		...
		/*
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "1.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Roda 4", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab7, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab8, $this->height, "", 1, 0, 'L');
		$this->Cell($Tabspc2, $this->height, "", "R", 0, 'C');
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "2.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Roda 2", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "3.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Bus/Truk", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "4.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Truk Gandengan", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "5.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Container/Trailer", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "6.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Mobil Box", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "7.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Sepeda", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		$this->Ln();
		$this->Cell($Tabspc1, $this->height, "", "L", 0, 'C');
		$this->Cell($Tab1, $this->height, "8.", 1, 0, 'C');
		$this->Cell($Tab2, $this->height, "Lainnya", 1, 0, 'L');
		$this->Cell($Tab3, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab4, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		$this->Cell($Tab5, $this->height, "", 1, 0, 'L');
		...
		*/		
		$this->SetFont('Arial', 'B', 10);
		$this->Cell($lengthCell, $this->height, "A. DIISI OLEH WAJIB PAJAK / PENANGGUNG PAJAK SELF ASSESMENT", 1, 0, 'C');
		$this->Ln();
		$this->SetFont('Arial', '', 9);
		...
		$this->Ln();
		$this->SetFont('Arial', 'B', 10);
		$this->Cell($lengthCell, $this->height, "B. PERNYATAAN", 1, 0, 'C');
		$this->Ln();
		$this->SetFont('Arial', '', 9);
		$this->Cell($lengthCell, $this->height, "", "LR", 0, 'L');
		$this->Ln();
		...
		$this->Cell($kolm3+$kolm4, $this->height, "...................................................................................., tahun ......", "R", 0, 'L');
		$this->Ln();
		$this->Cell($kolm1+$kolm2, $this->height, "", "L", 0, 'C');
		...
		$this->Ln();
		$this->Cell($kolm1+$kolm2, $this->height, "", "L", 0, 'C');
		$this->Cell($kolm3+$kolm4, $this->height, "Nama Jelas", "R", 0, 'C');
		$this->Ln();
		$this->SetFont('Arial', 'B', 10);
		$this->Cell($lengthCell, $this->height, "D. DIISI OLEH PETUGAS PENERIMA", 1, 0, 'C');
		$this->Ln();
		$this->SetFont('Arial', '', 9);
		...
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		$this->Cell($Cell1, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell2, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell3, $this->height, "", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		$this->Cell($Cell1, $this->height, "Diterima tanggal", 0, 0, 'L');
		$this->Cell($Cell2, $this->height, ": ", 0, 0, 'L');
		$this->Cell($Cell3, $this->height, "", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		$this->Cell($Cell1, $this->height, "Nama Petugas", 0, 0, 'L');
		$this->Cell($Cell2, $this->height, ": ", 0, 0, 'L');
		$this->Cell($Cell3, $this->height, "", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		$this->Cell($Cell1, $this->height, "NIP", 0, 0, 'L');
		$this->Cell($Cell2, $this->height, ": ", 0, 0, 'L');
		$this->Cell($Cell3, $this->height, "", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		...
		$this->Cell($Cell1, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell2, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell3, $this->height, "Ttd", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "L", 0, 'C');
		$this->Cell($Cell1, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell2, $this->height, "", 0, 0, 'C');
		$this->Cell($Cell3, $this->height, "(..........................................................)", "R", 0, 'C');
		$this->Ln();
		$this->Cell($SpcCell, $this->height, "", "LB", 0, 'C');
		$this->Cell($Cell1, $this->height, "", "B", 0, 'C');
		$this->Cell($Cell2, $this->height, "", "B", 0, 'C');
		$this->Cell($Cell3, $this->height, "NIP.", "RB", 0, 'L');
		$this->Ln();
	}
