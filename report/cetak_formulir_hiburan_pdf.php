...
define("FileName", "cetak_formulir_hiburan_pdf.php");
...
$query="begin;";
$dbConn->query($query);
$query="select * from f_cetak_pajak_entertaintment(".$custId.", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "
...
while ($dbConn->next_record()) {
		...
		$data["o_entertaintment_type_id"] = $dbConn->f("o_entertaintment_type_id");
...
$dbConn->query($query);
while ($dbConn->next_record()) {
	$dataBaru["entertainment_desc"][] = $dbConn->f("entertainment_desc");
	$dataBaru["service_charge_wd"][] = $dbConn->f("service_charge_wd");	
	$dataBaru["service_charge_we"][] = $dbConn->f("service_charge_we");
	$dataBaru["seat_qty"][] = $dbConn->f("seat_qty");
	$dataBaru["room_qty"][] = $dbConn->f("room_qty");	
	$dataBaru["clerk_qty"][] = $dbConn->f("clerk_qty");
	$dataBaru["booking_hour"][] = $dbConn->f("booking_hour");
	$dataBaru["f_and_b"][] = $dbConn->f("f_and_b");
	$dataBaru["portion_person"][] = $dbConn->f("portion_person");
}
...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data,$dataArr,$dataBaru) {
		...
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "WAJIB PAJAK HIBURAN", "LR", 0, 'C');
		$this->Ln();
		...
		*/
		...
		$this->Cell($per2, $this->height, "Pendataan Pajak Hiburan", "TB", 0, 'L');
		$this->Cell($per3, $this->height, "", "TBR", 0, 'L');
		$this->Ln();
		//akhir tanda
		...
		$this->Cell($kol6, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol7, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol8, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol9, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol10, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol11, $this->height, "", "TB", 0, 'C');
		$this->Cell($kol12, $this->height, "", "RT", 0, 'C');
		$this->Ln();
		...
		$this->Cell($kol6, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol7, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol8, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol9, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol10, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol11, $this->height*2, "", 1, 0, 'C');
		$this->Cell($kol12, $this->height*2, "", "R", 0, 'C');
		$this->Ln($this->height-5);
		$this->Cell($kol1, $this->height*2, "", "L", 0, 'C');
		$this->Cell($kol2, $this->height*2, "No", 0, 0, 'C');
		$this->Cell($kol3, $this->height*2, "Jenis Hiburan", 0, 0, 'C');
		$this->Cell($kol4, $this->height+2, "Cover Charge/", 0, 0, 'C');
		$this->Cell($kol5, $this->height+2, "Jumlah Lembar", 0, 0, 'C');
		$this->Cell($kol6, $this->height+2, "Jumlah", 0, 0, 'C');
		$this->Cell($kol7, $this->height+2, "Jumlah PL", 0, 0, 'C');
		$this->Cell($kol8, $this->height+2, "Boking/", 0, 0, 'C');
		$this->Cell($kol9, $this->height*2, "F & B", 0, 0, 'C');
		$this->Cell($kol10, $this->height+2, "Porsi/", 0, 0, 'C');
		$this->Cell($kol11, $this->height+2, "Lain-", 0, 0, 'C');
		$this->Cell($kol12, $this->height*2, "", "R", 0, 'C');
		$this->Ln($this->height);
		$this->Cell($kol1, $this->height, "", "L", 0, 'C');
		$this->Cell($kol2, $this->height, "", 0, 0, 'C');
		$this->Cell($kol3, $this->height, "", 0, 0, 'C');
		$this->Cell($kol4, $this->height-2, "HTM/Tarif", 0, 0, 'C');
		$this->Cell($kol5, $this->height-2, "Meja/Kursi", 0, 0, 'C');
		$this->Cell($kol6, $this->height-2, "Room", 0, 0, 'C');
		$this->Cell($kol7, $this->height-2, "Pramuria/Pemijat", 0, 0, 'C');
		$this->Cell($kol8, $this->height-2, "Jam", 0, 0, 'C');
		$this->Cell($kol9, $this->height, "", 0, 0, 'C');
		$this->Cell($kol10, $this->height-2, "Orang", 0, 0, 'C');
		$this->Cell($kol11, $this->height-2, "lain", 0, 0, 'C');
		$this->Cell($kol12, $this->height, "", "R", 0, 'C');
		$this->Ln();
		
		//isi kolom
		$no = 1;
		$this->SetWidths(array($kol1, $kol2, $kol3, $kol4, $kol5, $kol6, $kol7, $kol8, $kol9, $kol10, $kol11, $kol12));
		$this->SetAligns(array("C", "C", "L", "R", "C", "C", "C", "C", "C", "C", "C", "C"));
		for ($i=0; $i<count($dataBaru['entertainment_desc']); $i++) {
		$this->RowMultiBorderWithHeight(array("",
											  $no,
											  $dataBaru["entertainment_desc"][$i],
											  $dataBaru["service_charge_wd"][$i],
											  $dataBaru["seat_qty"][$i],
											  $dataBaru["room_qty"][$i],
											  $dataBaru["clerk_qty"][$i],
											  $dataBaru["booking_hour"][$i],
											  $dataBaru["f_and_b"][$i],
											  $dataBaru["portion_person"][$i],
											  "",
											  "")
											 ,
										array('L',
		...
		$this->Cell($kol6, $this->height, "", "B", 0, 'C');
		$this->Cell($kol7, $this->height, "", "B", 0, 'C');
		$this->Cell($kol8, $this->height, "", "B", 0, 'C');
		$this->Cell($kol9, $this->height, "", "B", 0, 'C');
		$this->Cell($kol10, $this->height, "", "B", 0, 'C');
		$this->Cell($kol11, $this->height, "", "B", 0, 'C');
		$this->Cell($kol12, $this->height, "", "RB", 0, 'C');
		$this->Ln();
