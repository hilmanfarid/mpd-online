...
where a.p_rqst_type_id = b.p_rqst_type_id
	...
	and c.p_job_position_id = e.p_job_position_id
...
class FormCetak extends FPDF {
	...
	function PageCetak($data) {
		...
		if(empty($data['jenis_usaha']) ){
			...
			if($data['jenis_usaha']=='Perorangan') { 
				//PERORANGAN
				// Form 5. Alamat Wajib Pajak
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "3. Alamat Wajib Pajak", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["wp_address_name"], 0, 0, 'L');
				...
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "4. Nama Objek Pajak/Merek Dagang", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["company_brand"], 0, 0, 'L');
				...
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "5. Alamat Objek Pajak", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["alamat_brand"], 0, 0, 'L');
				...
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["vat_code"], 0, 0, 'L');

			} else { //PERUSAHAAN
				// Form 3. Alamat Wajib Pajak
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "3. Alamat Wajib Pajak", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				...
				// Form 4. Nama penanggung pajak
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "4. Penanggung Pajak", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				...
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "5. Jabatan", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["code"], 0, 0, 'L');
				
				// Form 6. Nama Merek Dagang
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "6. Nama Objek Pajak/Merek Dagang", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["company_brand"], 0, 0, 'L');
				
				// Form 7. Alamat Merek Dagang
				$this->Ln();
				$this->SetFont('Times', 'B', 11);
				$this->Cell($formLen1, $this->height, "7. Alamat Objek Pajak", 0, 0, 'L');
				$this->SetFont('Times', '', 11);
				$this->Cell($twelfth1-12, $this->height, " : ", 0, 0, 'C');
				$this->Cell($formLen2 - $twelfth1, $this->height, $data["alamat_brand"], 0, 0, 'L');
		...
		$this->Ln();
		$this->SetFont('Times', '', 11);
		$this->Cell($lengthCell, $this->height, "telah dikukuhkan dan terdaftar dengan Nomor Pokok Wajib Pajak (NPWPD) ".$data["npwpd"].".", 0, 0, 'L');
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "                Nomor Pokok Wajib Pajak (NPWPD) ini merupakan indentitas Wajib pajak dalam melaksanakan ", 0, 0, 'L');
		$this->Ln();
		$this->Cell($lengthCell, $this->height, "hak dan kewajiban perpajakan daerah di Kota Bandung.", 0, 0, 'L');
