<?php
	...
	define("FileName", "cetak_formulir_sptpd.php");
	...
	$t_piutang_pajak_penetapan_final_id = CCGetFromGet("t_piutang_pajak_penetapan_final_id","");
	...
	*/
	...
	function PageCetak($data) {
		...
		*/
		...
		$this->Cell($lbodyx1 - 10, $this->height, number_format(0,2,",","."), "", 0, 'R');
		...
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, number_format($data["nilai_piutang"],2,",","."), "", 0, 'R');
		$this->Cell(10, $this->height, "", "R", 0, 'R');
		$this->Ln();
		...
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, number_format($data["realisasi_piutang"],2,",","."), "", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		$this->Ln();
		...
		$this->Cell($lbodyx1 - 10, $this->height, number_format(0,2,",","."), "B", 0, 'R');
		$this->Cell(10, $this->height, "", "", 0, 'R');
		$this->Cell($lbody1, $this->height, "", "R", 0, 'L');
		$this->Ln();
		
		$jumno3 = $data["realisasi_piutang"];
		$this->Cell(10, $this->height, "", "L", 0, 'L');
		...
		$jumno4 = $data["nilai_piutang"] - $jumno3;
		$total = $jumno4 + $jumno5;
		$this->Cell(5, $this->height, "", "L", 0, 'L');
