...
class FormCetak extends FPDF {
	...
	*/
	...
	function PageCetak($data) {
		...
		$this->Cell($lheader3, $this->height, "SKPDKBLB", "R", 0, 'C');
		...
		$this->SetFont('Arial', '', 9);
		$this->Cell($lheader3, $this->height + 1, "Kurang Bayar Lebih Bayar)", "R", 0, 'C');
		...
		*/
		...
		$this->Cell(5, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody3 - 5, $this->height, "    4. Jumlah kelebihan pembayaran Pokok Pajak (3d-2)", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
		$this->Cell($lbodyx1 - 10, $this->height, number_format($jumno3-$data["debt_vat_amt"],2,",","."), "", 0, 'R');
		$this->Cell(10, $this->height, "", "R", 0, 'R');
		$this->Ln();
		...
		$this->Cell(5, $this->height, "", "L", 0, 'L');
		$this->Cell($lbody3 - 5, $this->height, "    6. Jumlah lebih bayar (4 - 5c)", "", 0, 'L');
		$this->Cell($lbodyx1, $this->height, "Rp ", "", 0, 'L');
