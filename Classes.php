...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    ...
    $this->Messages["ccs_cancel"] = "BATAL";
    ...
    $this->Messages["ccs_delete"] = "HAPUS";
    ...
    $this->Messages["ccs_insert"] = "SIMPAN";
    $this->Messages["ccs_insertlink"] = "TAMBAH";
    ...
    $this->Messages["ccs_update"] = "SIMPAN";
